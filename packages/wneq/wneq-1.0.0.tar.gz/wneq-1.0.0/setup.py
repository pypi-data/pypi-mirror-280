...
about = {}
with open(path.join(here, "wneq", "__about__.py")) as f:
    exec(f.read(), about)
...
setup(
    ...
    url="https://github.com/mbradle/wneq",  # Optional
    ...
    project_urls={  # Optional
        "Bug Reports": "https://github.com/mbradle/wneq/issues",
        # 'Funding': 'https://donate.pypi.org',
        # 'Say Thanks!': 'http://saythanks.io/to/example',
        "Source": "https://github.com/mbradle/wneq/",
    },
)
