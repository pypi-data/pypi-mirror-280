...
class Addon(FirstParamSingleton):
    ...
    @classmethod
    def from_(cls: type[AddonT], addon: "Addon") -> AddonT:
        return cls(addon.path)

    def cast(self, cls: type[AddonT]) -> AddonT:
