...
class SqlEditorTextArea(TextArea):
    BINDINGS = [
        Binding("ctrl+enter", "execute", "Execute"),
        Binding("ctrl+space", "autocomplete", "Autocomplete"),
        Binding("ctrl+f", "format", "Format"),
        Binding("ctrl+s", "select", "Select"),
        Binding("escape", "close", "Close Autocomplete"),
    ]
