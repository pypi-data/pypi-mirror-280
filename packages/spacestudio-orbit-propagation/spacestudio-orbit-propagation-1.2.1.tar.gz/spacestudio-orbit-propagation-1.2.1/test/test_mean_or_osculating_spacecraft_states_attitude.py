...
class TestMeanOrOsculatingSpacecraftStatesAttitude(unittest.TestCase):
    """MeanOrOsculatingSpacecraftStatesAttitude unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeanOrOsculatingSpacecraftStatesAttitude:
        """Test MeanOrOsculatingSpacecraftStatesAttitude
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeanOrOsculatingSpacecraftStatesAttitude`
        """
        model = MeanOrOsculatingSpacecraftStatesAttitude()
        if include_optional:
            return MeanOrOsculatingSpacecraftStatesAttitude(
                rotation = [
                    [
                        1.337
                        ]
    ...
    def testMeanOrOsculatingSpacecraftStatesAttitude(self):
        """Test MeanOrOsculatingSpacecraftStatesAttitude"""
