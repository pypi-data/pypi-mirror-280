...
class TestOrbitPropagationRequestOutputsSpacecraftStates(unittest.TestCase):
    """OrbitPropagationRequestOutputsSpacecraftStates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrbitPropagationRequestOutputsSpacecraftStates:
        """Test OrbitPropagationRequestOutputsSpacecraftStates
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrbitPropagationRequestOutputsSpacecraftStates`
        """
        model = OrbitPropagationRequestOutputsSpacecraftStates()
        if include_optional:
            return OrbitPropagationRequestOutputsSpacecraftStates(
                mean = True,
                osculating = True
            )
        else:
    ...
    def testOrbitPropagationRequestOutputsSpacecraftStates(self):
        """Test OrbitPropagationRequestOutputsSpacecraftStates"""
