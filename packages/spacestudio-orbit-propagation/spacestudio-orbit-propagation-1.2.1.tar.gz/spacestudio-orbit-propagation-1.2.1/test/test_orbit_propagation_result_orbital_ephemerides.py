...
class TestOrbitPropagationResultOrbitalEphemerides(unittest.TestCase):
    """OrbitPropagationResultOrbitalEphemerides unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrbitPropagationResultOrbitalEphemerides:
        """Test OrbitPropagationResultOrbitalEphemerides
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrbitPropagationResultOrbitalEphemerides`
        """
        model = OrbitPropagationResultOrbitalEphemerides()
        if include_optional:
            return OrbitPropagationResultOrbitalEphemerides(
                ephemerides_frame = '',
                timestamps = [
                    ''
                    ],
    ...
    def testOrbitPropagationResultOrbitalEphemerides(self):
        """Test OrbitPropagationResultOrbitalEphemerides"""
