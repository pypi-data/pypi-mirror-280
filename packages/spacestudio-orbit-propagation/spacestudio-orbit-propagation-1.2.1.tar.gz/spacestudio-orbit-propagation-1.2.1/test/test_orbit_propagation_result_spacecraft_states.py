...
class TestOrbitPropagationResultSpacecraftStates(unittest.TestCase):
    """OrbitPropagationResultSpacecraftStates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrbitPropagationResultSpacecraftStates:
        """Test OrbitPropagationResultSpacecraftStates
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrbitPropagationResultSpacecraftStates`
        """
        model = OrbitPropagationResultSpacecraftStates()
        if include_optional:
            return OrbitPropagationResultSpacecraftStates(
                mu = 1.337,
                ephemerides_frame = '',
                timestamps = [
                    ''
    ...
    def testOrbitPropagationResultSpacecraftStates(self):
        """Test OrbitPropagationResultSpacecraftStates"""
