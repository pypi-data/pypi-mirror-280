...
class TestOrbitPropagationRequestOutputsOrbitalEphemerides(unittest.TestCase):
    """OrbitPropagationRequestOutputsOrbitalEphemerides unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrbitPropagationRequestOutputsOrbitalEphemerides:
        """Test OrbitPropagationRequestOutputsOrbitalEphemerides
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrbitPropagationRequestOutputsOrbitalEphemerides`
        """
        model = OrbitPropagationRequestOutputsOrbitalEphemerides()
        if include_optional:
            return OrbitPropagationRequestOutputsOrbitalEphemerides(
                types = [
                    'CARTESIAN'
                    ],
                timestep = 1.337,
    ...
    def testOrbitPropagationRequestOutputsOrbitalEphemerides(self):
        """Test OrbitPropagationRequestOutputsOrbitalEphemerides"""
