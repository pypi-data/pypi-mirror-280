...
class TestOrbitPropagationResultOrbitalEphemeridesOsculating(unittest.TestCase):
    """OrbitPropagationResultOrbitalEphemeridesOsculating unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrbitPropagationResultOrbitalEphemeridesOsculating:
        """Test OrbitPropagationResultOrbitalEphemeridesOsculating
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrbitPropagationResultOrbitalEphemeridesOsculating`
        """
        model = OrbitPropagationResultOrbitalEphemeridesOsculating()
        if include_optional:
            return OrbitPropagationResultOrbitalEphemeridesOsculating(
    ...
    def testOrbitPropagationResultOrbitalEphemeridesOsculating(self):
        """Test OrbitPropagationResultOrbitalEphemeridesOsculating"""
