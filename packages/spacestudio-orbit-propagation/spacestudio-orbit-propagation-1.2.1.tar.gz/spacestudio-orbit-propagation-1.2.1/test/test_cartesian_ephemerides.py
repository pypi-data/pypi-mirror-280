...
class TestCartesianEphemerides(unittest.TestCase):
    """CartesianEphemerides unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CartesianEphemerides:
        """Test CartesianEphemerides
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CartesianEphemerides`
        """
        model = CartesianEphemerides()
        if include_optional:
            return CartesianEphemerides(
                x = [
                    1.337
                    ],
                y = [
    ...
    def testCartesianEphemerides(self):
        """Test CartesianEphemerides"""
