...
class OrbitPropagationResultOrbitalEphemerides(BaseModel):
    """
    ...
    mean: Optional[OrbitPropagationResultOrbitalEphemeridesMean] = None
    osculating: Optional[OrbitPropagationResultOrbitalEphemeridesOsculating] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrbitPropagationResultOrbitalEphemerides from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrbitPropagationResultOrbitalEphemerides from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "mean": OrbitPropagationResultOrbitalEphemeridesMean.from_dict(obj["mean"]) if obj.get("mean") is not None else None,
            "osculating": OrbitPropagationResultOrbitalEphemeridesOsculating.from_dict(obj["osculating"]) if obj.get("osculating") is not None else None
        })
        return _obj
