...
class OrbitPropagationResultSpacecraftStates(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["mu", "ephemeridesFrame", "timestamps", "mass", "mean", "osculating"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrbitPropagationResultSpacecraftStates from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrbitPropagationResultSpacecraftStates from a dict"""
        if obj is None:
            return None
