...
class OpenVisusTileSource(large_image.tilesource.TileSource, metaclass=LruCacheMetaclass):
	...
	def __init__(self, url=None, **kwargs):
		...
		print("pow2 size",self.tileWidth,self.tileHeight)
		...
		print(f"OpenVisusTileSource({url},kwargs={kwargs})")
	...
	def getLRUHash(*args, **kwargs):
		return strhash(super(OpenVisusTileSource, OpenVisusTileSource).getLRUHash(*args, **kwargs))
