...
def spatial_auc(adata, df=None, genes=[], gene_sets=['m5.all', 'm2.all'], version='2023.1.Mm', neighbors_defined=True, n_perms=1000, n_jobs=2):
    """
    ...
    Args:
        ...
        genes (list): List of genes to consider. If empty, all genes in adata.var_names will be used.
        gene_sets (list): List of gene set categories to retrieve from MSigDB.
        version (str): Version of the MSigDB database.
        neighbors_defined (bool): Whether spatial neighbors have already been defined in the AnnData object.
        n_perms (int): Number of permutations for calculating the p-value.
    ...
    try:
        df_msigdb = get_df_from_gmt(gene_sets, version, genes)
    except:
