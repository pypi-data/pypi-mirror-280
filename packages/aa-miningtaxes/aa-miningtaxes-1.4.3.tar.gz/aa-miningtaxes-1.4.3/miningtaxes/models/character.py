...
from django.db.models import Sum, When, Case, Value
...
class CharacterMiningLedgerEntry(models.Model):
    ...
    def calc_prices(self):
        ...
        if (len(MININGTAXES_WHITELIST) > 0 and self.eve_solar_system.name not in MININGTAXES_WHITELIST) or (
                len(MININGTAXES_WHITELIST) == 0 and (
