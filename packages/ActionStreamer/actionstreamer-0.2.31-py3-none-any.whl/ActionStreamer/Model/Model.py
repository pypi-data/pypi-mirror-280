...
class RecordingParameters:
    ...
    def __init__(self, height: int, width: int, fps: float, bitrate: int, vflip: int, hflip: int, encoding: str, segmentLengthSeconds: float, audio: int):
        self.height = height
        self.width = width
        self.fps = fps
...
class VideoClip:
    ...
    def __init__(self, fileID=0, tSFileID=0, videoClipParameters='', localFilePath='', height=0, width=0, framesPerSecond:float=0, bitrate = 0, audioStatus=0, startTime=0, startTimeMs=0, endTime=0, endTimeMs=0, clipLengthInSeconds:float=0):
        self.fileID = fileID
...
class TransferArgs:
    ...
    def __init__(self, videoClipId: int, localFilePath: str, remoteFilename: str, remoteFolderPath: str):
