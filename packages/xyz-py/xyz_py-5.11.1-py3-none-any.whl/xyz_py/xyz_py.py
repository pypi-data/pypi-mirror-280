...
def load_xyz(f_name: str, atomic_numbers: bool = False,
             ...
             check: bool = True) -> tuple[list, NDArray]:
    '''
    ...
    if check:
        check_xyz(f_name, allow_nonelements=atomic_numbers)
...
def check_xyz(f_name: str, allow_indices: bool = True,
              allow_nonelements: bool = False) -> None:
    '''
    ...
    try:
        ...
        raise ValueError('.xyz file cannot be read!')
