...
from . import F
__all__ = ['Classifier', 'F', 'FaceDetector', 'FaceObject', 'FaceRecognizer', 'LayerInfo', 'MUD', 'NN', 'Object', 'ObjectFloat', 'Retinaface', 'SelfLearnClassifier', 'YOLOv5', 'YOLOv8']
class Classifier:
    label_path: str
    labels: list[str]
    mean: list[float]
...
class FaceRecognizer:
    ...
    def __init__(self, detect_model: str = '', feature_model: str = '') -> None:
        ...
...
class YOLOv8:
    ...
    def __init__(self, model: str = '') -> None:
        ...
    def detect(self, img: maix._maix.image.Image, conf_th: float = 0.5, iou_th: float = 0.45, fit: maix._maix.image.Fit = ..., keypoint_th: float = 0.5) -> list[Object]:
        """
        Detect objects from image
        ...
        """
    def draw_pose(self, img: maix._maix.image.Image, points: list[int], radius: int = 4, color: maix._maix.image.Color = ...) -> None:
        """
