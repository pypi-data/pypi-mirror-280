...
from youqu_dogtail.dogtail.config import config
from youqu_dogtail.dogtail import path
from youqu_dogtail.dogtail import predicate
from youqu_dogtail.dogtail import rawinput
from youqu_dogtail.dogtail.logging import debugLogger as logger
from youqu_dogtail.dogtail.utils import doDelay, Blinker, Lock
...
if config.checkForA11y:
    from youqu_dogtail.dogtail.utils import checkForA11y
    checkForA11y()
...
class Node(object):
    ...
    def dump(self, type='plain', fileName=None):
        from youqu_dogtail.dogtail import dump
