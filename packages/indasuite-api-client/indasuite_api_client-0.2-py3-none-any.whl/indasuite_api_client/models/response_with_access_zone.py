...
T = TypeVar("T", bound="ResponseWithAccessZone")


@_attrs_define
class ResponseWithAccessZone:
    """
    Attributes:
        ...
        data (Union[Unset, AccessZone]):
    """

    status_code: Union[Unset, ApiStatusCode] = UNSET
    message: Union[Unset, str] = UNSET
    data: Union[Unset, "AccessZone"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = AccessZone.from_dict(_data)
