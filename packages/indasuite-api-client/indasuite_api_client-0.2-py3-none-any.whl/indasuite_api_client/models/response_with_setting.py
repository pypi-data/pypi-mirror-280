...
T = TypeVar("T", bound="ResponseWithSetting")


@_attrs_define
class ResponseWithSetting:
    """
    Attributes:
        ...
        data (Union[Unset, Setting]):
    """

    status_code: Union[Unset, ApiStatusCode] = UNSET
    message: Union[Unset, str] = UNSET
    data: Union[Unset, "Setting"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = Setting.from_dict(_data)

        response_with_setting = cls(
            status_code=status_code,
            message=message,
            data=data,
        )

        return response_with_setting
