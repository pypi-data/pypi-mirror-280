...
T = TypeVar("T", bound="ResponseWithMetricList")


@_attrs_define
class ResponseWithMetricList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Union[List["Metric"], None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                for data_type_0_item_data in _data_type_0:
                    data_type_0_item = Metric.from_dict(data_type_0_item_data)
                ...
                pass
            return cast(Union[List["Metric"], None, Unset], data)
        ...
        return response_with_metric_list
