...
from ...models.access_zone_groups_patch import AccessZoneGroupsPatch
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "patch",
        "url": f"/v1/access-zones/{access_zone_id}/groups",
    }

    if isinstance(body, AccessZoneGroupsPatch):
...
def sync_detailed(
    ...
    *,
    ...
    """Update groups of an access zone

    Args:
        access_zone_id (str):
        body (AccessZoneGroupsPatch):
        body (AccessZoneGroupsPatch):
        body (AccessZoneGroupsPatch):
