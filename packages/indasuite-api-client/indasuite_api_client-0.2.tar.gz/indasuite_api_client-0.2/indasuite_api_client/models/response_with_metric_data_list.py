...
T = TypeVar("T", bound="ResponseWithMetricDataList")


@_attrs_define
class ResponseWithMetricDataList:
    """
    Attributes:
        is_response_complete (Union[None, Unset, bool]):
        name (Union[Unset, str]):
        unit (Union[Unset, str]):
        values (Union[List['MetricData'], None, Unset]):
    """

    is_response_complete: Union[None, Unset, bool] = UNSET
    name: Union[Unset, str] = UNSET
    unit: Union[Unset, str] = UNSET
    values: Union[List["MetricData"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_values(data: object) -> Union[List["MetricData"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for values_type_0_item_data in _values_type_0:
                    values_type_0_item = MetricData.from_dict(values_type_0_item_data)
                ...
                pass
            return cast(Union[List["MetricData"], None, Unset], data)

        values = _parse_values(d.pop("values", UNSET))

        response_with_metric_data_list = cls(
        ...
        return response_with_metric_data_list
