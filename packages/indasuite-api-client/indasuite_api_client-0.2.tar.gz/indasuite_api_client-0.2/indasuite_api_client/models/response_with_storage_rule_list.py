...
T = TypeVar("T", bound="ResponseWithStorageRuleList")


@_attrs_define
class ResponseWithStorageRuleList:
    """
    Attributes:
        ...
        data (Union[List['StorageRule'], None, Unset]):
        pagination_info (Union[Unset, Pagination]):
    """

    status_code: Union[Unset, ApiStatusCode] = UNSET
    message: Union[Unset, str] = UNSET
    data: Union[List["StorageRule"], None, Unset] = UNSET
    pagination_info: Union[Unset, "Pagination"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if pagination_info is not UNSET:
            field_dict["paginationInfo"] = pagination_info
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Union[List["StorageRule"], None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                for data_type_0_item_data in _data_type_0:
                    data_type_0_item = StorageRule.from_dict(data_type_0_item_data)
                ...
                pass
            return cast(Union[List["StorageRule"], None, Unset], data)

        data = _parse_data(d.pop("data", UNSET))

        _pagination_info = d.pop("paginationInfo", UNSET)
        pagination_info: Union[Unset, Pagination]
        if isinstance(_pagination_info, Unset):
            pagination_info = UNSET
        else:
            pagination_info = Pagination.from_dict(_pagination_info)

        response_with_storage_rule_list = cls(
        ...
        return response_with_storage_rule_list
