...
.. image:: https://img.shields.io/endpoint?url=https%3A%2F%2Frunkit.io%2Fdamiankrawczyk%2Ftelegram-badge%2Fbranches%2Fmaster%3Furl%3Dhttps%3A%2F%2Ft.me%2Fdpy_self
   ...
   :alt: Telegram chat
.. image:: https://img.shields.io/pypi/v/pycord-self.svg
   :target: https://pypi.python.org/pypi/pycord-self
   :alt: PyPI version info
.. image:: https://img.shields.io/pypi/pyversions/discord.py.svg
   :target: https://pypi.python.org/pypi/pycord-self
   :alt: PyPI supported Python versions
.. image:: https://img.shields.io/pypi/dm/pycord-self.svg
   :target: https://pypi.python.org/pypi/pycord-self
...
If you would like to use the library alongside upstream ``discord.py``, you can install ``selfcord.py`` instead of ``pycord-self``. Check out the `renamed branch <https://github.com/dolfies/pycord-self/blob/renamed/README.rst>`_ for more information.
