...
class CO2DataLegacy:
    ...
    average_ration_scope1_declared_nace: float | int | None = None
    scope1_weight: float | int | None = None
    IC80_firstnace_scope1: float | int | None = None
    scope1_declared: float | int | None = None
    average_ratio_scope2_first_best_nace: float | int | None = None
    averate_ration_scope2_second_best_nace: float | int | None = None
    ...
    IC80_firstnace_scope2: float | int | None = None
