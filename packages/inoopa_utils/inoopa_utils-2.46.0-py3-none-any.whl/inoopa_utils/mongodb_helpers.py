...
class DbManagerMongo:
    ...
    def _create_indexes(self) -> None:
        ...
        for index in fields_to_index_legacy_co2_data:
            self._logger.debug(f"Creating index {index} in `legacy_co2_data` collection...")
            self.legacy_co2_data.create_index(index, background=True)
