...
class AlongTrackTolerance(Tolerance):
    ...
    AlongTrackTolerance
    """ # noqa: E501
    along_track_tolerance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The along-track axis tolerance (in meters)", alias="alongTrackTolerance")
    __properties: ClassVar[List[str]] = ["type", "alongTrackTolerance"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AlongTrackTolerance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AlongTrackTolerance from a dict"""
        if obj is None:
            return None
