...
class SmaTolerance(Tolerance):
    """
    SmaTolerance
    """ # noqa: E501
    sma_tolerance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The semi-major axis tolerance (in meters)", alias="smaTolerance")
    __properties: ClassVar[List[str]] = ["type", "smaTolerance"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SmaTolerance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SmaTolerance from a dict"""
        if obj is None:
            return None
