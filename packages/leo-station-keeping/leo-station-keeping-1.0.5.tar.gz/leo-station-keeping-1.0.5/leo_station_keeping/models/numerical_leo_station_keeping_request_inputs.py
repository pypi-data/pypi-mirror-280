...
class NumericalLeoStationKeepingRequestInputs(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["missionDateTime", "maximumDuration", "initialOrbit", "spacecraftGeometry", "platform", "propulsionSystem", "perturbations", "tolerance", "customManeuveringStrategy"]
