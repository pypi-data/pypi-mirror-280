...
class Perturbation(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[DragPerturbation, EarthPotentialPerturbation, SrpPerturbation, ThirdBodyPerturbation]]:
        ...
        if object_type ==  'DragPerturbation':
            return import_module("leo_station_keeping.models.drag_perturbation").DragPerturbation.from_dict(obj)
        if object_type ==  'EarthPotentialPerturbation':
            return import_module("leo_station_keeping.models.earth_potential_perturbation").EarthPotentialPerturbation.from_dict(obj)
        if object_type ==  'SrpPerturbation':
            return import_module("leo_station_keeping.models.srp_perturbation").SrpPerturbation.from_dict(obj)
        if object_type ==  'ThirdBodyPerturbation':
            return import_module("leo_station_keeping.models.third_body_perturbation").ThirdBodyPerturbation.from_dict(obj)
