...
class Platform(BaseModel):
    ...
    on_board_average_power: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The average power consumption of the platform (in watts). ", alias="onBoardAveragePower")
    __properties: ClassVar[List[str]] = ["mass", "onBoardAveragePower"]
