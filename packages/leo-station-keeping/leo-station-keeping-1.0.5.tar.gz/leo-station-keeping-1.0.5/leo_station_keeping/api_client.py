...
from leo_station_keeping.api_response import ApiResponse, T as ApiResponseT
import leo_station_keeping.models
from leo_station_keeping import rest
from leo_station_keeping.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(leo_station_keeping.models, klass)
