...
class Configuration:
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "http://leo-station-keeping.exoops.57.128.40.142.sslip.io" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("leo_station_keeping")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "http://leo-station-keeping.exoops.57.128.40.142.sslip.io",
