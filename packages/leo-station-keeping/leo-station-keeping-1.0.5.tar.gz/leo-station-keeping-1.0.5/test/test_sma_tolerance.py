...
class TestSmaTolerance(unittest.TestCase):
    """SmaTolerance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SmaTolerance:
        """Test SmaTolerance
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SmaTolerance`
        """
        model = SmaTolerance()
        if include_optional:
            return SmaTolerance(
