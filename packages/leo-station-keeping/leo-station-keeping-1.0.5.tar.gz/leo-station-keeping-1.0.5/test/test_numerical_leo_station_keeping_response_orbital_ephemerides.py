...
class TestNumericalLeoStationKeepingResponseOrbitalEphemerides(unittest.TestCase):
    """NumericalLeoStationKeepingResponseOrbitalEphemerides unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NumericalLeoStationKeepingResponseOrbitalEphemerides:
        """Test NumericalLeoStationKeepingResponseOrbitalEphemerides
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NumericalLeoStationKeepingResponseOrbitalEphemerides`
        """
        model = NumericalLeoStationKeepingResponseOrbitalEphemerides()
        if include_optional:
            return NumericalLeoStationKeepingResponseOrbitalEphemerides(
                ephemerides_frame = '',
                timestamps = [
                    ''
                    ],
    ...
    def testNumericalLeoStationKeepingResponseOrbitalEphemerides(self):
        """Test NumericalLeoStationKeepingResponseOrbitalEphemerides"""
