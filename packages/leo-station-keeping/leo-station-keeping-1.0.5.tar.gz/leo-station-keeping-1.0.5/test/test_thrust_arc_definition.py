...
class TestThrustArcDefinition(unittest.TestCase):
    """ThrustArcDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThrustArcDefinition:
        """Test ThrustArcDefinition
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThrustArcDefinition`
        """
        model = ThrustArcDefinition()
        if include_optional:
            return ThrustArcDefinition(
    ...
    def testThrustArcDefinition(self):
        """Test ThrustArcDefinition"""
