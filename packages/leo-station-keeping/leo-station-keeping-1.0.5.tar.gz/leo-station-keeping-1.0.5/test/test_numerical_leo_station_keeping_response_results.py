...
class TestNumericalLeoStationKeepingResponseResults(unittest.TestCase):
    """NumericalLeoStationKeepingResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NumericalLeoStationKeepingResponseResults:
        """Test NumericalLeoStationKeepingResponseResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NumericalLeoStationKeepingResponseResults`
        """
        model = NumericalLeoStationKeepingResponseResults()
        if include_optional:
            return NumericalLeoStationKeepingResponseResults(
                number_of_burns = 56,
    ...
    def testNumericalLeoStationKeepingResponseResults(self):
        """Test NumericalLeoStationKeepingResponseResults"""
