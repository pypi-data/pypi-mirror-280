...
from nwon_django_seeding.settings import NWON_DJANGO_SEED_SETTINGS

"""
This map configures our custom seeding logic for specific models.

It maps a model class to a dictionary that contains the field names in the database
and maps them to the field names in the seed file.
"""
CUSTOM_SEED_MODEL_MAP: Dict[Type[Model], Dict[str, str]] = {}


def load_seed_data(environment: str, app_name: str = "nwon"):
    """
