**Check lastest version [here](https://github.com/ilotoki0804/WebtoonScraper/blob/master/https://github.com/ilotoki0804/WebtoonScraper).**
# hxsoup

![PyPI - Python Version](https://github.com/ilotoki0804/WebtoonScraper/blob/master/https://img.shields.io/pypi/pyversions/hxsoup)
[![PyPI - Downloads](https://github.com/ilotoki0804/WebtoonScraper/blob/master/https://img.shields.io/pypi/dm/hxsoup)](https://pypi.org/project/hxsoup)
...
이 프로그램의 일부는 [resoup(본인 제작)](https://github.com/ilotoki0804/WebtoonScraper/blob/master/https://github.com/ilotoki0804/resoup) 라이브러리에 있던 코드를 포함합니다.
Some part of this program contains code from [resoup(created and developed by me)](https://github.com/ilotoki0804/WebtoonScraper/blob/master/https://github.com/ilotoki0804/resoup) library.

이 프로그램의 일부는 [httpx(BSD-3-Clause license)](https://github.com/ilotoki0804/WebtoonScraper/blob/master/https://github.com/encode/httpx) 라이브러리에 있던 코드를 포함합니다.
Some part of this program contains code from [httpx](https://github.com/ilotoki0804/WebtoonScraper/blob/master/https://github.com/encode/httpx) library.

## Motivation and blathers

이전에 requests의 불편한 점을 느끼고 관련 내용을 입맛에 맞게 수정한 resoup라는 라이브러리를 만들어 사용하고 있었습니다.

그러던 어느 날 [ArjanCodes의 영상](https://github.com/ilotoki0804/WebtoonScraper/blob/master/https://www.youtube.com/watch?v=OPyoXx0yA0I)에서 httpx에 대해 다시 보게 되고 실제로 사용해보니 requests와 상위 호환되는 라이브러리라는 점을 알게 되었습니다.
