...
from . import pre, sICTA_model, train
from .train import fit_model
from .pre import prediect
import os

def train(adata, gmt_path, project=None,pre_weights='', label_name='Celltype',max_g=300,max_gs=300,mask_ratio =0.015, n_unannotated = 1,batch_size=8, embed_dim=100,depth=2,num_heads=4,lr=0.01, epochs= 10, lrf=0.01):
    r"""
...
def train(adata, gmt_path, project=None,pre_weights='', label_name='Celltype',max_g=300,max_gs=300,mask_ratio =0.015, n_unannotated = 1,batch_size=128, embed_dim=100,depth=2,num_heads=4,lr=0.01, epochs= 10, lrf=0.01):
    r"""
    Fit the model with reference data
    Parameters
    ----------
...
def pre(adata,model_weight_path,project,laten=False,save_att = 'X_att', save_lantent = 'X_lat',n_step=80000,cutoff=0.0,n_unannotated = 1,batch_size=8,embed_dim=100,depth=2,num_heads=4):
    r"""
