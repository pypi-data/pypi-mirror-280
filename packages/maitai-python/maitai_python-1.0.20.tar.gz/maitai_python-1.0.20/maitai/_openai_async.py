...
from maitai._inference import InferenceException
...
class MaitaiAsyncOpenAIClient:
    def __init__(
        ...
        *,
        ...
        if api_key:
            config.auth_info.override_api_key = api_key
    ...
    async def create(
        ...
        *,
        ...
        if server_side_inference:
            ...
            if stream:
                return _process_async_openai_stream(session_id, reference_id, action_type, application_ref_name, messages, response, evaluation_enabled, completion_params, callback)
            else:
        ...
        if maitai_chunk.choices[0].finish_reason:
            if evaluation_enabled:
                ...
                await Evaluator.evaluate_async(
                    ...
                    application_ref_name=application_ref_name,
                    callback=callback,
                    chat_completion_chunk=maitai_chunk,
