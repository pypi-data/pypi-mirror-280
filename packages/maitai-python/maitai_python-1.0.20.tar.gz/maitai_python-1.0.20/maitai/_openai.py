    ...
    def create(
        ...
        *,
        ...
        if server_side_inference:
            ...
            if stream:
                return _process_openai_stream(session_id, reference_id, action_type, application_ref_name, messages, response, evaluation_enabled, completion_params, callback)
            else:
