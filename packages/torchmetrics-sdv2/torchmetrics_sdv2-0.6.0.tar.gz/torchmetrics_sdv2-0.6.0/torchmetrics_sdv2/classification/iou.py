...
from torchmetrics_sdv2.classification.confusion_matrix import ConfusionMatrix
from torchmetrics_sdv2.functional.classification.iou import _iou_from_confmat
