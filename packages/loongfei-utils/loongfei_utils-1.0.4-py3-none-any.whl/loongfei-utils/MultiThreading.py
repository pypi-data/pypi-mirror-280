...
class ExecuteList:
    ...
    def start_thread(self):
        for i in range(self.__thread_num__):
            ...
            threading.Thread(target=self.executing_list_item, args=(thread_name,)).start()
        if_continue = True
        while if_continue:
    ...
    def getting_executing_data(self, execute_type, execute_list_item):
        """
    ...
    def executing_list_item(self, thread_name):
        continue_do = True
        while continue_do:
            execute_list_item = self.getting_executing_data("1", "")
            if execute_list_item != "":
                ...
                try:
                    ...
                    self.getting_executing_data("3", execute_list_item)
                    ...
                    if not execute_result:
                        ...
                        self.getting_executing_data("2", execute_list_item)
