...
from test.tools.DiGuiThread import DiGuiThread
...
# cd = TSCrawlingToMp4(url="https://vip.lz-cdn.com/20220731/26529_5862e7cc/1000k/hls/mixed.m3u8",
#                              path="D:/Downloads/view/",
#                              zh_file_name="飞狐外传",
#                              logger=logger)
# cd.do_crawling(100,5)
