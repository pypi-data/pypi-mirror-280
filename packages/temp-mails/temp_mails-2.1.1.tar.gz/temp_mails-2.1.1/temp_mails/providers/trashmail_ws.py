...
class Trashmail_ws(_Livewire2):
    ...
    def __init__(self, name: str=None, domain: str=None, exclude: list[str]=None):
        ...
        super().__init__(
            urls={
                "base": "https://trashmail.ws",
                "mailbox": "https://trashmail.ws/mailbox/",
                "app": "https://trashmail.ws/livewire/message/frontend.app",
                "actions": "https://trashmail.ws/livewire/message/frontend.actions"
            },
