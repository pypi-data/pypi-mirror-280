...
class Maillog_org(_Livewire):
    """An API Wrapper around the https://maillog.org/ website"""
    ...
    def __init__(self, name: str=None, domain: str=None, exclude: list[str]=None):
        ...
        super().__init__(
            urls={
                "base": "https://maillog.org/",
                "app": "https://maillog.org/livewire/message/frontend.app",
                "actions": "https://maillog.org/livewire/message/frontend.actions"
            },
    ...
    def get_valid_domains() -> list[str] | None:
        ...
        """
        r = requests.get("https://maillog.org/")
