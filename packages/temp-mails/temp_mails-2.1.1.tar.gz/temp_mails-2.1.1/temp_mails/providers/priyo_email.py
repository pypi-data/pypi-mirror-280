...
class Priyo_email(_Livewire):
    ...
    def __init__(self, name: str=None, domain: str=None, exclude: list[str]=None):
        ...
        super().__init__(
            urls={
                "base": "https://priyo.email/",
                "app": "https://priyo.email/livewire/message/frontend.app",
                "actions": "https://priyo.email/livewire/message/frontend.actions"
            },
    ...
    def get_valid_domains() -> list[str] | None:
        ...
        """
        r = requests.get("https://priyo.email/")
