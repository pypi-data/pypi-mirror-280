...
class CloudSQLPostgres(
    ...
    def __init__(
        ...
        **Args**:
        ...
        - `database_flags`: Additional database flags to pass to your database instance. See: https://cloud.google.com/sql/docs/postgres/flags
        """
        super().__init__(
            name=name,
