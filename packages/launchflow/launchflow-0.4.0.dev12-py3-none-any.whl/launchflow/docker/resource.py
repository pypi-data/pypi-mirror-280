...
class DockerResource(Resource[T]):
    ...
    def _lazy_load_container_info(self) -> None:
        ...
        try:
            ...
            self.ports.update(connection_info.ports)
        except Exception:
            return
    ...
    def outputs(self) -> T:
        ...
        containers = docker_client.list_containers(environment_name=launchflow.environment, resource_name=self.name)
        ...
        return self._outputs_type(**inputs_dict, container_id=containers[0].id)
