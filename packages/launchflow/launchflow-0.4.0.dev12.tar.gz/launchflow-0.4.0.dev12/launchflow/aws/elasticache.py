...
@dataclasses.dataclass
class ElasticacheRedisInputs(Inputs):
    node_type: str
    ...
    **NOTE**: This resource can only be accessed from within the same VPC it is created in.
    ...
    def __init__(
        ...
        **Args**:
        ...
        - `node_type`: The instance class of the Elasticache Redis cluster. Defaults to `cache.t4g.micro` for development environments and `cache.r7g.large` for production environments.
        - `parameter_group_name`: The name of the parameter group to associate with the Elasticache Redis cluster. Defaults to `default.redis7`.
        - `engine_version`: Version number of the cache engine to use. Defaults to `7.0`.
        """
        super().__init__(name=name, product=ResourceProduct.AWS_ELASTICACHE_REDIS)
        self.parameter_group_name = parameter_group_name
        self.node_type = node_type
        self.engine_version = engine_version

    def inputs(self, environment_type: EnvironmentType) -> ElasticacheRedisInputs:
