...
class Agent:
    ...
    def save(self, api_key=None, public_key=None, private_key=None, update_existing=False) -> dict:
        """
...
class VectorStoreToolDefinition(UserDefinedToolDefinition):
    ...
    def from_name(cls, name: str  = None, id: str = None, description: str = "", **kwargs):
        ...
        return cls(
            ...
            type = cls.type,
            id = user_object.id,
            parameters = [ParameterDefinition(name="query", description="query for Knowledge Base", type="string")]
        )
