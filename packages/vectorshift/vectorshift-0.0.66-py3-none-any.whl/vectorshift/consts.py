...
OUTPUT_NODE_TYPES = ['text', 'formatted_text', 'image']
...
API_FILE_DELETE_BY_NAMES_ENDPOINT = f'{DOMAIN}/api/files/delete_by_names'
...
API_PIPELINE_SHARED_USERS_ENDPOINT = f'{DOMAIN}/api/pipelines/shared_users'
...
API_USER_DETAILS_ENDPOINT = f'{DOMAIN}/api/user_details'
