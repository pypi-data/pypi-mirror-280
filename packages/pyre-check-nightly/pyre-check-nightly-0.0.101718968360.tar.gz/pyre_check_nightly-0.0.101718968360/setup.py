...
def main() -> None:
    ...
    run(
        ...
        package_version="0.0.101718968360",
        module_name="pyre_check",
        runtime_dependencies=json.loads(r"""["click>=8.0", "dataclasses-json==0.5.7", "intervaltree", "libcst", "psutil", "pyre-extensions>=0.0.29", "tabulate", "testslide>=2.7.0", "typing_extensions", "typing_inspect"]"""),
        long_description=long_description,
    )
