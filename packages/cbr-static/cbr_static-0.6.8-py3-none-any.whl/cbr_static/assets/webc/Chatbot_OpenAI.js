...
import WebC_Chat_Bot from "./WebC__Chat_Bot.js";
...
// `
    ...
    async post_openai_prompt_with_stream(user_prompt, images) {
        ...
        user_data['selected_platform'] = $('#platform-select').val();               // todo: refactor the retrieval of this value from outside this js class
        user_data['selected_provider'] = $('#provider-select').val();               //       since this highly couples the component to other parts of the page
        user_data['selected_model'   ] = $('#model-select'   ).val();
