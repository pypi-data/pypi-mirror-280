...
os.environ['MARKETDATA_CUSTOM_CONFIG_PATH'] = ConfigConstants.CUSTOM_APPLICATION_PROPERTIES_PATH
os.environ['MARKETDATA_DEFAULT_PROPERTY_FILE'] = ConfigConstants.DEFAULT_APPLICATION_PROPERTIES_PATH
    ...
    def load_config():
        try:
            if PropertyUtils.config is None:
                ...
                custom_config_file = os.getenv('MARKETDATA_CUSTOM_CONFIG_PATH')
                default_config_file = os.getenv("MARKETDATA_DEFAULT_PROPERTY_FILE")
