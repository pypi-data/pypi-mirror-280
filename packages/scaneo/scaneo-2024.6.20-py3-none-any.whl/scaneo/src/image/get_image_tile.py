...
def get_tile_data(file_path, name, xyz, bands, tile_size=(256, 256)):
    ...
    # print(f"1 in {toc - tic:0.8f} seconds")

    # convert src bounds to lat,lng
    # tic = time.perf_counter()
    bb = shapely.geometry.box(*src.bounds)
    # toc = time.perf_counter()
    # print(f"2 in {toc - tic:0.8f} seconds")
    ...
    # toc = time.perf_counter()
    # print(f"3 in {toc - tic:0.8f} seconds")
    ...
    # toc = time.perf_counter()
    # print(f"4 in {toc - tic:0.8f} seconds")
