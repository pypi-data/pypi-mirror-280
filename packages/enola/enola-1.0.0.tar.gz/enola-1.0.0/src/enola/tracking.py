...
from enola.step import Step, StepType
from enola.base.common.auth.auth_model import AuthModel
from enola.enola_types import EnolaSenderModel, KindType, DataListModel, DataType, ErrOrWarnKind, Info, TokenInfo, TrackingModel
...
class Tracking:
    def __init__(self, token, name, app_id=None, user_id=None, session_id=None, channel_id=None, ip=None, code_api=None, is_test=False, message_input: str = "", enola_id_prev:str = "", app_name:str="", user_name:str="", session_name:str="", channel_name:str=""):
        """
        ...
        #user information
        self.enola_sender = EnolaSenderModel(app_id=app_id, app_name=app_name, user_id=user_id, user_name=user_name, session_id=session_id, session_name=session_name, channel_id=channel_id, channel_name=channel_name, ip=ip, code_api=code_api)
    ...
    def execute(self, successfull: bool, message_output: str ="", num_iteratons: int = 0) -> bool:
        """
        ...
        """
        self.date_end = self.hf.get_date_for_api()
        self.duration_in_ms = self.hf.get_dif_ms(self.date_start, self.date_end)
