...
class Evaluation:
    def __init__(self, token, app_id=None, user_id=None, session_id=None, channel_id=None, ip=None, code_api=None, app_name:str="", user_name:str="", session_name:str="", channel_name:str=""):
        """
