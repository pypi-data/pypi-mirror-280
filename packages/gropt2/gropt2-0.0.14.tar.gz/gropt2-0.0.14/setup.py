...
sources = ['cg_iter', 'lsmr_iter', 'op_main', 'gropt_params', 'optimize', 'gropt_utils',
           ...
           'op_bval', 'logging', 'fft_helper', 'solver', 'minres_iter', 'minresqlp_iter']

sourcefiles = ['./cython_src/gropt2.pyx',] + ['./c_src/%s.cpp' % x for x in sources]
...
include_dirs.append("./c_src/fftw3/")

if sys.platform == 'darwin':
    library_dirs.append("/opt/homebrew/")
