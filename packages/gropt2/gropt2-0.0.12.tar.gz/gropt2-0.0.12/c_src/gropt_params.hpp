...
class GroptParams
{
    public:
        ...
        void get_debugger(std::vector<int> &sizes, std::vector<double> &out_x, std::vector<double> &out_weights, std::vector<int> &out_cgiter, std::vector<std::string> &out_names);
        double get_opt_time();
