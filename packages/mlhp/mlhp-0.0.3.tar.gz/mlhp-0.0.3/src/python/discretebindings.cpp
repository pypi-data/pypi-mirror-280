...
void definePartitioners( pybind11::module& m )
{
    ...
    m.def( "spaceTreeQuadrature", []( const ImplicitFunctionWrapper<D>& function, size_t depth, double epsilon )
           { return std::make_shared<SpaceTreeQuadrature<D>>( function, epsilon, depth ); },
           pybind11::arg( "function" ), pybind11::arg( "depth" ), pybind11::arg( "epsilon" ) = 1.0 );
    
    m.def( "momentFittingQuadrature", []( const ImplicitFunctionWrapper<D>& function, 
                                               size_t depth, double epsilon, bool adaptOrders )
           { return std::make_shared<MomentFittingQuadrature<D>>( function, epsilon, depth, adaptOrders ); },
           pybind11::arg( "function" ), pybind11::arg( "depth" ), pybind11::arg( "epsilon" ) = 1.0,
