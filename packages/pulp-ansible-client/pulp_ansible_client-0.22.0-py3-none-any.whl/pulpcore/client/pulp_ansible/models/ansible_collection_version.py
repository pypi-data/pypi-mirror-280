...
class AnsibleCollectionVersion(object):
    ...
    def __init__(self, upload=None, file=None, artifact=None, repository=None, expected_name=None, expected_namespace=None, expected_version=None, local_vars_configuration=None):  # noqa: E501
