...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, url=None, max_retries=None, client_cert=None, tls_validation=None, total_timeout=None, connect_timeout=None, rate_limit=None, sock_read_timeout=None, download_concurrency=None, headers=None, proxy_url=None, ca_cert=None, sock_connect_timeout=None, pulp_labels=None, hidden_fields=None, name=None, pulp_href=None, pulp_created=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
