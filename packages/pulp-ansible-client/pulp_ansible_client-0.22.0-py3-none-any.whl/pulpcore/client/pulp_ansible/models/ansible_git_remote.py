...
class AnsibleGitRemote(object):
    ...
    def __init__(self, url=None, max_retries=None, client_cert=None, tls_validation=None, client_key=None, proxy_username=None, total_timeout=None, connect_timeout=None, proxy_password=None, rate_limit=None, password=None, sock_read_timeout=None, download_concurrency=None, headers=None, proxy_url=None, ca_cert=None, username=None, sock_connect_timeout=None, pulp_labels=None, name=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
