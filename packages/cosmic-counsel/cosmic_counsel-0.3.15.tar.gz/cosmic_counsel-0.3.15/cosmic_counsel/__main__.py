...
def main():
    if args.directory:
        ...
        with open(os.makedirs(os.path.dirname(context_index_path), exist_ok=True), 'wb') as f:
    ...
    if args.question:
        context_index_path = f'{parent_dir_path}/data/context_index.pkl'
        with open(os.makedirs(os.path.dirname(context_index_path), exist_ok=True), 'rb') as f:
