...
chat_history_path = os.path.join(parent_dir_path, 'chat_history.json')
...
def main():
    if args.directory:
        ...
        with open(os.path.join(parent_dir_path, 'context_index.pkl'), 'wb') as f:
    ...
    if args.output:
        ...
        output_file = os.path.join(parent_dir_path,'output.json')

    if args.question:
        with open(os.path.join(parent_dir_path, 'context_index.pkl'), 'rb') as f:
