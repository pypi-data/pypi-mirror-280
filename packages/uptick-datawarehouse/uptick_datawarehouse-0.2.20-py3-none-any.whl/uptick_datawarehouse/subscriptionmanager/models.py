...
class RevenueForecastSummary(models.Model):
    ...
    total_contract_paying_value = models.DecimalField(max_digits=10, decimal_places=2, null=True)
    ...
    downgrades_contract = models.DecimalField(max_digits=10, decimal_places=2, null=True)
...
class SubscriptionSummary(models.Model):
    ...
    superseded_subscription_contract_value= models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    superseded_subscription_upgrade_or_downgrade_amount= models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
...
class AddonSummary(models.Model):
    ...
    price_aud = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    price_nzd = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    price_gbp = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    price_cad = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
...
class ConsolidatedProfitAndLossMonth(models.Model):
    ...
    reporting_fx_rate = models.DecimalField(max_digits=12, decimal_places=4, default=decimal.Decimal("0.0000"))
    reporting_subtotal = models.DecimalField(max_digits=10, decimal_places=2, default=decimal.Decimal("0.00"))
