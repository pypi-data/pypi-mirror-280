...
from pulpcore.client.pulp_container.api.exporters_pulp_exports_api import ExportersPulpExportsApi  # noqa: E501
...
class TestExportersPulpExportsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.exporters_pulp_exports_api.ExportersPulpExportsApi()  # noqa: E501
