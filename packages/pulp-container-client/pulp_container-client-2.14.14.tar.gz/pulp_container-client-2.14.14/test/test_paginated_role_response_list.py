...
from pulpcore.client.pulp_container.models.paginated_role_response_list import PaginatedRoleResponseList  # noqa: E501
...
class TestPaginatedRoleResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pulpcore.client.pulp_container.models.paginated_role_response_list.PaginatedRoleResponseList()  # noqa: E501
        if include_optional :
            return PaginatedRoleResponseList(
                ...
                results = [
                    pulpcore.client.pulp_container.models.role_response.RoleResponse(
                        pulp_href = '0', 
