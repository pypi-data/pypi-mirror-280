...
from pulpcore.client.pulp_container.api.exporters_filesystem_exports_api import ExportersFilesystemExportsApi  # noqa: E501
...
class TestExportersFilesystemExportsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.exporters_filesystem_exports_api.ExportersFilesystemExportsApi()  # noqa: E501
