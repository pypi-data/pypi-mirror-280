...
from pulpcore.client.pulp_container.api.task_schedules_api import TaskSchedulesApi  # noqa: E501
...
class TestTaskSchedulesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.task_schedules_api.TaskSchedulesApi()  # noqa: E501
