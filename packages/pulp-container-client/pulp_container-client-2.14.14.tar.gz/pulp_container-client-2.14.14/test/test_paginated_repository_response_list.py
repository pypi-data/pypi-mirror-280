...
from pulpcore.client.pulp_container.models.paginated_repository_response_list import PaginatedRepositoryResponseList  # noqa: E501
...
class TestPaginatedRepositoryResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pulpcore.client.pulp_container.models.paginated_repository_response_list.PaginatedRepositoryResponseList()  # noqa: E501
        if include_optional :
            return PaginatedRepositoryResponseList(
                ...
                results = [
                    pulpcore.client.pulp_container.models.repository_response.RepositoryResponse(
                        pulp_href = '0', 
