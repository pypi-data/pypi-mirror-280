...
from pulpcore.client.pulp_container.models.method_enum import MethodEnum  # noqa: E501
...
class TestMethodEnum(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pulpcore.client.pulp_container.models.method_enum.MethodEnum()  # noqa: E501
        if include_optional :
            return MethodEnum(
            )
        else :
