...
from pulpcore.client.pulp_container.models.states_enum import StatesEnum  # noqa: E501
...
class TestStatesEnum(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pulpcore.client.pulp_container.models.states_enum.StatesEnum()  # noqa: E501
        if include_optional :
            return StatesEnum(
            )
        else :
