...
from pulpcore.client.pulp_container.models.upload_chunk import UploadChunk  # noqa: E501
...
class TestUploadChunk(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pulpcore.client.pulp_container.models.upload_chunk.UploadChunk()  # noqa: E501
        if include_optional :
            return UploadChunk(
                file = bytes(b'blah'), 
                sha256 = '0'
