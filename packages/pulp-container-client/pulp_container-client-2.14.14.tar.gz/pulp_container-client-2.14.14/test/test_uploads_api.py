...
from pulpcore.client.pulp_container.api.uploads_api import UploadsApi  # noqa: E501
...
class TestUploadsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.uploads_api.UploadsApi()  # noqa: E501
