...
from pulpcore.client.pulp_container.api.importers_pulp_api import ImportersPulpApi  # noqa: E501
...
class TestImportersPulpApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.importers_pulp_api.ImportersPulpApi()  # noqa: E501
