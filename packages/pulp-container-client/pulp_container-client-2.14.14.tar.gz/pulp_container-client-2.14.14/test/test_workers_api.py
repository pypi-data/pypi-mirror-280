...
from pulpcore.client.pulp_container.api.workers_api import WorkersApi  # noqa: E501
...
class TestWorkersApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.workers_api.WorkersApi()  # noqa: E501
