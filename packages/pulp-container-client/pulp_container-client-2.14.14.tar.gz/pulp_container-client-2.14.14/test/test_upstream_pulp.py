...
from pulpcore.client.pulp_container.models.upstream_pulp import UpstreamPulp  # noqa: E501
...
class TestUpstreamPulp(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pulpcore.client.pulp_container.models.upstream_pulp.UpstreamPulp()  # noqa: E501
        if include_optional :
            return UpstreamPulp(
                name = '0', 
                base_url = '0', 
