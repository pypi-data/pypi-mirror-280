...
from pulpcore.client.pulp_container.api.orphans_api import OrphansApi  # noqa: E501
...
class TestOrphansApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.orphans_api.OrphansApi()  # noqa: E501
