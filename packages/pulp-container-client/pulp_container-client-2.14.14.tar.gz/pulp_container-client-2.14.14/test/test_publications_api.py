...
from pulpcore.client.pulp_container.api.publications_api import PublicationsApi  # noqa: E501
...
class TestPublicationsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.publications_api.PublicationsApi()  # noqa: E501
