...
from pulpcore.client.pulp_container.models.paginated_upload_response_list import PaginatedUploadResponseList  # noqa: E501
...
class TestPaginatedUploadResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pulpcore.client.pulp_container.models.paginated_upload_response_list.PaginatedUploadResponseList()  # noqa: E501
        if include_optional :
            return PaginatedUploadResponseList(
                ...
                results = [
                    pulpcore.client.pulp_container.models.upload_response.UploadResponse(
                        pulp_href = '0', 
