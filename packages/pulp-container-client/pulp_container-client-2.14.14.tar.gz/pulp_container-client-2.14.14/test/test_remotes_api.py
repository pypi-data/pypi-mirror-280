...
from pulpcore.client.pulp_container.api.remotes_api import RemotesApi  # noqa: E501
...
class TestRemotesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.remotes_api.RemotesApi()  # noqa: E501
