...
from pulpcore.client.pulp_container.models.pulp_importer import PulpImporter  # noqa: E501
...
class TestPulpImporter(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pulpcore.client.pulp_container.models.pulp_importer.PulpImporter()  # noqa: E501
        if include_optional :
            return PulpImporter(
                name = '0', 
                repo_mapping = {
