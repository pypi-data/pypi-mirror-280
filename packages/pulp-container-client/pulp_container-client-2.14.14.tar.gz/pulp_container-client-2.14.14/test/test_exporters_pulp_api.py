...
from pulpcore.client.pulp_container.api.exporters_pulp_api import ExportersPulpApi  # noqa: E501
...
class TestExportersPulpApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.exporters_pulp_api.ExportersPulpApi()  # noqa: E501
