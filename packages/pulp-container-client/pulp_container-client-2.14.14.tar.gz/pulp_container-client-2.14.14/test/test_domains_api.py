...
from pulpcore.client.pulp_container.api.domains_api import DomainsApi  # noqa: E501
...
class TestDomainsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.domains_api.DomainsApi()  # noqa: E501
