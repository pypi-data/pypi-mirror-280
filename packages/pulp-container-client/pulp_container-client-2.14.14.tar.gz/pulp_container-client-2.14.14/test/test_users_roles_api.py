...
from pulpcore.client.pulp_container.api.users_roles_api import UsersRolesApi  # noqa: E501
...
class TestUsersRolesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.users_roles_api.UsersRolesApi()  # noqa: E501
