...
from pulpcore.client.pulp_container.api.distributions_api import DistributionsApi  # noqa: E501
...
class TestDistributionsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.distributions_api.DistributionsApi()  # noqa: E501
