...
from pulpcore.client.pulp_container.api.importers_pulp_imports_api import ImportersPulpImportsApi  # noqa: E501
...
class TestImportersPulpImportsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.importers_pulp_imports_api.ImportersPulpImportsApi()  # noqa: E501
