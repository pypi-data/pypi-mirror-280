...
from pulpcore.client.pulp_container.api.content_api import ContentApi  # noqa: E501
...
class TestContentApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.content_api.ContentApi()  # noqa: E501
