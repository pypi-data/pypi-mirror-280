...
from pulpcore.client.pulp_container.api.artifacts_api import ArtifactsApi  # noqa: E501
...
class TestArtifactsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.artifacts_api.ArtifactsApi()  # noqa: E501
