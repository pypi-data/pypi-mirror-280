...
from pulpcore.client.pulp_container.api.repositories_api import RepositoriesApi  # noqa: E501
...
class TestRepositoriesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.repositories_api.RepositoriesApi()  # noqa: E501
