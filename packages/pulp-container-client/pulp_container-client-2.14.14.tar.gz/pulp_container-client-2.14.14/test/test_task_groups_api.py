...
from pulpcore.client.pulp_container.api.task_groups_api import TaskGroupsApi  # noqa: E501
...
class TestTaskGroupsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.task_groups_api.TaskGroupsApi()  # noqa: E501
