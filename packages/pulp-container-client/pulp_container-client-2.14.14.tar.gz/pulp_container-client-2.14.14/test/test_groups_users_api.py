...
from pulpcore.client.pulp_container.api.groups_users_api import GroupsUsersApi  # noqa: E501
...
class TestGroupsUsersApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.groups_users_api.GroupsUsersApi()  # noqa: E501
