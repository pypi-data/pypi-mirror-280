...
from pulpcore.client.pulp_container.api.signing_services_api import SigningServicesApi  # noqa: E501
...
class TestSigningServicesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.signing_services_api.SigningServicesApi()  # noqa: E501
