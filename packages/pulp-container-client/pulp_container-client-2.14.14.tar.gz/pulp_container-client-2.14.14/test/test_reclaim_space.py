...
from pulpcore.client.pulp_container.models.reclaim_space import ReclaimSpace  # noqa: E501
...
class TestReclaimSpace(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pulpcore.client.pulp_container.models.reclaim_space.ReclaimSpace()  # noqa: E501
        if include_optional :
            return ReclaimSpace(
                repo_hrefs = [
                    null
