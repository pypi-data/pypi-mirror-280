...
from pulpcore.client.pulp_container.api.distributions_artifacts_api import DistributionsArtifactsApi  # noqa: E501
...
class TestDistributionsArtifactsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.distributions_artifacts_api.DistributionsArtifactsApi()  # noqa: E501
