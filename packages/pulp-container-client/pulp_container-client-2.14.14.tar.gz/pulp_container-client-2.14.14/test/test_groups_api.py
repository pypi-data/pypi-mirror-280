...
from pulpcore.client.pulp_container.api.groups_api import GroupsApi  # noqa: E501
...
class TestGroupsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_container.api.groups_api.GroupsApi()  # noqa: E501
