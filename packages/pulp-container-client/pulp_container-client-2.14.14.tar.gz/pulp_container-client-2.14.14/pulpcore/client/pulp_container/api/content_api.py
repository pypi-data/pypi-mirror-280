...
class ContentApi(object):
    ...
    def list(self,  **kwargs):  # noqa: E501
        ...
        :param list[str] pulp_type__in: Pulp type is in  * `core.publishedmetadata` - core.publishedmetadata * `container.blob` - container.blob * `container.manifest` - container.manifest * `container.tag` - container.tag * `container.signature` - container.signature
