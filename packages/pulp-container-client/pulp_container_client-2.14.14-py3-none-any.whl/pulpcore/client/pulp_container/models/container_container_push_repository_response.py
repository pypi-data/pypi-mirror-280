...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_href=None, description=None, retain_repo_versions=None, manifest_signing_service=None, pulp_created=None, name=None, versions_href=None, latest_version_href=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
