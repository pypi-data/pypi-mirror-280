...
@lru_cache
def _build_execution_name(target_image: str, version: Optional[int] = None):
    """
    ...
    """
    _ex_name = "u" + hashlib.sha256(target_image.encode()).hexdigest()[:20]
...
def _recover_terminated_image_build_execution(
    ...
    recover_ex_id = _build_execution_name(target_image, latest_version + 1)
