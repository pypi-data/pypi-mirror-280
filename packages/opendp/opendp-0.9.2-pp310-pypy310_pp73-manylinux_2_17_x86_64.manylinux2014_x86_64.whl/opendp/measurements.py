...
def make_geometric(
    ...
    [make_geometric in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_geometric.html)
...
def make_laplace_threshold(
    ...
    [make_laplace_threshold in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_laplace_threshold.html)
...
def make_private_expr(
    ...
    [make_private_expr in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_private_expr.html)
...
def make_private_lazyframe(
    ...
    [make_private_lazyframe in Rust documentation.](https://docs.rs/opendp/0.9.2/opendp/measurements/fn.make_private_lazyframe.html)
