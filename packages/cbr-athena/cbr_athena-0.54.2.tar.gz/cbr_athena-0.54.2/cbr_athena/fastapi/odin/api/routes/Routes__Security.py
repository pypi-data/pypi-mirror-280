...
from cbr_athena.fastapi.odin.api.Odin__EC2      import Odin__EC2
...
class Routes__Security(Fast_API__Routes):
    ...
    def add_routes(self):
        ...
        def ips_attacking_odin():
            ...
            ip_traffic_details = 'http://localhost:5001/dev/logs/ip-address?ip_address={ip_address}&env=PROD&hours=24'
            ip_data = IP_Data()
            try:
