...
class TestListTable(unittest.TestCase):
    def setUp(self):
        ...
        meta = metadata_thrift.SSTableMetadata(
                ...
                total_count=10)
        builder.add_metadata('sstable_meta', serialize(meta))
    ...
    def test_get_metadata(self):
        data = self.mbtable.get_metadata('sstable_meta')
        meta = deserialize(metadata_thrift.SSTableMetadata(), data)
        ...
        data = self.mbtable.get_file_metadata('sstable_meta')
        meta = deserialize(metadata_thrift.SSTableMetadata(), data)
        self.assertEqual('list_table', meta.table_type)
        self.assertEqual(10, meta.total_count)
