"use strict";
(self["webpackChunkclimb_onyx_ui"] = self["webpackChunkclimb_onyx_ui"] || []).push([["lib_index_js"],{
...
class ReactAppWidget extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((climb_onyx_gui__WEBPACK_IMPORTED_MODULE_2___default()), { httpPathHandler: this.routeHandler, s3PathHandler: this.s3PathHandler, fileWriter: this.fileWriter, extVersion: this.version }));
    }
}
...
async function requestAPI(endPoint = '', init = {}, param = ['', ''], param2 = ['', '']) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_1__.URLExt.join(settings.baseUrl, 'climb-onyx-ui', endPoint);
...
const plugin = {
    ...
    activate: (app, palette, documentManager, launcher, htmlTracker) => {
        ...
        const category = 'Onyx';
        let version = '';
        (0,_handler__WEBPACK_IMPORTED_MODULE_5__.requestAPI)('version')
            .then(data => {
        ...
        const s3_open_function = (s3_link) => {
            (0,_handler__WEBPACK_IMPORTED_MODULE_5__.requestAPI)('s3', {}, ['s3location', s3_link])
                ...
                .catch(reason => {
                console.error(`The climb-onyx-ui server extension appears to be missing.\n${reason}`);
            });
        };
        const write_file_function = (path, content) => {
            const dataToSend = { content: content };
            (0,_handler__WEBPACK_IMPORTED_MODULE_5__.requestAPI)('file-write', {
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => {
                if (!widget || widget.disposed) {
                    const content = new _App__WEBPACK_IMPORTED_MODULE_7__.ReactAppWidget(routeHandler, s3_open_function, write_file_function, version);
...
//# sourceMappingURL=lib_index_js.9c5341e2a8b5851e655d.js.map