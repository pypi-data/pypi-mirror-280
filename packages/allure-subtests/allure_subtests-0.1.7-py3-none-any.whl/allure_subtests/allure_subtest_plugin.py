...
class AllureSubTests:
    ...
    def test(
        ...
        teardown_subtest: Callable[[str], None] | None = None,
        **kwargs: Any,
        ...
        with self._capturing_output() as captured_output, self._capturing_logs() as captured_logs:
            ...
            self.update_subtest_status(start, exc_info, subtest_name, stack_trace_str)
    ...
    def update_subtest_status(self, start: int, exc_info, msg, stack_trace_str, call_info=None):
