        ...
        <table class="hover_table">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="col_number" title="Total HT des factures de MooGLi ${current_exercice_period_label}">
                    ...
                    <th scope="col" class="col_number archive" title="Total HT des factures de MooGLi ${previous_exercice_period_label}">
                    ...
                    <th scope="col" class="col_number" title="Total HT des notes de dépenses de MooGLi ${current_exercice_period_label}">
                        Dépenses<br><small>${current_exercice['label']}</small>
                    </th>
                    <th scope="col" class="col_number archive" title="Total HT des notes de dépenses de MooGLi ${previous_exercice_period_label}">
                        Dépenses<br><small>${previous_exercice['label']}</small>
                    </th>
                    <th scope="col" class="col_number" title="Total HT des factures fournisseur de MooGLi ${current_exercice_period_label}">
                        Achats<br><small>${current_exercice['label']}</small>
                    </th>
                    <th scope="col" class="col_number archive" title="Total HT des factures fournisseur de MooGLi ${previous_exercice_period_label}">
                    ...
                    <th scope="col" class="col_number" title="Total des kilomètres saisis dans de MooGLi ${current_exercice_period_label}">
                    ...
                    <th scope="col" class="col_number archive" title="Total des kilomètres saisis dans de MooGLi ${previous_exercice_period_label}">
