...
def get_config_file(file_type='json', config_type=0, file_path=None):
    '''
    file_type='json': 文件类型
    ...
    if file_type == file_type_json:
        json_file = open(get_config_path(file_type=file_type, config_type=config_type, file_path=file_path), encoding='utf-8', mode='r')
...
def get_config_path(file_type=None, config_type=0, file_path=None):
