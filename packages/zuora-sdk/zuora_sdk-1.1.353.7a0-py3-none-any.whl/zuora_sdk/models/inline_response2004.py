...
class InlineResponse2004(CommonResponse):
    ...
    def job_id(self):
        ...
        String of 32 characters that identifies the BookingDate Backfill job.  The id is generated before the backfill job is processed.  You can use the id to get the BookingDate Backfill job result.  # noqa: E501
