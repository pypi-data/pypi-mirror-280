...
class CreateOrderProductRatePlanOverride(object):
    ...
    def __init__(self, charge_overrides=None, clearing_existing_features=None, custom_fields=None, external_catalog_plan_id=None, externally_managed_plan_id=None, product_rate_plan_id=None, product_rate_plan_number=None, subscription_product_features=None, unique_token=None):  # noqa: E501
        """CreateOrderProductRatePlanOverride - a model defined in Swagger"""  # noqa: E501
    ...
    def charge_overrides(self):
        """Gets the charge_overrides of this CreateOrderProductRatePlanOverride.  # noqa: E501

        List of charges associated with the rate plan.   # noqa: E501

        :return: The charge_overrides of this CreateOrderProductRatePlanOverride.  # noqa: E501
    ...
    def charge_overrides(self, charge_overrides):
        """Sets the charge_overrides of this CreateOrderProductRatePlanOverride.

        List of charges associated with the rate plan.   # noqa: E501

        :param charge_overrides: The charge_overrides of this CreateOrderProductRatePlanOverride.  # noqa: E501
    ...
    def clearing_existing_features(self):
        """Gets the clearing_existing_features of this CreateOrderProductRatePlanOverride.  # noqa: E501

        Specifies whether all features in the rate plan will be cleared.   # noqa: E501

        :return: The clearing_existing_features of this CreateOrderProductRatePlanOverride.  # noqa: E501
        :rtype: bool
        """
    ...
    def clearing_existing_features(self, clearing_existing_features):
        """Sets the clearing_existing_features of this CreateOrderProductRatePlanOverride.

        Specifies whether all features in the rate plan will be cleared.   # noqa: E501

        :param clearing_existing_features: The clearing_existing_features of this CreateOrderProductRatePlanOverride.  # noqa: E501
        :type: bool
        """
    ...
    def custom_fields(self):
        """Gets the custom_fields of this CreateOrderProductRatePlanOverride.  # noqa: E501
        ...
        :return: The custom_fields of this CreateOrderProductRatePlanOverride.  # noqa: E501
    ...
    def custom_fields(self, custom_fields):
        """Sets the custom_fields of this CreateOrderProductRatePlanOverride.

        Container for custom fields of the Rate Plan object. The custom fields of the Rate Plan object are used when rate plans are subscribed.   # noqa: E501

        :param custom_fields: The custom_fields of this CreateOrderProductRatePlanOverride.  # noqa: E501
    ...
    def external_catalog_plan_id(self):
        """Gets the external_catalog_plan_id of this CreateOrderProductRatePlanOverride.  # noqa: E501
        ...
        :return: The external_catalog_plan_id of this CreateOrderProductRatePlanOverride.  # noqa: E501
        :rtype: str
        """
    ...
    def external_catalog_plan_id(self, external_catalog_plan_id):
        """Sets the external_catalog_plan_id of this CreateOrderProductRatePlanOverride.

        An external ID of the product rate plan to be added. You can use this field to specify a product rate plan that is imported from an external system. The value of the `externalCatalogPlanId` field must match one of the values that are predefined in the `externallyManagedPlanIds` field on a product rate plan.  **Note:** If both `externalCatalogPlanId` and `productRatePlanId` are provided. They must point to the same product rate plan. Otherwise, the request would fail.   # noqa: E501

        :param external_catalog_plan_id: The external_catalog_plan_id of this CreateOrderProductRatePlanOverride.  # noqa: E501
        :type: str
        """
    ...
    def externally_managed_plan_id(self):
        """Gets the externally_managed_plan_id of this CreateOrderProductRatePlanOverride.  # noqa: E501
        ...
        :return: The externally_managed_plan_id of this CreateOrderProductRatePlanOverride.  # noqa: E501
        :rtype: str
        """
    ...
    def externally_managed_plan_id(self, externally_managed_plan_id):
        """Sets the externally_managed_plan_id of this CreateOrderProductRatePlanOverride.

        Indicates the unique identifier for the rate plan purchased on a third-party store. This field is used to represent a subscription rate plan created through third-party stores.   # noqa: E501

        :param externally_managed_plan_id: The externally_managed_plan_id of this CreateOrderProductRatePlanOverride.  # noqa: E501
        :type: str
        """
    ...
    def product_rate_plan_id(self):
        """Gets the product_rate_plan_id of this CreateOrderProductRatePlanOverride.  # noqa: E501

        Internal identifier of the product rate plan that the rate plan is based on.   # noqa: E501

        :return: The product_rate_plan_id of this CreateOrderProductRatePlanOverride.  # noqa: E501
        :rtype: str
        """
    ...
    def product_rate_plan_id(self, product_rate_plan_id):
        """Sets the product_rate_plan_id of this CreateOrderProductRatePlanOverride.

        Internal identifier of the product rate plan that the rate plan is based on.   # noqa: E501

        :param product_rate_plan_id: The product_rate_plan_id of this CreateOrderProductRatePlanOverride.  # noqa: E501
        :type: str
        """
    ...
    def product_rate_plan_number(self):
        """Gets the product_rate_plan_number of this CreateOrderProductRatePlanOverride.  # noqa: E501

        Number of a product rate plan for this subscription.   # noqa: E501

        :return: The product_rate_plan_number of this CreateOrderProductRatePlanOverride.  # noqa: E501
        :rtype: str
        """
    ...
    def product_rate_plan_number(self, product_rate_plan_number):
        """Sets the product_rate_plan_number of this CreateOrderProductRatePlanOverride.

        Number of a product rate plan for this subscription.   # noqa: E501

        :param product_rate_plan_number: The product_rate_plan_number of this CreateOrderProductRatePlanOverride.  # noqa: E501
        :type: str
        """
    ...
    def subscription_product_features(self):
        """Gets the subscription_product_features of this CreateOrderProductRatePlanOverride.  # noqa: E501
        ...
        :return: The subscription_product_features of this CreateOrderProductRatePlanOverride.  # noqa: E501
    ...
    def subscription_product_features(self, subscription_product_features):
        """Sets the subscription_product_features of this CreateOrderProductRatePlanOverride.

        List of features associated with the rate plan. The system compares the `subscriptionProductFeatures` and `featureId` fields in the request with the counterpart fields in a rate plan. The comparison results are as follows: * If there is no `subscriptionProductFeatures` field or the field is empty, features in the rate plan remain unchanged. But if the `clearingExistingFeatures` field is additionally set to true, all features in the rate plan are cleared. * If the `subscriptionProductFeatures` field contains the `featureId` nested fields, as well as the optional `description` and `customFields` nested fields, the features indicated by the featureId nested fields in the request overwrite all features in the rate plan.   # noqa: E501

        :param subscription_product_features: The subscription_product_features of this CreateOrderProductRatePlanOverride.  # noqa: E501
    ...
    def unique_token(self):
        """Gets the unique_token of this CreateOrderProductRatePlanOverride.  # noqa: E501
        ...
        :return: The unique_token of this CreateOrderProductRatePlanOverride.  # noqa: E501
        :rtype: str
        """
    ...
    def unique_token(self, unique_token):
        """Sets the unique_token of this CreateOrderProductRatePlanOverride.

        Unique identifier for the rate plan. This identifier enables you to refer to the rate plan before the rate plan has an internal identifier in Zuora.  For instance, suppose that you want to use a single order to add a product to a subscription and later update the same product. When you add the product, you can set a unique identifier for the rate plan. Then when you update the product, you can use the same unique identifier to specify which rate plan to modify.   # noqa: E501

        :param unique_token: The unique_token of this CreateOrderProductRatePlanOverride.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateOrderProductRatePlanOverride, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateOrderProductRatePlanOverride):
            return False
