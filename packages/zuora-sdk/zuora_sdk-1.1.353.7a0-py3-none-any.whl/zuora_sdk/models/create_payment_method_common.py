...
class CreatePaymentMethodCommon(object):
    ...
    def __init__(self, account_key=None, auth_gateway=None, ip_address=None, make_default=False):  # noqa: E501
        """CreatePaymentMethodCommon - a model defined in Swagger"""  # noqa: E501
    ...
    def account_key(self):
        """Gets the account_key of this CreatePaymentMethodCommon.  # noqa: E501

        Internal ID of the customer account that will own the payment method.   # noqa: E501

        :return: The account_key of this CreatePaymentMethodCommon.  # noqa: E501
        :rtype: str
        """
    ...
    def account_key(self, account_key):
        """Sets the account_key of this CreatePaymentMethodCommon.

        Internal ID of the customer account that will own the payment method.   # noqa: E501

        :param account_key: The account_key of this CreatePaymentMethodCommon.  # noqa: E501
        :type: str
        """
    ...
    def auth_gateway(self):
        """Gets the auth_gateway of this CreatePaymentMethodCommon.  # noqa: E501
        ...
        :return: The auth_gateway of this CreatePaymentMethodCommon.  # noqa: E501
        :rtype: str
        """
    ...
    def auth_gateway(self, auth_gateway):
        """Sets the auth_gateway of this CreatePaymentMethodCommon.

        Internal ID of the payment gateway that Zuora will use to authorize the payments that are made with the payment method.  If you do not set this field, Zuora will use one of the following payment gateways instead:  * The default payment gateway of the customer account that owns the payment method, if the `accountKey` field is set. * The default payment gateway of your Zuora tenant, if the `accountKey` field is not set.   # noqa: E501

        :param auth_gateway: The auth_gateway of this CreatePaymentMethodCommon.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ip_address(self):
        """Gets the ip_address of this CreatePaymentMethodCommon.  # noqa: E501
        ...
        :return: The ip_address of this CreatePaymentMethodCommon.  # noqa: E501
        :rtype: str
        """
    ...
    def ip_address(self, ip_address):
        """Sets the ip_address of this CreatePaymentMethodCommon.

        The IPv4 or IPv6 information of the user when the payment method is created or updated. Some gateways use this field for fraud prevention. If this field is passed to Zuora, Zuora directly passes it to gateways.   If the IP address length is beyond 45 characters, a validation error occurs.  For validating SEPA payment methods on Stripe v2, this field is required.   # noqa: E501

        :param ip_address: The ip_address of this CreatePaymentMethodCommon.  # noqa: E501
        :type: str
        """
    ...
    def make_default(self):
        """Gets the make_default of this CreatePaymentMethodCommon.  # noqa: E501
        ...
        :return: The make_default of this CreatePaymentMethodCommon.  # noqa: E501
        :rtype: bool
        """
    ...
    def make_default(self, make_default):
        """Sets the make_default of this CreatePaymentMethodCommon.

        Specifies whether the payment method will be the default payment method of the customer account that owns the payment method. Only applicable if the `accountKey` field is set.   # noqa: E501

        :param make_default: The make_default of this CreatePaymentMethodCommon.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreatePaymentMethodCommon, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePaymentMethodCommon):
            return False
