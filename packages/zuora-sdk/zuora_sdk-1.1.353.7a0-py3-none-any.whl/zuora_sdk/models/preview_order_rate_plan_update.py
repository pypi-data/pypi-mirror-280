...
class PreviewOrderRatePlanUpdate(object):
    ...
    def __init__(self, charge_updates=None, clearing_existing_features=None, custom_fields=None, product_rate_plan_number=None, rate_plan_id=None, specific_update_date=None, subscription_product_features=None, subscription_rate_plan_number=None, unique_token=None):  # noqa: E501
