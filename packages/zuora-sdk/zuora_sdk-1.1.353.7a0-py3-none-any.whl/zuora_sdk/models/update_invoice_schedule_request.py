...
class UpdateInvoiceScheduleRequest(object):
    ...
    swagger_types = {
        ...
        'notes': 'str',
        'orders': 'list[str]',
        'schedule_items': 'list[UpdateInvoiceScheduleItem]',
    ...
    def __init__(self, additional_subscriptions_to_bill=None, invoice_separately=None, next_run_date=None, notes=None, orders=None, schedule_items=None, specific_subscriptions=None):  # noqa: E501
        """UpdateInvoiceScheduleRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def additional_subscriptions_to_bill(self):
        """Gets the additional_subscriptions_to_bill of this UpdateInvoiceScheduleRequest.  # noqa: E501
        ...
        :return: The additional_subscriptions_to_bill of this UpdateInvoiceScheduleRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def additional_subscriptions_to_bill(self, additional_subscriptions_to_bill):
        """Sets the additional_subscriptions_to_bill of this UpdateInvoiceScheduleRequest.

        A list of the numbers of the subscriptions that need to be billed together with the invoice schedule.   One invoice schedule can have at most 600 additional subscriptions.   # noqa: E501

        :param additional_subscriptions_to_bill: The additional_subscriptions_to_bill of this UpdateInvoiceScheduleRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    def invoice_separately(self):
        """Gets the invoice_separately of this UpdateInvoiceScheduleRequest.  # noqa: E501
        ...
        :return: The invoice_separately of this UpdateInvoiceScheduleRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def invoice_separately(self, invoice_separately):
        """Sets the invoice_separately of this UpdateInvoiceScheduleRequest.

        Whether the invoice items created from the invoice schedule appears on a separate invoice when Zuora generates invoices.   # noqa: E501

        :param invoice_separately: The invoice_separately of this UpdateInvoiceScheduleRequest.  # noqa: E501
        :type: bool
        """
    ...
    def next_run_date(self):
        """Gets the next_run_date of this UpdateInvoiceScheduleRequest.  # noqa: E501

        The run date of the next execution of the invoice schedule.   By default, the next run date is the same as the run date of next pending invoice schedule item. The date can be overwritten by a different date other than the default value. If the invoice schedule has completed the execution, the next run date is `null`.   # noqa: E501

        :return: The next_run_date of this UpdateInvoiceScheduleRequest.  # noqa: E501
        :rtype: date
        """
    ...
    def next_run_date(self, next_run_date):
        """Sets the next_run_date of this UpdateInvoiceScheduleRequest.

        The run date of the next execution of the invoice schedule.   By default, the next run date is the same as the run date of next pending invoice schedule item. The date can be overwritten by a different date other than the default value. If the invoice schedule has completed the execution, the next run date is `null`.   # noqa: E501

        :param next_run_date: The next_run_date of this UpdateInvoiceScheduleRequest.  # noqa: E501
        :type: date
        """
    ...
    @property
    def notes(self):
        """Gets the notes of this UpdateInvoiceScheduleRequest.  # noqa: E501

        Comments on the invoice schedule.   # noqa: E501

        :return: The notes of this UpdateInvoiceScheduleRequest.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this UpdateInvoiceScheduleRequest.

        Comments on the invoice schedule.   # noqa: E501

        :param notes: The notes of this UpdateInvoiceScheduleRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def orders(self):
        """Gets the orders of this UpdateInvoiceScheduleRequest.  # noqa: E501

        A list of the IDs or numbers of the orders associated with the invoice schedule. One invoice schedule can be associated with at most 10 orders.  The orders specified in this field override all the existing orders associated with the invoice schedule.   # noqa: E501

        :return: The orders of this UpdateInvoiceScheduleRequest.  # noqa: E501
        :rtype: list[str]
        """
        return self._orders
    ...
    def orders(self, orders):
        """Sets the orders of this UpdateInvoiceScheduleRequest.

        A list of the IDs or numbers of the orders associated with the invoice schedule. One invoice schedule can be associated with at most 10 orders.  The orders specified in this field override all the existing orders associated with the invoice schedule.   # noqa: E501

        :param orders: The orders of this UpdateInvoiceScheduleRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    def schedule_items(self):
        """Gets the schedule_items of this UpdateInvoiceScheduleRequest.  # noqa: E501

        Container for invoice schedule items. The maximum number of schedule items is 50.  The invoice schedule items specified in this field override all the existing invoice schedule items.   # noqa: E501

        :return: The schedule_items of this UpdateInvoiceScheduleRequest.  # noqa: E501
        :rtype: list[UpdateInvoiceScheduleItem]
        """
        return self._schedule_items

    @schedule_items.setter
    def schedule_items(self, schedule_items):
        """Sets the schedule_items of this UpdateInvoiceScheduleRequest.

        Container for invoice schedule items. The maximum number of schedule items is 50.  The invoice schedule items specified in this field override all the existing invoice schedule items.   # noqa: E501

        :param schedule_items: The schedule_items of this UpdateInvoiceScheduleRequest.  # noqa: E501
        :type: list[UpdateInvoiceScheduleItem]
        """
    ...
    def specific_subscriptions(self):
        """Gets the specific_subscriptions of this UpdateInvoiceScheduleRequest.  # noqa: E501
        ...
        :return: The specific_subscriptions of this UpdateInvoiceScheduleRequest.  # noqa: E501
    ...
    def specific_subscriptions(self, specific_subscriptions):
        """Sets the specific_subscriptions of this UpdateInvoiceScheduleRequest.

        A list of the numbers of specific subscriptions associated with the invoice schedule.  - If the subscriptions specified in this field belong to the orders specified in the `orders` field, only the specific subscriptions instead of the orders are associated with the invoice schedule.  - If only the `orders` field is specified, all the subscriptions from the order are associated with the invoice schedule.    The specific subscriptions specified in this field override all the existing specific subscriptions associated with the invoice schedule.  Example: ``` {   \"orders\": [     \"O-00000001\", \"O-00000002\"   ],   \"specificSubscriptions\": [     {       \"orderKey\": \"O-00000001\",       \"subscriptionKey\": \"S-00000001\"     }   ] } ``` - For the order with number O-00000001, only subscription S-00000001 contained in the order is associated with the invoice schedule. - For the order with number O-00000002, all subscriptions contained in the order are associated with the invoice schedule.   # noqa: E501

        :param specific_subscriptions: The specific_subscriptions of this UpdateInvoiceScheduleRequest.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateInvoiceScheduleRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateInvoiceScheduleRequest):
            return False
