...
class TaxationItemsApi(object):
    ...
    def create_taxation_item(self, body, **kwargs):  # noqa: E501
        """CRUD: Create a taxation item  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_taxation_item(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ProxyCreateTaxationItemRequest body: (required)
        ...
        if kwargs.get('async_req'):
            return self.create_taxation_item_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_taxation_item_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_taxation_item_with_http_info(self, body, **kwargs):  # noqa: E501
        """CRUD: Create a taxation item  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_taxation_item_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'idempotency_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_entity_ids', 'zuora_track_id', 'zuora_version', 'reject_unknown_fields']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_taxation_item" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_taxation_item`")  # noqa: E501
    ...
    def get_taxation_item_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GetTaxationItemResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def put_taxation_item(self, body, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param UpdateTaxationItemRequest body: (required)
        :param str id: The unique ID of a taxation item.  (required)
        :param str accept_encoding: Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. 
        :param str content_encoding: Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. 
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken). 
