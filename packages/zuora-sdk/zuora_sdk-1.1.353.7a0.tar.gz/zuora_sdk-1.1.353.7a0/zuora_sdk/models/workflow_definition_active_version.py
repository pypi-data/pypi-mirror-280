...
class WorkflowDefinitionActiveVersion(object):
    ...
    swagger_types = {
        ...
        'id': 'int',
        'status': 'str',
        'type': 'WorkflowDefinitionActiveVersionType',
        'version': 'str'
    }
    ...
    def __init__(self, description=None, id=None, status=None, type=None, version=None):  # noqa: E501
    ...
    def type(self):
        ...
        :rtype: WorkflowDefinitionActiveVersionType
        """
        return self._type
