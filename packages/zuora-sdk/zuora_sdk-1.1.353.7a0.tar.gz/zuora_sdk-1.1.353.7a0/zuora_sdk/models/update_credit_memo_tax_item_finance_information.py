...
class UpdateCreditMemoTaxItemFinanceInformation(object):
    ...
    def __init__(self, on_account_accounting_code=None, sales_tax_payable_accounting_code=None):  # noqa: E501
        """UpdateCreditMemoTaxItemFinanceInformation - a model defined in Swagger"""  # noqa: E501
    ...
    def on_account_accounting_code(self):
        """Gets the on_account_accounting_code of this UpdateCreditMemoTaxItemFinanceInformation.  # noqa: E501

        The accounting code that maps to an on account in your accounting system.   # noqa: E501

        :return: The on_account_accounting_code of this UpdateCreditMemoTaxItemFinanceInformation.  # noqa: E501
        :rtype: str
        """
    ...
    def on_account_accounting_code(self, on_account_accounting_code):
        """Sets the on_account_accounting_code of this UpdateCreditMemoTaxItemFinanceInformation.

        The accounting code that maps to an on account in your accounting system.   # noqa: E501

        :param on_account_accounting_code: The on_account_accounting_code of this UpdateCreditMemoTaxItemFinanceInformation.  # noqa: E501
        :type: str
        """
    ...
    def sales_tax_payable_accounting_code(self):
        """Gets the sales_tax_payable_accounting_code of this UpdateCreditMemoTaxItemFinanceInformation.  # noqa: E501

        The accounting code for the sales taxes payable.   # noqa: E501

        :return: The sales_tax_payable_accounting_code of this UpdateCreditMemoTaxItemFinanceInformation.  # noqa: E501
        :rtype: str
        """
    ...
    def sales_tax_payable_accounting_code(self, sales_tax_payable_accounting_code):
        """Sets the sales_tax_payable_accounting_code of this UpdateCreditMemoTaxItemFinanceInformation.

        The accounting code for the sales taxes payable.   # noqa: E501

        :param sales_tax_payable_accounting_code: The sales_tax_payable_accounting_code of this UpdateCreditMemoTaxItemFinanceInformation.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateCreditMemoTaxItemFinanceInformation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateCreditMemoTaxItemFinanceInformation):
            return False
