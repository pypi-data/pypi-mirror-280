...
class PaymentWithCustomRates(object):
    ...
    def __init__(self, currency=None, custom_fx_rate=None, rate_date=None):  # noqa: E501
        """PaymentWithCustomRates - a model defined in Swagger"""  # noqa: E501
        self._currency = None
    ...
    @property
    def currency(self):
        """Gets the currency of this PaymentWithCustomRates.  # noqa: E501
        ...
        :return: The currency of this PaymentWithCustomRates.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this PaymentWithCustomRates.

        The currency code for either Reporting or Home currency.  **Note**: This field is only available if you set the `zuora-version` request header to `224.0` or later.   # noqa: E501

        :param currency: The currency of this PaymentWithCustomRates.  # noqa: E501
        :type: str
        """
        if currency is None:
    ...
    def custom_fx_rate(self):
        """Gets the custom_fx_rate of this PaymentWithCustomRates.  # noqa: E501
        ...
        :return: The custom_fx_rate of this PaymentWithCustomRates.  # noqa: E501
        :rtype: float
        """
    ...
    def custom_fx_rate(self, custom_fx_rate):
        """Sets the custom_fx_rate of this PaymentWithCustomRates.

        The Custom FX conversion rate between Home/Reporting and Transactional currency items.  **Note**: This field is only available if you set the `zuora-version` request header to `224.0` or later.   # noqa: E501

        :param custom_fx_rate: The custom_fx_rate of this PaymentWithCustomRates.  # noqa: E501
        :type: float
        """
    ...
    @property
    def rate_date(self):
        """Gets the rate_date of this PaymentWithCustomRates.  # noqa: E501
        ...
        :return: The rate_date of this PaymentWithCustomRates.  # noqa: E501
        :rtype: str
        """
    ...
    def rate_date(self, rate_date):
        """Sets the rate_date of this PaymentWithCustomRates.

        The date on which a particular currency rate is fixed or obtained on.  **Note**: This field is only available if you set the `zuora-version` request header to `224.0` or later.   # noqa: E501

        :param rate_date: The rate_date of this PaymentWithCustomRates.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaymentWithCustomRates, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaymentWithCustomRates):
            return False
