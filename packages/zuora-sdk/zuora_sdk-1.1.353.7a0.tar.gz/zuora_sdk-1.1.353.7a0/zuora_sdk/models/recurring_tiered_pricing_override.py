...
class RecurringTieredPricingOverride(PriceChangeParams):
    ...
    def __init__(self, list_price_base=None, quantity=None, specific_list_price_base=None, tiers=None, uom=None, *args, **kwargs):  # noqa: E501
        """RecurringTieredPricingOverride - a model defined in Swagger"""  # noqa: E501
    ...
    def list_price_base(self):
        """Gets the list_price_base of this RecurringTieredPricingOverride.  # noqa: E501


        :return: The list_price_base of this RecurringTieredPricingOverride.  # noqa: E501
    ...
    def list_price_base(self, list_price_base):
        """Sets the list_price_base of this RecurringTieredPricingOverride.


        :param list_price_base: The list_price_base of this RecurringTieredPricingOverride.  # noqa: E501
    ...
    @property
    def quantity(self):
        """Gets the quantity of this RecurringTieredPricingOverride.  # noqa: E501

        Number of units purchased.   # noqa: E501

        :return: The quantity of this RecurringTieredPricingOverride.  # noqa: E501
        :rtype: float
        """
    ...
    def quantity(self, quantity):
        """Sets the quantity of this RecurringTieredPricingOverride.

        Number of units purchased.   # noqa: E501

        :param quantity: The quantity of this RecurringTieredPricingOverride.  # noqa: E501
        :type: float
        """
    ...
    def specific_list_price_base(self):
        """Gets the specific_list_price_base of this RecurringTieredPricingOverride.  # noqa: E501
        ...
        :return: The specific_list_price_base of this RecurringTieredPricingOverride.  # noqa: E501
        :rtype: int
        """
    ...
    def specific_list_price_base(self, specific_list_price_base):
        """Sets the specific_list_price_base of this RecurringTieredPricingOverride.

        The number of months for the list price base of the charge. This field is required if you set the value of the `listPriceBase` field to `Per_Specific_Months`.  **Note**:    - This field is available only if you have the <a href=\"https://knowledgecenter.zuora.com/Billing/Subscriptions/Product_Catalog/I_Annual_List_Price\" target=\"_blank\">Annual List Price</a> feature enabled.   - The value of this field is `null` if you do not set the value of the `listPriceBase` field to `Per_Specific_Months`.                 # noqa: E501

        :param specific_list_price_base: The specific_list_price_base of this RecurringTieredPricingOverride.  # noqa: E501
        :type: int
        """
    ...
    @property
    def tiers(self):
        """Gets the tiers of this RecurringTieredPricingOverride.  # noqa: E501

        List of cumulative pricing tiers in the charge.   # noqa: E501

        :return: The tiers of this RecurringTieredPricingOverride.  # noqa: E501
    ...
    def tiers(self, tiers):
        """Sets the tiers of this RecurringTieredPricingOverride.

        List of cumulative pricing tiers in the charge.   # noqa: E501

        :param tiers: The tiers of this RecurringTieredPricingOverride.  # noqa: E501
    ...
    @property
    def uom(self):
        """Gets the uom of this RecurringTieredPricingOverride.  # noqa: E501
        ...
        :return: The uom of this RecurringTieredPricingOverride.  # noqa: E501
        :rtype: str
        """
        return self._uom
    ...
    @uom.setter
    def uom(self, uom):
        """Sets the uom of this RecurringTieredPricingOverride.

        Unit of measure of the standalone charge.  **Note:** This field is available when the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Manage_subscription_transactions/Orders/Standalone_Orders/AA_Overview_of_Standalone_Orders\" target=\"_blank\">Standalone Orders</a> feature is enabled.   # noqa: E501

        :param uom: The uom of this RecurringTieredPricingOverride.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RecurringTieredPricingOverride, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecurringTieredPricingOverride):
            return False
