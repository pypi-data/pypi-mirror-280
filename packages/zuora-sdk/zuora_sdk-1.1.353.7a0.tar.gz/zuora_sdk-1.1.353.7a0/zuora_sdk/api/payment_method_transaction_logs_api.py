...
class PaymentMethodTransactionLogsApi(object):
    ...
    def get_payment_method_transaction_log(self, id, **kwargs):  # noqa: E501
        """CRUD: Retrieve a payment method transaction log  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_payment_method_transaction_log(id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_payment_method_transaction_log_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_payment_method_transaction_log_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_payment_method_transaction_log_with_http_info(self, id, **kwargs):  # noqa: E501
        """CRUD: Retrieve a payment method transaction log  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_payment_method_transaction_log_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_payment_method_transaction_log" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_payment_method_transaction_log`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='PaymentMethodTransactionLogResponse',  # noqa: E501
