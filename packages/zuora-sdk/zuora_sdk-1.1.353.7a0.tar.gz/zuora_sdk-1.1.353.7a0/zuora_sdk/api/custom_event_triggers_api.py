...
class CustomEventTriggersApi(object):
    ...
    def get_event_triggers_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['accept_encoding', 'content_encoding', 'authorization', 'zuora_entity_ids', 'zuora_track_id', 'base_object', 'event_type_name', 'active', 'start', 'limit', 'zuora_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
