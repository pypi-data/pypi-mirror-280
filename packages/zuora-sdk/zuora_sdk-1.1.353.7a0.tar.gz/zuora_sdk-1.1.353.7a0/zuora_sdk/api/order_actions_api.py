...
class OrderActionsApi(object):
    ...
    def update_order_action(self, body, id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.update_order_action(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UpdateOrderActionRequest body: (required)
        :param str id: The id of the Order Action to update. (required)
        ...
        if kwargs.get('async_req'):
            return self.update_order_action_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_order_action_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_order_action_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Update an order action  # noqa: E501

        Updates the change reason and custom fields for an order action.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_order_action_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method update_order_action" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_order_action`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_order_action`")  # noqa: E501
