...
from aurori.jobs import job_manager
...
class Feature(object):
    ...
    def discover_jobs(self, feature_source_path):
        jobSource = feature_source_path + '.' + self.name + '.jobs'
                ...
                for (_, c) in clsmembers:
                    if issubclass(c, Job) & (c is not Job):
                        if c.disable is False:
                            ...
                            job_manager.register_job(self, c, True)
