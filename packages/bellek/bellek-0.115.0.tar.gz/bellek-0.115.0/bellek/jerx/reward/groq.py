# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/jerx.reward.groq.ipynb.
...
def make_question_answer_func(llm: ChatOpenAI | None = None):
    if llm is None:
        llm = ChatOpenAI(model="llama3-70b-8192", temperature=0)
