...
# --------------------------------------------------------------------------------------------------------------------------------------- 
 ...
 # --------------------------------------------------------------------------------------------------------------------------------------- 
    ...
    def addCApi(module:str):
        try:
            ...
            IuApiTest.doInstallPackage(packageName)
 ...
 # ---------------------------------------------------------------------------------------------------------------------------------------       
    @staticmethod
    def doInstallPackage(packageName:str):
        try:
            try:
                IuLog.doVerbose(__name__, f"{packageName}")
                __import__(packageName)
            except ImportError:
                IuLog.doVerbose(__name__, f"{packageName} installing...")
...
# ---------------------------------------------------------------------------------------------------------------------------------------      
    ...
    async def fromFile(pathFile: str) -> tuple:
        try:
            ...
            return content, file_extension, file_name
