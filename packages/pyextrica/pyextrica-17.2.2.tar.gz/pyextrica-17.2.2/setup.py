...
with open(os.path.join(here, "pyextrica", "_version.py"), "r", "utf-8") as f:
    exec(f.read(), about)
...
setup(
    ...
    url=about["__url__"],
    packages=find_packages(include=["pyextrica", "pyextrica.*"]),
    ...
    entry_points={
        "sqlalchemy.dialects": [
            "pyextrica = pyextrica.sqlalchemy.dialect:TrinoDialect",
        ]
    },
)
