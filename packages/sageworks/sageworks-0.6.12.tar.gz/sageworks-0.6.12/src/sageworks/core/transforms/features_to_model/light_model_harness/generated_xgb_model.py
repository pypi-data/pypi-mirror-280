...
if __name__ == "__main__":
    ...
    feature_list = ["maxestateindex", "chi4v", "bcut2d_mrhi", "peoe_vsa10", "slogp_vsa9", "numhacceptors", "fr_methoxy", "fr_unbrch_alkane", "slogp_vsa2", "fr_pyridine", "slogp_vsa4", "fr_alkyl_carbamate", "fr_oxime", "numaliphaticrings", "numsaturatedheterocycles", "fr_guanido", "fr_ar_oh", "chi0", "smr_vsa7", "vsa_estate10", "numaromaticcarbocycles", "smr_vsa2", "fr_ar_n", "fr_benzene", "tpsa", "slogp_vsa11", "slogp_vsa1", "bcut2d_mrlow", "peoe_vsa8", "fr_azide", "fr_thiazole", "kappa3", "fr_piperzine", "fr_nh0", "peoe_vsa13", "slogp_vsa12", "fr_dihydropyridine", "peoe_vsa2", "fr_imidazole", "slogp_vsa5", "numhdonors", "fr_morpholine", "peoe_vsa11", "bcut2d_mwlow", "chi2v", "bertzct", "mollogp", "fr_ar_coo", "numsaturatedrings", "minabspartialcharge", "vsa_estate6", "fr_thiocyan", "maxabspartialcharge", "numvalenceelectrons", "chi1", "estate_vsa11", "nocount", "vsa_estate5", "chi1n", "slogp_vsa3", "labuteasa", "sps", "fr_c_o_nocoo", "fr_sulfonamd", "nhohcount", "numaliphaticheterocycles", "smr_vsa1", "maxpartialcharge", "slogp_vsa7", "chi0n", "fr_nitrile", "molwt", "balabanj", "fr_aniline", "fr_prisulfonamd", "fr_c_o", "peoe_vsa5", "fr_phos_ester", "estate_vsa2", "fr_c_s", "fpdensitymorgan1", "smr_vsa6", "ringcount", "fr_priamide", "smr_vsa9", "heavyatommolwt", "peoe_vsa7", "fr_epoxide", "fr_tetrazole", "peoe_vsa1", "fr_al_oh_notert", "fr_nh1", "fr_thiophene", "fr_barbitur", "fpdensitymorgan3", "slogp_vsa8", "minestateindex", "numheteroatoms", "fr_nitro", "vsa_estate1", "fr_ketone", "fr_ndealkylation2", "fr_nitro_arom_nonortho", "qed", "fr_alkyl_halide", "heavyatomcount", "fr_term_acetylene", "vsa_estate7", "fr_nitro_arom", "fr_ndealkylation1", "kappa2", "fr_hdrzine", "slogp_vsa6", "fr_nitroso", "fr_halogen", "smr_vsa3", "estate_vsa10", "fr_amide", "chi3v", "vsa_estate2", "estate_vsa9", "fr_hdrzone", "maxabsestateindex", "smr_vsa8", "peoe_vsa9", "peoe_vsa6", "fr_al_oh", "estate_vsa8", "hallkieralpha", "estate_vsa1", "fr_aryl_methyl", "fr_allylic_oxid", "fr_amidine", "fr_nh2", "fr_ether", "fr_sulfone", "fractioncsp3", "slogp_vsa10", "numaromaticheterocycles", "fr_bicyclic", "fr_lactam", "fr_phos_acid", "peoe_vsa4", "chi1v", "fr_sh", "estate_vsa7", "bcut2d_chglo", "bcut2d_logplow", "estate_vsa3", "numaliphaticcarbocycles", "estate_vsa5", "vsa_estate4", "fr_isothiocyan", "fr_phenol", "fpdensitymorgan2", "fr_hoccn", "fr_urea", "peoe_vsa14", "bcut2d_mwhi", "chi3n", "fr_furan", "numaromaticrings", "smr_vsa5", "chi4n", "fr_imine", "peoe_vsa3", "minpartialcharge", "fr_arn", "smr_vsa4", "vsa_estate3", "fr_benzodiazepine", "avgipc", "fr_diazo", "fr_isocyan", "fr_lactone", "bcut2d_chghi", "fr_sulfide", "vsa_estate9", "estate_vsa4", "fr_aldehyde", "fr_nhpyrrole", "minabsestateindex", "fr_quatn", "fr_phenol_noorthohbond", "kappa1", "numrotatablebonds", "fr_n_o", "peoe_vsa12", "fr_para_hydroxylation", "fr_oxazole", "fr_ar_nh", "bcut2d_logphi", "exactmolwt", "numsaturatedcarbocycles", "fr_imide", "fr_ketone_topliss", "fr_ester", "fr_piperdine", "estate_vsa6", "chi0v", "chi2n", "vsa_estate8", "fr_al_coo", "molmr", "smr_vsa10", "fr_azo", "fr_coo2", "numradicalelectrons", "fr_coo", "nacid", "nbase", "naromatom", "narombond", "apol", "bpol", "nrot"]
