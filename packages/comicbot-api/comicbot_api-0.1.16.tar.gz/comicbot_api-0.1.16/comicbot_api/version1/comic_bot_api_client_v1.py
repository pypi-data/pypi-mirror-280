...
class ComicBotAPIClientV1:
    ...
    def get_releases_for_week(self, week_num: int, **kwargs):
        ...
        release_day = ReleaseDay(week_num=week_num)
        url_builder = ComicReleaseURLBuilder(release_day.release_date)
        ...
        return self._web_scraper.scrape_comics(url_builder.build(), release_day)
