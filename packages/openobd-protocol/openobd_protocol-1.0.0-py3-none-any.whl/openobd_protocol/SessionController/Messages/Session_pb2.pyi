...
class Authenticate(_message.Message):
    __slots__ = ("client_id", "client_secret", "api_key", "cluster_id")
    ...
    api_key: str
    cluster_id: str
    def __init__(self, client_id: _Optional[str] = ..., client_secret: _Optional[str] = ..., api_key: _Optional[str] = ..., cluster_id: _Optional[str] = ...) -> None: ...
