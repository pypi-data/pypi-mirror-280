...
class sessionControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.startSessionOnConnection = channel.unary_unary(
                '/openOBD.v1.sessionController/startSessionOnConnection',
...
class sessionController(object):
    ...
    def startSessionOnConnection(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/openOBD.v1.sessionController/startSessionOnConnection',
