...
class ServiceResult(_message.Message):
    __slots__ = ("result_value", "user_feedback_value", "description")
    RESULT_VALUE_FIELD_NUMBER: _ClassVar[int]
    USER_FEEDBACK_VALUE_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    result_value: Result
    user_feedback_value: UserFeedback
    description: str
    def __init__(self, result_value: _Optional[_Union[Result, str]] = ..., user_feedback_value: _Optional[_Union[UserFeedback, str]] = ..., description: _Optional[str] = ...) -> None: ...
