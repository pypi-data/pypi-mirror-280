...
cdef extern from "cmappy.h":
	...
	int *mappy_k_cigar(const uint8_t *target, const uint8_t *query, int *n_cigarcode, int *zdropped, int *max_q, int *max_t, int match, int mismatch, int gap_open_1, int gap_extend_1, int gap_open_2, int gap_extend_2, int bw, int zdropvalue, int *delcount, int *inscount)
