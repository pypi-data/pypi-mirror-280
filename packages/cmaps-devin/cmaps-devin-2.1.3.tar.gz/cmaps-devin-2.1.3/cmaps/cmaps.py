...
class Cmaps(object):
    ...
    def acton(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "acton.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def actonS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "actonS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def bam(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "bam.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def bamO(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "bamO.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def bamako(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "bamako.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def bamakoS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "bamakoS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def batlow(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "batlow.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def batlowK(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "batlowK.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def batlowKS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "batlowKS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def batlowS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "batlowS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def batlowW(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "batlowW.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def batlowWS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "batlowWS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def berlin(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "berlin.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def bilbao(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "bilbao.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def bilbaoS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "bilbaoS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def broc(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "broc.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def brocO(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "brocO.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def buda(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "buda.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def budaS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "budaS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def bukavu(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "bukavu.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def cork(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "cork.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def corkO(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "corkO.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def davos(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "davos.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def davosS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "davosS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def devon(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "devon.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def devonS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "devonS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def fes(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "fes.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def glasgow(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "glasgow.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def glasgowS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "glasgowS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def grayC(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "grayC.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def grayCS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "grayCS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def hawaii(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "hawaii.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def hawaiiS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "hawaiiS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def imola(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "imola.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def imolaS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "imolaS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def lajolla(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "lajolla.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def lajollaS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "lajollaS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def lapaz(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "lapaz.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def lapazS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "lapazS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def lipari(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "lipari.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def lipariS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "lipariS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def lisbon(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "lisbon.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def managua(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "managua.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def navia(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "navia.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def naviaS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "naviaS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def nuuk(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "nuuk.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def nuukS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "nuukS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def oleron(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "oleron.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def oslo(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "oslo.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def osloS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "osloS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def roma(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "roma.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def romaO(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "romaO.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def tofino(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "tofino.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def tokyo(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "tokyo.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def tokyoS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "tokyoS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def turku(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "turku.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def turkuS(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "turkuS.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def vanimo(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "vanimo.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def vik(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "vik.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
    ...
    def vikO(self):
        ...
        try:
            ...
            cmap_file = os.path.join(CMAPSFILE_DIR, "cmcrameri",  "vikO.rgb")
            cmap = Colormap(self._coltbl(cmap_file), name=cname)
            register_cmap(name=cname, cmap=cmap)
            return cmap
