...
from .dev_utils import current_time
...
class LaboratoryUtils:
    ...
    def probability_calibration(
        ...
        if config_json is None:
            config_json = laboratory.download_config(down_file=False)
    ...
    def qcis_mapping_isq(
        ...
        try:
            ...
            qasm_transpiled, _, _, _ = transpile(
                qasm_circuit,
                coupling_map,
