...
from . import header, history, statistics, balance, autocomplet, note, about, exiting
from . import make
...
LAYOUT = html.Div(
    [
        ...
        drag_event_receiver2 := dbc.Input(type="text", id="dragEventReceiver2", style={'visibility': 'hidden', "display": "none"}),
        edit_event_receiver := dbc.Input(type="text", id="editEventReceiver", style={'visibility': 'hidden', "display": "none"}),
        quick_search_receiver := dbc.Input(type="text", id="quickSearchReceiver", style={'visibility': 'hidden', "display": "none"}),
        history.MODAL,
        statistics.POP,
