...
class band_diffuse_frac(NamedObject[axis_direction_component_child], CreatableNamedObjectMixin[axis_direction_component_child]):
    """
    ...
    """
    return_type = "<object object at 0x7fb56b51ef30>"
