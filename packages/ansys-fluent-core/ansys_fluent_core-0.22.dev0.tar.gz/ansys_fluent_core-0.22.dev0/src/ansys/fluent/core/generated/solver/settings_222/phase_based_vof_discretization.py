...
class phase_based_vof_discretization(NamedObject[relaxation_factor_child], CreatableNamedObjectMixin[relaxation_factor_child]):
    """
    ...
    """
    return_type = "<object object at 0x7fb56b37c930>"
