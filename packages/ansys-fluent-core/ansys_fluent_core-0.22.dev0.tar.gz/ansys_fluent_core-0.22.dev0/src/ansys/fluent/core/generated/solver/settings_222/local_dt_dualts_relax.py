...
class local_dt_dualts_relax(NamedObject[relaxation_factor_child], CreatableNamedObjectMixin[relaxation_factor_child]):
    """
    ...
    """
    return_type = "<object object at 0x7fb56b37cc90>"
