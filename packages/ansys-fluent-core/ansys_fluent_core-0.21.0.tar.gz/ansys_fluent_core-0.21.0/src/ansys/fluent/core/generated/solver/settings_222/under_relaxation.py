...
class under_relaxation(NamedObject[relaxation_factor_child], CreatableNamedObjectMixin[relaxation_factor_child]):
    """
    ...
    """
    return_type = "<object object at 0x7fd8f93b6da0>"
