...
class multi_grid_controls(NamedObject[multi_grid_controls_child], CreatableNamedObjectMixin[multi_grid_controls_child]):
    """
    ...
    """
    return_type = "<object object at 0x7fd8f93b62d0>"
