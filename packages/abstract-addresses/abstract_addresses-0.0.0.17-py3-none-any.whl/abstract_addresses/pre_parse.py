...
from .california_municipalities import california_municipalities 
import os,usaddress
def get_abs_path():
...
def get_county_vars_data():
    ...
    return california_municipalities#safe_read_from_json(county_vars_path)
    ...
    for county, info in state_data.items():
        if city in info["cities"]:
            ...
            if city_zip_codes:
                ...
                return {
                    address_dict['AddressNumber']: street_number,
                    address_dict['StreetName']: street_name,
                    address_dict['PlaceName']: city,
                    address_dict['StateName']:address_dict['StateName'],  # Set statically, dynamic if other states' data available
