...
def start_chrome(gui = False, ad_blocker = True, disable_popups_and_cookies = True, additional_options = []):
    ...
    try:
        ...
        AD_BLOCK_ABSOLUTEPATH = CHROME_EXTENSIONS_ABSOLUTEPATH + 'cjpalhdlnbpafiamejdnhcphjbkeiagm/1.56.0_0'

        # TODO: What is 'import undetected_chromedriver.v2 as uc'? Try it
        ...
        if disable_popups_and_cookies:
            ...
            options.add_experimental_option("prefs", {"excludeSwitches": ['enable-automation', 'load-extension', 'disable-popup-blocking'], 'profile.default_content_setting_values.automatic_downloads': 1})
