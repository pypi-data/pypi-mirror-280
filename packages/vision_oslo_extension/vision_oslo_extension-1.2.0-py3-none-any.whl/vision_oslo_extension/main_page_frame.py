...
class PageOne(BasePage):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(master=self.headframe, text = 'OSLO Model Data Preparation',font = controller.sub_title_font)
        ...
        explain3 = tk.Label(master=self.optionframe, text = '3: Extra.OSLO Preparation', font = controller.text_font)
        ...
        explain4 = tk.Label(master=self.optionframe, text = '5: Provision for development', font = controller.text_font)
        explain4.grid(row = 4, column = 0, sticky = "w", padx=5, pady=2)

        button4 = tk.Button(master=self.optionframe, text = 'execute 5', command=lambda: self.set_main_option("5","S05"))
        button4.grid(row = 4, column = 1, sticky = "w", padx=5, pady=2)
...
class PageFour(BasePage):
    ...
    def __init__(self, parent, controller):
        ...
        button3 = tk.Button(master=self.optionframe, text = 'execute 3', command=lambda: self.set_main_option("3","P03"))
        button3.grid(row = 2, column = 1, sticky = "w", padx=5, pady=2)
        ...
        button5 = tk.Button(master=self.optionframe, text = 'execute 5', command=lambda: self.set_main_option("5","P05"))
        button5.grid(row = 4, column = 1, sticky = "w", padx=5, pady=2)
        ...
        button6 = tk.Button(master=self.optionframe, text = 'execute 6', command=lambda: self.set_main_option("6","P06"))
        button6.grid(row = 5, column = 1, sticky = "w", padx=5, pady=2)

        explain7 = tk.Label(master=self.optionframe, text = '7: AC: OLE Current Rating Assessment', font = controller.text_font)
        explain7.grid(row = 6, column = 0, sticky = "w", padx=5, pady=2)

        button7 = tk.Button(master=self.optionframe, text = 'execute 7', command=lambda: self.set_main_option("7","P07"))
        button7.grid(row = 6, column = 1, sticky = "w", padx=5, pady=2)

        explain8 = tk.Label(master=self.optionframe, text = '8: AC: Static Frequency Converter SFC Assessment', font = controller.text_font)
        explain8.grid(row = 7, column = 0, sticky = "w", padx=5, pady=2)

        button8 = tk.Button(master=self.optionframe, text = 'execute 8', command=lambda: self.set_main_option("8","P08"))
        button8.grid(row = 7, column = 1, sticky = "w", padx=5, pady=2)
        ...
        button9 = tk.Button(master=self.optionframe, text = 'execute 9', command=lambda: self.set_main_option("9","P09"))
        button9.grid(row = 8, column = 1, sticky = "w", padx=5, pady=2)
        ...
        button10 = tk.Button(master=self.optionframe, text = 'execute 10', command=lambda: self.set_main_option("10","P10"))
        button10.grid(row = 9, column = 1, sticky = "w", padx=5, pady=2)
        ...
        button11 = tk.Button(master=self.optionframe, text = 'execute 11', command=lambda: self.set_main_option("11","P11"))
        button11.grid(row = 10, column = 1, sticky = "w", padx=5, pady=2)

        explain12 = tk.Label(master=self.optionframe, text = '12: DC: (Data PREP. and Assessment) Single End Feeding', font = controller.text_font)
        explain12.grid(row = 11, column = 0, sticky = "w", padx=5, pady=2)

        button12 = tk.Button(master=self.optionframe, text = 'execute 12', command=lambda: self.set_main_option("12","P12"))
        button12.grid(row = 11, column = 1, sticky = "w", padx=5, pady=2)
