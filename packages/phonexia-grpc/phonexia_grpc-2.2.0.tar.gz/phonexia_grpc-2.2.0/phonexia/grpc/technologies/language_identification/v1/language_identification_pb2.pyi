...
class LanguageIdentificationScore(google.protobuf.message.Message):
    ...
    INDIVIDUAL_LANGUAGES_FIELD_NUMBER: builtins.int
    identifier: builtins.str
    """This field has either language code (specified by RFC 5646) or identifier of language group."""
    score: builtins.float
    """Score for this language or language group.
    The score represents the probability of the input belonging to a particular
    language.
    Language group scores sum up the probabilities of their individual languages.
    """
    @property
    def individual_languages(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___LanguageIdentificationScore]:
        """This field is only set for language groups. 
        Scores for individual languages that this group is comprised of can be found in this field.
        """
    ...
    def __init__(
        ...
        *,
        identifier: builtins.str = ...,
        score: builtins.float = ...,
        individual_languages: collections.abc.Iterable[global___LanguageIdentificationScore] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["identifier", b"identifier", "individual_languages", b"individual_languages", "score", b"score"]) -> None: ...
