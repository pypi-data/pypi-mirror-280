...
class ModbusRtu:
    ...
    baud_rate_selected: Optional[str] = field(
        ...
        metadata={
            ...
            "namespace": "http://www.smartgridready.com/ns/V0/",
            "required": True,
            "pattern": r"\{\{.+\}\}|300|600|1200|2400|4800|5600|9600|14400|19200|38400|57600|115200|12800|230400|256000",
        },
    )
...
class ModbusInterfaceDescription:
    ...
    master_functions_supported_list: Optional[MasterFunctionsSupportedList] = (
        field(
            default=None,
            metadata={
