...
import scalify
from scalify.client.openai import get_default_async_client
from scalify.types import Audio, SpeechRequest
from scalify.utilities.asyncio import run_sync
from scalify.utilities.jinja import Environment
    ...
    if stream:
        if request.response_format != "pcm":
            raise ValueError(
                ...
                "call e.g. `.save('audio.mp3')`, Scalify can convert PCM-streamed "
