...
To change this behavior globally set `MARVIN_IMAGE_RESPONSE_FORMAT=b64_json` in your environment, or equivalently change `scalify.settings.images.response_format = "b64_json"` in your code.
