...
try:
    ...
    raise ModuleNotFoundError(
        ...
        " install it with `pip install prefect` or `pip install scalify[prefect]`."
    )
from pydantic import Field, model_validator

from scalify.utilities.asyncio import run_sync, run_sync_if_awaitable
...
class JSONBlockState(State):
    block_name: str = Field(default="scalify-kv")
