...
from scalify.tools.assistants import ENDRUN_TOKEN, AssistantTool, EndRun
from scalify.types import Tool
from scalify.utilities.asyncio import ExposeSyncMethodsMixin, expose_sync_method
    ...
    async def get_tool_outputs(self, run: OpenAIRun) -> list[str]:
        ...
        if run.required_action.type == "submit_tool_outputs":
            ...
            for tool_call in run.required_action.submit_tool_outputs.tool_calls:
                try:
                    output = scalify.utilities.tools.call_function_tool(
                        tools=tools,
                    ...
                    logger.error(output)
                string_output = scalify.utilities.tools.output_to_string(output)
                tool_outputs.append(
                    dict(
