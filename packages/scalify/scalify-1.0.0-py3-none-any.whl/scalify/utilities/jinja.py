...
from scalify.types import BaseMessage as Message
from scalify.types import ImageFileContentBlock, TextContentBlock
...
class BaseEnvironment(BaseModel):
    ...
    def render(self, template: Union[str, BaseTemplate], **kwargs: Any) -> str:
        ...
        Example:
            ...
            ```python
            from scalify.utilities.jinja import Environment as jinja_env
...
def split_text_by_tokens(
    ...
    Example:
        ...
        scalify.utilities.jinja import split_text_by_tokens
