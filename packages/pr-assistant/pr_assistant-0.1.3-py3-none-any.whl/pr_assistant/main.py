...
# Construct the absolute path to prompt.txt
...
try:
    ...
    print(f"Error: prompt.txt file not found at {prompt_path}")
    PROMPT = ""
...
def main():
    ...
    filename = os.path.join(script_dir, "local_storage.txt")
    filename_emails = os.path.join(script_dir, "local_storage_emails.txt")
