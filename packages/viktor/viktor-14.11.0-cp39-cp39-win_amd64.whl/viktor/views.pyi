...
class GeometryView(View):
    def __init__(self, label: str, duration_guess: int, *, description: str = ..., update_label: str = ..., view_mode: Literal['2D', '3D'] = ..., default_shadow: bool = ..., up_axis: Literal['Y', 'Z'] = ..., x_axis_to_right: bool = ...) -> None: ...
