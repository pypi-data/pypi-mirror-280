...
class MockedEntityRevision(EntityRevision):
    def __init__(self, params: Union[dict, Munch] = ..., created_date: datetime.datetime = ..., entity_revision_id: int = ...) -> None: ...

class MockedUser(User):
    def __init__(self, *, first_name: str = ..., last_name: str = ..., email: str = ..., job_title: str = ..., user_id: int = ...) -> None: ...
...
class MockedEntity:
    @property
    def __class__(self) -> Type: ...
    def __init__(self, *, entity_id: int = ..., name: str = ..., entity_type: MockedEntityType = ..., last_saved_params: Union[dict, Munch] = ..., last_saved_summary: dict = ..., get_file: File = ..., parent: MockedEntity = ..., children: Sequence['MockedEntity'] = ..., siblings: Sequence['MockedEntity'] = ..., revisions: Sequence[MockedEntityRevision] = ..., invalid: bool = ..., workspace_id: int = ...) -> None: ...
    @property
    def id(self) -> int: ...
    @property
    def name(self) -> str: ...
