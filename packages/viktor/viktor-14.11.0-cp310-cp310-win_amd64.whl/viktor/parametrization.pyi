...
class Step(Page):
    def __init__(self, title: str, *, views: Union[str, Sequence[str]] = ..., description: str = ..., enabled: Union[bool, BoolOperator, Lookup, FunctionLookup, Callable] = ..., previous_label: str = ..., next_label: str = ..., on_next: Callable = ..., width: int = ...) -> None: ...
