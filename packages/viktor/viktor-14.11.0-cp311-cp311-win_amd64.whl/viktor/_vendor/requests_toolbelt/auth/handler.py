...
from viktor._vendor.requests.auth import AuthBase, HTTPBasicAuth
from viktor._vendor.requests.compat import urlparse, urlunparse
...
class AuthHandler(AuthBase):
    ...
    .. code-block:: python
        ...
        from viktor._vendor.requests import HTTPDigestAuth
        from viktor._vendor.requests_toolbelt.auth.handler import AuthHandler
