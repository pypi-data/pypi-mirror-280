...
class MultipartEncoder(object):
    ...
    .. code-block:: python
        ...
        from viktor._vendor import requests
        from viktor._vendor.requests_toolbelt import MultipartEncoder
...
class MultipartEncoderMonitor(object):
    ...
    .. code-block:: python
        ...
        from viktor._vendor.requests_toolbelt import MultipartEncoderMonitor
        from viktor._vendor import requests
...
class FileFromURLWrapper(object):
    ...
    .. code-block:: python
        ...
        from viktor._vendor import requests
        from viktor._vendor.requests_toolbelt import MultipartEncoder, FileFromURLWrapper
