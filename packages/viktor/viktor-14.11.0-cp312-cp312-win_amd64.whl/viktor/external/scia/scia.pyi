...
class Model:
    ...
    def create_general_cross_section_element(self, name: str, element_type: GeneralCrossSectionElement.Type, points: Sequence[Tuple[float, float]], *, material: Material = ...) -> GeneralCrossSectionElement: ...
    def create_general_cross_section(self, elements: Sequence[GeneralCrossSectionElement], *, name: str = ...) -> GeneralCrossSection: ...
