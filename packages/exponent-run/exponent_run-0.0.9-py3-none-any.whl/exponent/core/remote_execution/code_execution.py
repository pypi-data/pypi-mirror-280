from exponent.core.remote_execution.languages.diff import execute_diff
...
async def execute_code(
    ...
    try:
        if request.language == "python":
            ...
            result = await execute_shell(request.content, working_directory)
        elif request.language == "diff":
            result = execute_diff(request.content, working_directory=working_directory)
        else:
