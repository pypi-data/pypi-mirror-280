...
from postnlecommerce.models.customs import Customs
...
class LabellingCustomerShipment(object):

    """Implementation of the 'labellingCustomerShipment' model.
    ...
    Attributes:
        ...
        customs (Customs): The Customs type is mandatory for non-EU shipments
    ...
    def __init__(self,
        ...
        """Constructor for the LabellingCustomerShipment class"""
    ...
    def from_dictionary(cls,
        ...
        customs = Customs.from_dictionary(dictionary.get('Customs')) if 'Customs' in dictionary.keys() else APIHelper.SKIP
