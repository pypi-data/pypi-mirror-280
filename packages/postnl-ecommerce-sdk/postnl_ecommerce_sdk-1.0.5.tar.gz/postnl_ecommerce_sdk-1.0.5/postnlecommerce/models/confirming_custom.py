...
from postnlecommerce.models.confirming_custom_content import ConfirmingCustomContent


class ConfirmingCustom(object):

    """Implementation of the 'confirmingCustom' model.
    ...
    Attributes:
        ...
        content (List[ConfirmingCustomContent]): The contents of the shipment.
            This section is mandatory (minimum once, maximum 5). Fill per
            unique item.
    ...
    def __init__(self,
        ...
        """Constructor for the ConfirmingCustom class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Content') is not None:
            content = [ConfirmingCustomContent.from_dictionary(x) for x in dictionary.get('Content')]
