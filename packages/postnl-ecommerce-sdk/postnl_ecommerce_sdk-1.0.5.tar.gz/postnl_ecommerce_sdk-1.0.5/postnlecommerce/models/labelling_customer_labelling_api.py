...
class LabellingCustomerLabellingAPI(object):

    """Implementation of the 'labellingCustomer_Labelling API' model.
    ...
    def __init__(self,
                 ...
                 name=APIHelper.SKIP):
        """Constructor for the LabellingCustomerLabellingAPI class"""
