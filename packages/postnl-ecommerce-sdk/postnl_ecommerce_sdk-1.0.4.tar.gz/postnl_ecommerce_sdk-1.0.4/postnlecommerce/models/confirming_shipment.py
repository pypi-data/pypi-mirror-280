...
from postnlecommerce.models.confirming_custom import ConfirmingCustom
...
class ConfirmingShipment(object):

    """Implementation of the 'confirmingShipment' model.
    ...
    Attributes:
        ...
        customs (List[ConfirmingCustom]): The Customs type is mandatory for
    ...
    def __init__(self,
        ...
        """Constructor for the ConfirmingShipment class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Customs') is not None:
            customs = [ConfirmingCustom.from_dictionary(x) for x in dictionary.get('Customs')]
        else:
            customs = APIHelper.SKIP
