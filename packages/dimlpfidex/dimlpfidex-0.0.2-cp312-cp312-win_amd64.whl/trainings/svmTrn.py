...
def get_and_check_parameters(init_args):
    ...
    parser.add_argument("--output_roc", type=lambda x: sanitizepath(args.root_folder, x, "w"), help="Output ROC curve file name", metavar="<str>", default="roc_curve.png")
    ...
    parser.add_argument("--positive_class_index", type=lambda x: int_type(x, min=0), metavar="<int [0,nb_class-1]>", help="Index of positive class for the roc curve calculation, index starts at 0")
