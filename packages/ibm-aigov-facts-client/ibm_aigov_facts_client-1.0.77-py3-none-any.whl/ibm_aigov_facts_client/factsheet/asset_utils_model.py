...
# utils===============================================================
    ...
    def set_attachment_fact(self,
                            ...
                            fact_id: str,
                            phase_name: str = None,
                            html_rendering_hint: str = None) -> None:
        ...
        """
            ...
            # :param str description: Description of the file to be attached
            # :param str fact_id: Fact id against which the attachment needs to be uploaded, if no fact id is passed it will be found under 'Other Attachments' in factsheet
            # :params str phase_name: Phase name in which the attachment should appear.Available options are in :func:`~ibm_aigov_facts_client.utils.enums.Phases
            ...
            # A way to use me is:
            #
            >>> model.set_attachment_fact(file_to_upload="./artifacts/image.png",description=<file description>,fact_id=<custom fact id>,phase_name=<phase_name>,html_rendering_hint=<render hint>)
