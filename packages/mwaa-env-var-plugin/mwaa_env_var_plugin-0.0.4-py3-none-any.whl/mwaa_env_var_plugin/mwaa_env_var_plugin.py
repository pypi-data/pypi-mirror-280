...
class MwaaEnvVarPlugin(AirflowPlugin):
    ...
    def set_custom_env_vars():
        ...
        for env_var, value in os.environ.items():
            # Check if the environment variable starts with AIRFLOW__CUSTOM__
            if env_var.startswith('AIRFLOW__ENV__'):
                ...
                print(f"Set environment variable: {new_env_var_name}={value}")

# Ensure the plugin sets the environment variables when Airflow starts
# custom_env_var_plugin = MwaaEnvVarPlugin()
