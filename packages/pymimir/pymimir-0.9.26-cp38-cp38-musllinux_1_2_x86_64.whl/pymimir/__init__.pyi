...
class FaithfulAbstraction:
    @staticmethod
    @typing.overload
    def create(domain_filepath: str, problem_filepath: str, mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295) -> FaithfulAbstraction | None:
        ...
    @staticmethod
    @typing.overload
    def create(parser: PDDLParser, aag: IAAG, ssg: ISSG, mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295) -> FaithfulAbstraction | None:
        ...
    @staticmethod
    @typing.overload
    def create(domain_filepath: str, problem_filepaths: list[str], mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[FaithfulAbstraction]:
        ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[PDDLParser, IAAG, ISSG]], mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[FaithfulAbstraction]:
        ...
    def compute_shortest_distances_from_states(self, arg0: list[int], arg1: bool) -> list[float]:
        ...
    def get_aag(self) -> IAAG:
        ...
    def get_abstract_state_id(self, arg0: State) -> int:
        ...
...
class GlobalFaithfulAbstractState:
    ...
    def get_abstract_state_id(self) -> int:
        ...
    def get_abstraction_id(self) -> int:
        ...
    def get_id(self) -> int:
        ...
class GlobalFaithfulAbstraction:
    @staticmethod
    @typing.overload
    def create(domain_filepath: str, problem_filepaths: list[str], mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[GlobalFaithfulAbstraction]:
        ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[PDDLParser, IAAG, ISSG]], mark_true_goal_atoms: bool = False, use_unit_cost_one: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[GlobalFaithfulAbstraction]:
        ...
    def get_abstract_state_id(self, arg0: State) -> int:
        ...
    ...
    def get_num_transitions(self) -> int:
        ...
    def get_state_id(self, arg0: GlobalFaithfulAbstractState) -> int:
        ...
...
class StateSpace:
    @staticmethod
    @typing.overload
    def create(domain_filepath: str, problem_filepaths: str, use_unit_cost_one: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295) -> StateSpace | None:
        ...
    @staticmethod
    @typing.overload
    def create(parser: PDDLParser, aag: IAAG, ssg: ISSG, use_unit_cost_one: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295) -> StateSpace | None:
        ...
    @staticmethod
    @typing.overload
    def create(domain_filepath: str, problem_filepaths: list[str], use_unit_cost_one: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[StateSpace]:
        ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[PDDLParser, IAAG, ISSG]], use_unit_cost_one: bool = True, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, num_threads: int = 4) -> list[StateSpace]:
        ...
    ...
    def get_ssg(self) -> ISSG:
        ...
    def get_state_id(self, arg0: State) -> int:
        ...
...
class Transition:
    ...
    def get_creating_action(self) -> GroundAction:
        ...
    def get_successor_state(self) -> int:
        ...
class TupleGraph:
    def __str__(self) -> str:
        ...
