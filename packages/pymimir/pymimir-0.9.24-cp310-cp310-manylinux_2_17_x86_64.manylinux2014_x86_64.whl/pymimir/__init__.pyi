...
class FaithfulAbstraction:
    @staticmethod
    @typing.overload
    def create(arg0: str, arg1: str, arg2: int, arg3: int) -> FaithfulAbstraction | None:
        ...
    @staticmethod
    @typing.overload
    def create(domain_filepath: str, problem_filepaths: list[str], max_num_states: int = 18446744073709551615, timeout_ms: int = 18446744073709551615, num_threads: int = 4) -> list[FaithfulAbstraction]:
        ...
    def compute_shortest_distances_from_states(self, arg0: list[int], arg1: bool) -> list[int]:
        ...
...
class GlobalFaithfulAbstraction:
    @staticmethod
    def create(domain_filepath: str, problem_filepaths: list[str], max_num_states: int = 18446744073709551615, timeout_ms: int = 18446744073709551615, num_threads: int = 4) -> list[GlobalFaithfulAbstraction]:
        ...
...
class StateSpace:
    @staticmethod
    @typing.overload
    def create(arg0: str, arg1: str, arg2: int, arg3: int) -> StateSpace | None:
        ...
    @staticmethod
    @typing.overload
    def create(domain_filepath: str, problem_filepaths: list[str], max_num_states: int = 18446744073709551615, timeout_ms: int = 18446744073709551615, num_threads: int = 4) -> list[StateSpace]:
        ...
    def compute_pairwise_shortest_state_distances(self, forward: bool = True) -> list[list[int]]:
        ...
    def compute_shortest_distances_from_states(self, states: list[int], forward: bool = True) -> list[int]:
        ...
    ...
    def is_deadend_state(self, arg0: State) -> bool:
        ...
    def sample_state_with_goal_distance(self, arg0: int) -> int:
        ...
class StaticAtom:
    def __str__(self) -> str:
        ...
