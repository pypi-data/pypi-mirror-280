...
__NAMESPACE__ = "https://www.microchip.com/schema/SHA104_Config_1.0"
...
class BinaryEncodingEnum(Enum):
    HEX = "Hex"
    BASE64 = "Base64"


class BinaryOrStringEncodingEnum(Enum):
    HEX = "Hex"
    BASE64 = "Base64"
...
class CryptoAuthCompressedCertificateSntypeSource(Enum):
    SNSRC_DEVICE_SN = "SNSRC_DEVICE_SN"
    SNSRC_PUB_KEY_HASH = "SNSRC_PUB_KEY_HASH"
    SNSRC_DEVICE_SN_HASH = "SNSRC_DEVICE_SN_HASH"
    SNSRC_PUB_KEY_HASH_POS = "SNSRC_PUB_KEY_HASH_POS"
    SNSRC_DEVICE_SN_HASH_POS = "SNSRC_DEVICE_SN_HASH_POS"
    SNSRC_PUB_KEY_HASH_RAW = "SNSRC_PUB_KEY_HASH_RAW"
...
class DataSourcesWriterType:
    ...
    source_name: Optional[str] = field(
        ...
        metadata={
            "name": "Source_Name",
            "type": "Element",
            "namespace": "https://www.microchip.com/schema/SHA104_Config_1.0",
            "required": True,
...
@dataclass
class DateTimeModifySetFieldsType:
    ...
    fractional_second: Optional[float] = field(
        default=None,
        metadata={
...
class Ed25519PublicKeyFormatEnum(Enum):
    """
    :cvar SUBJECT_PUBLIC_KEY_INFO: ASN.1 DER encoded
        SubjectPublicKeyInfo as defined in RFC 5280, RFC 8410 section 4,
        and RFC 8302 section 5.1.2.
    :cvar RFC8032_ENC: Standard encoding of Ed25519 public keys as
        defined in RFC 8302 section 5.1.2 (Encoding).
    """
    SUBJECT_PUBLIC_KEY_INFO = "Subject_Public_Key_Info"
    RFC8032_ENC = "RFC8032_ENC"


class EdDsainstanceType(Enum):
    """
    :cvar ED25519: Represents the PureEdDSA without context. No prehash
        is applied and no context is applied.
    :cvar ED25519CTX: Represents the PureEdDSA with context. No prehash
        is applied and context is 0-255 octets.
    :cvar ED25519PH: Represents the HashEdDSA with context. SHA-512
        prehash is applied and context is 0-255 octets.
    """
    ED25519 = "Ed25519"
...
class EdDsasignatureFormatEnum(Enum):
    """
    :cvar RCF8032_SIGNATURE: EdDSA encoding as defined in RFC 8032
        section 3.3 (Sign).
    """
    RCF8032_SIGNATURE = "RCF8032_Signature"
...
class NumericValue(Enum):
    UNIX = "Unix"


class PrivateKeyFormatEnums(Enum):
    PKCS8 = "PKCS8"
...
class PublicKeyFormatEnums(Enum):
    SUBJECT_PUBLIC_KEY_INFO = "Subject_Public_Key_Info"
...
class X25519PublicKeyFormatEnum(Enum):
    """
    :cvar SUBJECT_PUBLIC_KEY_INFO: ASN.1 DER encoded
        SubjectPublicKeyInfo as defined in RFC 5280, RFC 8410 section 4,
        and RFC 7748 section 5.
    :cvar RFC7748_ENC: Standard encoding of X25519 public keys as
        defined near the end of RFC 7748 section 5 (The X25519 and X448
        Functions).
    """
    SUBJECT_PUBLIC_KEY_INFO = "Subject_Public_Key_Info"
    RFC7748_ENC = "RFC7748_ENC"
...
class X509EdDsainstanceType(Enum):
    """
    :cvar ED25519: Represents the PureEdDSA without context. No prehash
        is applied and no context is applied.
    """
...
class BinaryDataOrStringType:
    ...
    encoding: Optional[BinaryOrStringEncodingEnum] = field(
        default=None,
        metadata={
            "type": "Attribute",
            "required": True,
...
class BinaryDataType:
    ...
    encoding: Optional[BinaryEncodingEnum] = field(
        default=None,
        metadata={
            "type": "Attribute",
            "required": True,
...
class ClientDeviceDataItem:
    ...
    type_value: Optional[PublicDataTypeEnum] = field(
        default=None,
        metadata={
            "name": "Type",
            "type": "Element",
...
@dataclass
class CryptoAuthCompressedCertificateSntype:
    class Meta:
        name = "CryptoAuthCompressedCertificateSNType"

    source: Optional[CryptoAuthCompressedCertificateSntypeSource] = field(
        default=None,
        metadata={
            "name": "Source",
            "type": "Element",
    ...
    expire_years: Optional[int] = field(
        default=None,
        metadata={
            "name": "Expire_Years",
            "type": "Element",
...
@dataclass
class CryptoAuthCompressedCertificateType:
    """
    :ivar certificate: Reference to the source of the certificate to
        convert into a compressed certificate.
    :ivar ca_certificate:
    :ivar ca_public_key:
    :ivar atcacert_def: Compressed certificate definition as the c-code
        instantiation of an atcacert_def_t structure and dependent data
        from CryptoAuthLib.
    :ivar signer_id: Optionally specifies the Signer ID to use in the
        compressed certificate if the input certificate does not contain
        it.
    :ivar issue_date: Optionally specifies the issue date to use in the
        compressed certificate if the input certificate does not contain
        it. Typically only for CERTTYPE_CUSTOM.
    """
    ...
    ca_public_key: Optional[str] = field(
        default=None,
        metadata={
            "name": "CA_Public_Key",
            "type": "Element",
    ...
    atcacert_def: Optional["CryptoAuthCompressedCertificateType.AtcacertDef"] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "https://www.microchip.com/schema/SHA104_Config_1.0",
    ...
    signer_id: Optional[str] = field(
        ...
        metadata={
            ...
            "type": "Element",
            "namespace": "https://www.microchip.com/schema/SHA104_Config_1.0",
            "pattern": r"0x0*[0-9a-fA-F]{4}",
        }
    )
    issue_date: Optional["CryptoAuthCompressedCertificateType.IssueDate"] = field(
        default=None,
        metadata={
            "name": "Issue_Date",
            "type": "Element",
    ...
    class AtcacertDef:
        ...
        cryptoauthlib_version: Optional[str] = field(
            default=None,
            metadata={
                "type": "Attribute",
                "required": True,
                "pattern": r"([0-9]+\.[0-9]+\.[0-9]+|[0-9]{8})",
            }
        )
...
class DatabaseDataFieldType:
    ...
    type_value: Optional[DataTypeEnum] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Attribute",
...
class DateTimeFormatType:
    """
    :ivar input:
    :ivar format: Date time format string in the same style as the c
        strftime() function.
    :ivar numeric:
    """
    input: Optional[str] = field(
    ...
    numeric: Optional["DateTimeFormatType.Numeric"] = field(
        default=None,
        metadata={
            "name": "Numeric",
            "type": "Element",
    ...
    @dataclass
    class Numeric:
        resolution: Optional[NumericResolution] = field(
            default=None,
            metadata={
                "name": "Resolution",
                "type": "Element",
        ...
        epoch: Optional[Union[XmlDateTime, NumericValue]] = field(
            default=None,
            metadata={
                "name": "Epoch",
                "type": "Element",
...
class DateTimeModifyType:
    """
    :ivar input:
    :ivar apply_only_if_leap_day: If this is set to True, then the
        specified date time modification will only be applied if the
        input day falls on a leap day (February 29). Otherwise, the
        output date time will be unmodified and the same as the input.
        This was added to accommodate Compressed Certificate "not
        before" (aka issue) dates, which can't fall on a leap day due to
        their simple fixed expire/valid year math for calculating the
        "not after" (aka expire) date. If the issue date was on a leap
        day, then the date could be set to Feb 28th, to fix the
        incompatibility.
    :ivar add_period:
    :ivar set_fields:
    """
    ...
    apply_only_if_leap_day: Optional[BooleanType] = field(
        default=None,
        metadata={
            "name": "Apply_Only_If_Leap_Day",
            "type": "Element",
            "namespace": "https://www.microchip.com/schema/SHA104_Config_1.0",
        }
    )
    ...
    set_fields: Optional[DateTimeModifySetFieldsType] = field(
        default=None,
        metadata={
            "name": "Set_Fields",
            "type": "Element",
...
class PublicKeyEncodeType:
    ...
    ed25519_format: Optional[Ed25519PublicKeyFormatEnum] = field(
        default=None,
        metadata={
            "name": "Ed25519_Format",
            "type": "Element",
    ...
    x25519_format: Optional[X25519PublicKeyFormatEnum] = field(
        default=None,
        metadata={
            "name": "X25519_Format",
            "type": "Element",
...
class SignatureEncodingType:
    ...
    ed_dsa_format: Optional[EdDsasignatureFormatEnum] = field(
        default=None,
        metadata={
            "name": "EdDSA_Format",
            "type": "Element",
...
class StaticPrivateKeyPublicType:
    ...
    format: Optional[PrivateKeyFormatEnums] = field(
        default=None,
        metadata={
            "type": "Attribute",
            "required": True,
...
@dataclass
class X509SignatureAlgorithmEdDsatype:
    class Meta:
        name = "X509SignatureAlgorithmEdDSAType"

    instance: Optional[X509EdDsainstanceType] = field(
        default=None,
        metadata={
            "name": "Instance",
            "type": "Element",
...
class X509TimeType:
    ...
    type_value: Optional[X509TimeTypeType] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Attribute",
...
class ConfigurationSubzone1Type:
    ...
    reserved_1: Optional[DataHex1Byte] = field(
        default=None,
        metadata={
            "name": "Reserved_1",
            "type": "Element",
...
class ConfigurationSubzone3Type:
    ...
    :ivar self_test: If True, Enhanced self-test mode. If False, normal
        self-test mode.
    ...
    self_test: Optional[BooleanType] = field(
        default=None,
        metadata={
            "name": "Self_Test",
            "type": "Element",
...
@dataclass
class CryptoAuthDeriveKeyType:
    """Performs a Crypto Authentication DeriveKey calculation as a KDF.

    Param1/Mode is always 0x04 - Seed/TempKey is derived from a fixed value.

    :ivar parent_key: A 32-byte parent key.
    :ivar target_key: Param2/TargetKey of the DeriveKey command and
        included in the KDF calculation.
    :ivar sn_8_force: Force a different SN[8] value from the one in the
        device serial number.
    :ivar sn_0_1_force: Force a different SN[0:1] value from the one in
        the device serial number.
    :ivar seed: 32 byte value called TempKey in the DeriveKey KDF
        calculation.
    :ivar output_size: Size of the output in bytes. Maximum size is 32
        bytes.
    """
    ...
    sn_0_1_force: Optional[str] = field(
        default=None,
        metadata={
            "name": "SN_0_1_Force",
            "type": "Element",
    ...
    seed: Optional[StringOrDataOrFromSourceType] = field(
        default=None,
        metadata={
            "name": "Seed",
            "type": "Element",
...
class CustomCacertificateType:
    ...
    certificate: Optional[BinaryDataOrStringType] = field(
        default=None,
        metadata={
            "name": "Certificate",
            "type": "Element",
...
class DeviceGenerateKeyType:
    ...
    ed25519: Optional[EmptyType] = field(
        default=None,
        metadata={
            "name": "Ed25519",
            "type": "Element",
    ...
    x25519: Optional[EmptyType] = field(
        default=None,
        metadata={
            "name": "X25519",
            "type": "Element",
...
@dataclass
class SignatureAlgorithmEdDsatype:
    class Meta:
        name = "SignatureAlgorithmEdDSAType"

    instance: Optional[EdDsainstanceType] = field(
        default=None,
        metadata={
            "name": "Instance",
            "type": "Element",
    ...
    context: Optional[BinaryDataOrStringType] = field(
        default=None,
        metadata={
            "name": "Context",
            "type": "Element",
...
@dataclass
class ValueType:
    bytes: Optional[BinaryDataOrStringType] = field(
        default=None,
        metadata={
            "name": "Bytes",
            "type": "Element",
...
class X509SignatureAlgorithmType:
    ...
    ed_dsa: Optional[X509SignatureAlgorithmEdDsatype] = field(
        default=None,
        metadata={
            "name": "EdDSA",
            "type": "Element",
...
class X520DirectoryStringOrFromSourceType(StringOrDataOrFromSourceType):
    ...
    """
    type_value: Optional[X520DirectoryStringOrFromSourceTypeType] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Attribute",
...
class X520Ia5StringOrFromSourceType(StringOrDataOrFromSourceType):
    ...
    type_value: Optional[X520Ia5StringOrFromSourceTypeType] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Attribute",
...
class X520PrintableStringOrFromSourceType(StringOrDataOrFromSourceType):
    ...
    encoding. encoding attribute must be Hex or Base64 for this type.
    """
    type_value: Optional[X520PrintableStringOrFromSourceTypeType] = field(
        default=None,
        metadata={
            "name": "type",
            "type": "Attribute",
...
class Kdftype:
    ...
    crypto_auth_derive_key: Optional[CryptoAuthDeriveKeyType] = field(
        default=None,
        metadata={
            "name": "Crypto_Auth_Derive_Key",
            "type": "Element",
            "namespace": "https://www.microchip.com/schema/SHA104_Config_1.0",
        }
    )
...
class SignatureAlgorithmType:
    ...
    ed_dsa: Optional[SignatureAlgorithmEdDsatype] = field(
        default=None,
        metadata={
            "name": "EdDSA",
            "type": "Element",
...
class StaticBytesType:
    public: Optional[BinaryDataOrStringType] = field(
        default=None,
        metadata={
            "name": "Public",
            "type": "Element",
...
class StaticPublicKeySecretType(AsymmetricSecretBinaryDataType):
    format: Optional[PublicKeyFormatEnums] = field(
        default=None,
        metadata={
            "type": "Attribute",
            "required": True,
...
class DataSourceType:
    ...
    :ivar static_ed25519_private_key: Static ECC Private Key definition.
    :ivar static_ed25519_public_key: Static ECC Public Key definition.
    :ivar static_x25519_private_key: Static ECC Private Key definition.
    :ivar static_x25519_public_key: Static ECC Public Key definition.
    ...
    :ivar crypto_auth_compressed_certificate: Generates a compressed
        certificate and formatted public key from a certificate.
    :ivar crypto_auth_compressed_certificate_sn: Generates a serial
        number using one of the predefined schemes for Crypto
        Authentication Compressed Certificates.
    """
    name: Optional[str] = field(
        default=None,
        metadata={
    ...
    static_ed25519_private_key: Optional[StaticPrivateKeyType] = field(
        default=None,
        metadata={
            "name": "Static_Ed25519_Private_Key",
            "type": "Element",
            "namespace": "https://www.microchip.com/schema/SHA104_Config_1.0",
        }
    )
    static_ed25519_public_key: Optional[StaticPublicKeyType] = field(
        default=None,
        metadata={
            "name": "Static_Ed25519_Public_Key",
            "type": "Element",
            "namespace": "https://www.microchip.com/schema/SHA104_Config_1.0",
        }
    )
    static_x25519_private_key: Optional[StaticPrivateKeyType] = field(
        default=None,
        metadata={
            "name": "Static_X25519_Private_Key",
            "type": "Element",
            "namespace": "https://www.microchip.com/schema/SHA104_Config_1.0",
        }
    )
    static_x25519_public_key: Optional[StaticPublicKeyType] = field(
        default=None,
        metadata={
            "name": "Static_X25519_Public_Key",
            "type": "Element",
            "namespace": "https://www.microchip.com/schema/SHA104_Config_1.0",
        }
    )
    ...
    date_time_format: Optional[DateTimeFormatType] = field(
        default=None,
        metadata={
    ...
    crypto_auth_compressed_certificate: Optional[CryptoAuthCompressedCertificateType] = field(
        default=None,
        metadata={
            "name": "Crypto_Auth_Compressed_Certificate",
            "type": "Element",
            "namespace": "https://www.microchip.com/schema/SHA104_Config_1.0",
        }
    )
    crypto_auth_compressed_certificate_sn: Optional[CryptoAuthCompressedCertificateSntype] = field(
        default=None,
        metadata={
            "name": "Crypto_Auth_Compressed_Certificate_SN",
            "type": "Element",
            "namespace": "https://www.microchip.com/schema/SHA104_Config_1.0",
        }
    )
...
@dataclass
class Sha104Config(Sha104ConfigType):
    class Meta:
        name = "SHA104_Config"
        namespace = "https://www.microchip.com/schema/SHA104_Config_1.0"
...
@dataclass
class Sha106Config(Sha104ConfigType):
    class Meta:
        name = "SHA106_Config"
        namespace = "https://www.microchip.com/schema/SHA104_Config_1.0"
