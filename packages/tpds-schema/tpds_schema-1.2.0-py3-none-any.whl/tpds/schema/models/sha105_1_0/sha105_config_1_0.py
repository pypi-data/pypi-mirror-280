...
__NAMESPACE__ = "https://www.microchip.com/schema/SHA105_Config_1.0"
...
class DataSourcesWriterType:
    ...
    source_name: Optional[str] = field(
        ...
        metadata={
            "name": "Source_Name",
            "type": "Element",
            "namespace": "https://www.microchip.com/schema/SHA105_Config_1.0",
            "required": True,
...
@dataclass
class Sha105Config(Sha105ConfigType):
    class Meta:
        name = "SHA105_Config"
        namespace = "https://www.microchip.com/schema/SHA105_Config_1.0"
