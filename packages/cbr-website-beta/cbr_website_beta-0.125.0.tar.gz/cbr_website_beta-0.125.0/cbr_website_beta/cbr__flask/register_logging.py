...
from cbr_website_beta.utils.decorators.trace__cbr import trace__cbr
from osbot_utils.helpers.trace.Trace_Call import Trace_Call
from osbot_utils.helpers.trace.Trace_Call__Config import Trace_Call__Config
from osbot_utils.testing.Stdout import Stdout
from osbot_utils.utils.Dev import pprint
from osbot_utils.utils.Misc import date_time_now, list_set, random_id
...
def register_logging(app):
    ...
    def pre_request_logging():
        ...
        trace_call_config.show_method_class = False
        ...
        if dydb_cbr_requests.disabled:
            return


        try:
            # todo: move the code below into a separate method (and most likely separate class)
