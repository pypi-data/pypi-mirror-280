...
:LastEditTime: 2024-06-21 14:04:04
...
class CouponUserListHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        # 获取可发放优惠券列表
        coupon_list = CouponModel().get_dict_list(where="shop_id = %s and status = 1 and end_time > %s and coupon_inventory > record_number",params=[shop_id,TimeHelper.get_now_timestamp()],field="coupon_name,coupon_type,use_price,coupon_price,coupon_discount")
        ret_data = {
            "model_list": record_list,
            "count": record_count,
