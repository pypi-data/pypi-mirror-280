...
def get_project(
    ...
    if project_id:
        ...
        return get_project_from_name(
            project_name=project_name, project_type=project_type, raise_if_missing=raise_if_missing
        )
    else:
...
def get_project_from_name(
    project_name: str, project_type: Optional[ProjectType] = None, raise_if_missing: bool = True
) -> Optional[ProjectResponse]:
    """
