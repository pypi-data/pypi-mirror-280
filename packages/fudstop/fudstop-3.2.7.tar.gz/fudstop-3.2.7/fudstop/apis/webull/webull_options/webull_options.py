...
class WebullOptions:
    def __init__(self, database:str='market_data', user:str='chuck'):
        ...
        self.opts = PolygonOptions(host='localhost', user='chuck', database='markets', password='fud', port=5433)
    ...
    async def all_options(self, ticker, direction='all', expireDate =  None):
        try:
            ...
            params = {"type":0,"quoteMultiplier":100,"count":-1,"direction":"all","tickerId":913243251,"expireDate":"2024-06-18","unSymbol":"SPY"}
            expireDate == today if expireDate == None else params['expireDate']
    ...
    async def find_plays(self):
        ...
        async with asyncpg.create_pool(host='localhost', user='chuck', database='markets', port=5433, password='fud') as pool:
