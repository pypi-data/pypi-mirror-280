...
class Polygon:
    def __init__(self, host='localhost', user='chuck', database='market_data', password='fud', port=5433):
        self.host=host
        self.port=port
        self.user=user
    ...
    async def macd(self, ticker: str, timespan: str, limit: str = '1000'):
        ...
        except (ClientConnectorError, ClientOSError, ContentTypeError) as e:
