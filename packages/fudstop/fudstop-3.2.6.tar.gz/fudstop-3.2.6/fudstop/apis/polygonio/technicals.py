...
load_dotenv()
poly = Polygon(host='localhost', user='chuck', database='markets', port=5433, password='fud')
...
class Technicals:
    def __init__(self):
        ...
        self.db = PolygonDatabase(host='localhost', user='chuck', port=5433, password='fud', database='markets')
        self.macd_webhooks =  {
