...
class StockMarket:
    def __init__(self):
        ...
        self.database = PolygonDatabase(user='chuck', database='markets', host='localhost', password='fud', port=5433)
        self.poly = Polygon(user='chuck', host='localhost', port=5433, database='markets', password='fud')
