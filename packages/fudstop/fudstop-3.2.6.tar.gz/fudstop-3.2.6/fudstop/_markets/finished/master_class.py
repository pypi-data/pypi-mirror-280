...
poly = Polygon(host='localhost', user='chuck', database='markets', password='fud', port=5433)
db = Polygon(host='localhost', user='chuck', database='markets', password='fud', port=5433)
...
opts = PolygonOptions(user='chuck', database='markets', host='localhost', password='fud', port=5433)
db = PolygonDatabase(host='localhost', user='chuck', database='markets', password='fud', port=5433)
