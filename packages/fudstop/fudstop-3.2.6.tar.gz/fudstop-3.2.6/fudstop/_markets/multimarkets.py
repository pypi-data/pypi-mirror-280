...
class MultiMarkets(Inserts):
    def __init__(self, user, database, port, host, password):
        self.poly = Polygon(host='localhost', user='chuck', database='markets', password='fud', port=5433)
        self.discord = DiscordSDK()
        self.feed_db = PolygonDatabase(host='localhost', user='chuck', port=5433, password='fud', database='markets')
        ...
        self.opts = PolygonOptions(user='chuck', database='markets', host='localhost', port=5433, password='fud')
...
market = MultiMarkets(host='localhost', user='chuck', database='markets', port=5433, password='fud')
