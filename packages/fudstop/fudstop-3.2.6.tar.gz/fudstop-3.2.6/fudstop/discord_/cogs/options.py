...
class OptionsCOG(commands.Cog):
    def __init__(self, bot):
        self.bot=bot
        self.poly = PolygonOptions(user='chuck', database='markets', host='localhost', port=5433, password='fud')
        self.wt = WebullTrading()
        self.wb = WebullOptions(user='chuck', database='markets', host='localhost', password='fud', port=5433)
        self.db = PolygonDatabase(user='chuck', database='markets', host='localhost', password='fud', port=5433)
        self.ai = OpenAISDK()
