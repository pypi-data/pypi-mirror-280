...
db = PolygonDatabase(user='chuck', database='charlie', host='localhost', port=5433, password='fud')
opts = PolygonOptions(user='chuck', database='charlie', host='localhost', port=5433, password='fud')
