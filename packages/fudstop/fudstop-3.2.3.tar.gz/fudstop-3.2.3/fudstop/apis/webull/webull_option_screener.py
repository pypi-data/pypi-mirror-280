...
class WebullOptionScreener:
    ...
    async def screener(self, **params):
        ...
        if 'implVol_gte' in params or 'implVol_lte' in params:
            await self.add_rule("implVol", self.convert_to_decimal(params.get('implVol_gte')), await self.convert_to_decimal(params.get('implVol_lte')))
        ...
        if 'probITM_gte' in params or 'probITM_lte' in params:
            await self.add_rule("probITM", self.convert_to_decimal(params.get('probITM_gte')), await self.convert_to_decimal(params.get('probITM_lte')))
