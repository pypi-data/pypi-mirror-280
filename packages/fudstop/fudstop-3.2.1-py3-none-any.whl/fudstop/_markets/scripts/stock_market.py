...
class StockMarketLive:
    def __init__(self):
        ...
        self.polygon = Polygon(host='localhost', user='chuck', password='fud', database='markets', port=5432)
    ...
    async def connect(self):
        self.pool = await asyncpg.create_pool(host='localhost', user='chuck', database='markets', port=5432, password='fud', min_size=1, max_size=10)
        return self.pool
    ...
    #             insert_query = """
    #             INSERT INTO trades (
    #                 ticker, exchange, tape, price, size,
