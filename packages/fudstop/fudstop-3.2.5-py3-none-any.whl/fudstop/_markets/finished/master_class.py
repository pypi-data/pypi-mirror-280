...
poly = Polygon(host='localhost', user='chuck', database='markets', password='fud', port=5432)
db = Polygon(host='localhost', user='chuck', database='markets', password='fud', port=5432)
...
opts = PolygonOptions(user='chuck', database='markets', host='localhost', password='fud', port=5432)
