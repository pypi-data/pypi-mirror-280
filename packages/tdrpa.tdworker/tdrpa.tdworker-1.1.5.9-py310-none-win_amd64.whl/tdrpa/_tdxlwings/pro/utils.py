...
import tdrpa._tdxlwings as xlwings # To prevent circular imports
...
class LicenseHandler:
    ...
    def get_license():
        ...
        raise xlwings.LicenseError("Couldn't find an _tdxlwings license key.")
    ...
    def validate_license(product, license_type=None):
        ...
        if key.startswith("gA") and not Fernet:
            ...
            try:
                ...
                raise xlwings.LicenseError("Invalid _tdxlwings license key.") from None
        else:
            signature = hmac.new(
        ...
        if (
            ...
            raise xlwings.LicenseError("Invalid _tdxlwings license key format.") from None
