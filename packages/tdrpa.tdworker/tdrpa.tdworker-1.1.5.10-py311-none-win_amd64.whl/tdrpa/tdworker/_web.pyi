class Web:
    chromeProcess: Incomplete
    @staticmethod
    def OpenChrome(url: str = None, chromeExePath: str = None, isMaximize: bool = True, supportUia: bool = False, otherStartupParam: Incomplete | None = None):
        '''
        打开谷歌浏览器

        App.CreateChrome(url="www.baidu.com", chromeExePath=None, isMaximize=True, supportUia=False, otherStartupParam=None)
        ...
        :param supportUia:[可选参数]是否支持uiautomatin，True支持，False不支持。默认False
