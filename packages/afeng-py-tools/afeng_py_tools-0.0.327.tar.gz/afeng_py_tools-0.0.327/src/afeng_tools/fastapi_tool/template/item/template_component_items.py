...
class TemplatePageHeaderData(TemplateBaseData):
    """页面顶部链息"""
    # topbar数据
    topbar_data: Optional[TemplateTopBarData] = TemplateTopBarData()
    # logo search数据
    logo_search_data: Optional[TemplateLogoSearchData] = TemplateLogoSearchData()
    # fix nav数据
    fix_nav_data: Optional[TemplateFixNavData] = TemplateFixNavData()
