...
class parser():
    ...
    def get(self,model='ASUnet',):
        ...
        try:
            ...
            asu_positions, asu_symbols,sites,kinds = conlattcell2asu(atoms,positions,N_symbols)
            ...
            # 11-d : lattice cell constants (6) ; spacegroup ; total number ; total node number; c lattice volume ;  c lattice total mass
            ...
            if model == 'ASUnet':
                ...
                ori_1 = random.uniform(0, 0.1)
                ori_2 = random.uniform(0, 0.1)
