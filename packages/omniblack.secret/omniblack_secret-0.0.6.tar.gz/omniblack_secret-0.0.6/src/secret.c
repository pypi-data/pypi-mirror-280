...
PyTypeObject* borrowSecretCls(PyObject* self) {
    PyTypeObject* cls;
    ...
    SecretModuleState* state = (SecretModuleState*)PyModule_GetState(mod);
...
PyObject* tp_new(PyTypeObject *subtype, PyObject *args, PyObject *kwds) {
    ...
    PyObject* self = prepare_new_secret(subtype, data_buffer, len);
    Py_DECREF(string);
...
PyObject* random_secret(PyTypeObject* cls, PyObject* args) {
    ...
    // This may not be a good idea as some point we
    // should check to see if the cost of allocating and encoding
    // exceeds the cost of releasing and acquiring the GIL.
    ...
    PyObject* result = prepare_new_secret(
        cls,
        b64_data,
        // b64_maxlen include the trailing NULL
