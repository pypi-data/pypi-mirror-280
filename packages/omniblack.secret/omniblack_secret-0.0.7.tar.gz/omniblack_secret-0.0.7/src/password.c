...
PyObject* random_password(PyTypeObject* cls, PyObject* Py_UNUSED(args)) {
    PyObject* mod = PyType_GetModuleByDef(cls, &secret_mod);
    ...
    PyObject* new_secret = prepare_new_secret(cls, new_pass, pass_len);
...
PyMethodDef password_methods[] = {
    ...
    },
    {
        ...
        .ml_doc=PyDoc_STR(
            ...
            "NOTE: Only useful on the unhashed password."
        ),
    },
    {
