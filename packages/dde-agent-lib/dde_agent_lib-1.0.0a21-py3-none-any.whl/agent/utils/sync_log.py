...
# from apps.agentcore.config.app_config import get_app_config
# from apps.agentcore.utils.global_safe_storage import get_system_config_from_nacos
...
def sync_files_oss():
    ...
    # access_key_id = 'LTAI5tMEAqUwBvV5GFFerV5Q'
    # access_key_secret = '34xZWr2aHtsVzIKAsZxl4ksfvZSihR'
    # bucket_name = 'geogpt-oss'
...
def async_sync():
    ...
    #     executor.submit(sync_files_oss)
