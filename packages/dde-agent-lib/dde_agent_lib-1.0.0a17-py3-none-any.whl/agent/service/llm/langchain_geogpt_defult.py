...
from agent.service.llm.langchain_geogpt_new import LangchainGeoGPTNew
...
class LangchainGeoGPTDefault(LLM, CustomModel):
    ...
    @staticmethod
    async def http_request(prompt, system, history, endpoint, stream, max_output_length, template_name):
        service_params = {
    ...
    @staticmethod
    def ahttp_request_stream(prompt, system, history, endpoint, stream, max_output_length, template_name):
        service_params = {
            "promptTemplateName": template_name,
            "stream": stream,
            "maxOutputLength": max_output_length
