...
from shyft.time_series import (TimeAxis, Calendar, DoubleVector, UtcPeriod, POINT_INSTANT_VALUE, POINT_AVERAGE_VALUE,
                               TsVector, pow)

from shyft.hydrology import (
    RelHumSource, TemperatureSource, WindSpeedSource, RadiationSource, PrecipitationSource, PrecipitationSourceVector,
...
def calculate_pressure_tsv(elevation: DoubleVector, sea_level_pressure: TsVector) -> TsVector:
    """
