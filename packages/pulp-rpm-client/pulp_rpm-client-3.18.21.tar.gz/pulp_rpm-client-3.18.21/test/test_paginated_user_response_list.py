...
from pulpcore.client.pulp_rpm.models.paginated_user_response_list import PaginatedUserResponseList  # noqa: E501
...
class TestPaginatedUserResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pulpcore.client.pulp_rpm.models.paginated_user_response_list.PaginatedUserResponseList()  # noqa: E501
        if include_optional :
            return PaginatedUserResponseList(
                ...
                results = [
                    pulpcore.client.pulp_rpm.models.user_response.UserResponse(
                        pulp_href = '0', 
                        id = 56, 
                        username = '0', 
                        first_name = '0', 
                        ...
                        groups = [
                            pulpcore.client.pulp_rpm.models.user_group_response.UserGroupResponse(
                                name = '0', 
                                pulp_href = '0', )
                            ], 
                        hidden_fields = [
