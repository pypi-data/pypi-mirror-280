...
from pulpcore.client.pulp_rpm.models.paginated_remote_response_list import PaginatedRemoteResponseList  # noqa: E501
...
class TestPaginatedRemoteResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pulpcore.client.pulp_rpm.models.paginated_remote_response_list.PaginatedRemoteResponseList()  # noqa: E501
        if include_optional :
            return PaginatedRemoteResponseList(
                ...
                results = [
                    pulpcore.client.pulp_rpm.models.remote_response.RemoteResponse(
                        pulp_href = '0', 
