...
class TaskScheduleResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, name=None, task_name=None, dispatch_interval=None, next_dispatch=None, last_task=None, local_vars_configuration=None):  # noqa: E501
    ...
    def dispatch_interval(self, dispatch_interval):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and dispatch_interval is None:  # noqa: E501
            raise ValueError("Invalid value for `dispatch_interval`, must not be `None`")  # noqa: E501
