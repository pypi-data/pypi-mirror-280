...
class PatchedDomain(object):
    ...
    def __init__(self, name=None, description=None, storage_class=None, storage_settings=None, redirect_to_object_storage=True, hide_guarded_distributions=False, local_vars_configuration=None):  # noqa: E501
        """PatchedDomain - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this PatchedDomain.  # noqa: E501

        A name for this domain.  # noqa: E501

        :return: The name of this PatchedDomain.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PatchedDomain.

        A name for this domain.  # noqa: E501

        :param name: The name of this PatchedDomain.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this PatchedDomain.  # noqa: E501

        An optional description.  # noqa: E501

        :return: The description of this PatchedDomain.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this PatchedDomain.

        An optional description.  # noqa: E501

        :param description: The description of this PatchedDomain.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def storage_class(self):
        """Gets the storage_class of this PatchedDomain.  # noqa: E501
        ...
        :return: The storage_class of this PatchedDomain.  # noqa: E501
    ...
    def storage_class(self, storage_class):
        """Sets the storage_class of this PatchedDomain.

        Backend storage class for domain.  * `pulpcore.app.models.storage.FileSystem` - Use local filesystem as storage * `storages.backends.s3boto3.S3Boto3Storage` - Use Amazon S3 as storage * `storages.backends.azure_storage.AzureStorage` - Use Azure Blob as storage  # noqa: E501

        :param storage_class: The storage_class of this PatchedDomain.  # noqa: E501
    ...
    def storage_settings(self):
        """Gets the storage_settings of this PatchedDomain.  # noqa: E501

        Settings for storage class.  # noqa: E501

        :return: The storage_settings of this PatchedDomain.  # noqa: E501
        :rtype: object
        """
    ...
    def storage_settings(self, storage_settings):
        """Sets the storage_settings of this PatchedDomain.

        Settings for storage class.  # noqa: E501

        :param storage_settings: The storage_settings of this PatchedDomain.  # noqa: E501
        :type: object
        """
    ...
    def redirect_to_object_storage(self):
        """Gets the redirect_to_object_storage of this PatchedDomain.  # noqa: E501

        Boolean to have the content app redirect to object storage.  # noqa: E501

        :return: The redirect_to_object_storage of this PatchedDomain.  # noqa: E501
        :rtype: bool
        """
    ...
    def redirect_to_object_storage(self, redirect_to_object_storage):
        """Sets the redirect_to_object_storage of this PatchedDomain.

        Boolean to have the content app redirect to object storage.  # noqa: E501

        :param redirect_to_object_storage: The redirect_to_object_storage of this PatchedDomain.  # noqa: E501
        :type: bool
        """
    ...
    def hide_guarded_distributions(self):
        """Gets the hide_guarded_distributions of this PatchedDomain.  # noqa: E501

        Boolean to hide distributions with a content guard in the content app.  # noqa: E501

        :return: The hide_guarded_distributions of this PatchedDomain.  # noqa: E501
        :rtype: bool
        """
    ...
    def hide_guarded_distributions(self, hide_guarded_distributions):
        """Sets the hide_guarded_distributions of this PatchedDomain.

        Boolean to hide distributions with a content guard in the content app.  # noqa: E501

        :param hide_guarded_distributions: The hide_guarded_distributions of this PatchedDomain.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchedDomain):
            return False
