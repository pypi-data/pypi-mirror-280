...
class UpstreamPulpsApi(object):
    ...
    def replicate(self, upstream_pulp_href, upstream_pulp,  **kwargs):  # noqa: E501
        """Replicate  # noqa: E501

        Trigger an asynchronous repository replication task group. This API is provided as a tech preview.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.replicate(upstream_pulp_href, upstream_pulp, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.replicate_with_http_info(upstream_pulp_href, upstream_pulp,  **kwargs)  # noqa: E501

    def replicate_with_http_info(self, upstream_pulp_href, upstream_pulp,  **kwargs):  # noqa: E501
        """Replicate  # noqa: E501

        Trigger an asynchronous repository replication task group. This API is provided as a tech preview.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.replicate_with_http_info(upstream_pulp_href, upstream_pulp, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('upstream_pulp' not in local_var_params or  # noqa: E501
                                                        local_var_params['upstream_pulp'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `upstream_pulp` when calling `replicate`")  # noqa: E501
