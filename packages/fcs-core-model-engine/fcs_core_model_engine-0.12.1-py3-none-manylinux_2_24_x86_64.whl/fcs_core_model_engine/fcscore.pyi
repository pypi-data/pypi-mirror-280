...
class MeshComponentInstance(ModelItemInstance):
    def save_updated_component_mesh(self, component_mesh: ComponentMesh) -> bool: ...
    def get_component_mesh(self) -> ComponentMesh: ...
...
class Model:
    ...
    def remove_model_instance(self, instanceId: int) -> List[int]: ...
    ...
    def load_model(modelFilePath: str) -> bool: ...
