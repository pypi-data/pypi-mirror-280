...
class GenerateRequest(BaseModel):
    model: Literal["TinyLlama/TinyLlama-1.1B-Chat-v1.0" ,"HuggingFaceH4/zephyr-7b-beta" ,"mistralai/Mistral-7B-Instruct-v0.2" ,"microsoft/phi-2", "microsoft/Phi-3-mini-4k-instruct", "meta-llama/Meta-Llama-3-8B-Instruct"] = Field("TinyLlama/TinyLlama-1.1B-Chat-v1.0", description="The model to use for generation.")
