...
from eis.insurance.api import booking_funnels_api
...
with eis.insurance.ApiClient(configuration) as api_client:
    ...
    api_instance = booking_funnels_api.BookingFunnelsApi(api_client)
    create_booking_funnel_request_dto = CreateBookingFunnelRequestDto(
        code="code_example",
        parent_id=3,
        name="Booking Funnel Test",
        js_code="js_code_example",
        steps_config={},
        css="css_example",
        logo_path="logo_path_example",
    ...
    try:
        # Create the booking funnel
        api_response = api_instance.create_booking_funnel(create_booking_funnel_request_dto, authorization=authorization)
        pprint(api_response)
    except eis.insurance.ApiException as e:
        print("Exception when calling BookingFunnelsApi->create_booking_funnel: %s\n" % e)
```
