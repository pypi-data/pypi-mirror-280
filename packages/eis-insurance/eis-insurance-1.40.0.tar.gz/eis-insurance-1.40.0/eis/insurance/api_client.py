...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BookingFunnelsApi()
        api_instance.create_booking_funnel  # this is an instance of the class Endpoint
        api_instance.create_booking_funnel()  # this invokes api_instance.create_booking_funnel.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_booking_funnel.callable or self.callable in this class
