...
class ObjectIdentificationGPTImpl(IObjectIdentification):
    ...
    def __init__(self, engine_configurations: EngineConfigurations):
        ...
        self.object_identifier = self.agent_picker.create_agent(LLMAgentNames.OBJECT_IDENTIFIER)
        self.image_validator = self.agent_picker.create_agent(LLMAgentNames.IMAGE_VALIDATOR)
        self.image_describer = self.agent_picker.create_agent(LLMAgentNames.IMAGE_DESCRIBER)
