from dronebuddylib.atoms.llmintegration.generic_agent_impl import GenericAgentImpl
...
class AgentFactory:
    ...
    def __init__(self, model_name: str, api_key: str, temperature: float = None):
        ...
        self.generic_agent = GenericAgentImpl(api_key, model_name, temperature)

    def create_agent(self, agent: LLMAgentNames):
        ...
        elif agent == LLMAgentNames.GENERIC_AGENT:
