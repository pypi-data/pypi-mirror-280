...
class ObjectIdentifierAgentImpl(ILLMAgent):
    ...
    {
        "description": "description of the items that can be read out to the user, be very specific, if known items are recognized
         definitely mention them. Give the description as if you are talking to a blind person.",
        "data": [
            {
