...
class FaceRecognitionEngine:
    ...
    def __init__(self, algorithm: FaceRecognitionAlgorithm, config: EngineConfigurations):
        ...
        if algorithm == FaceRecognitionAlgorithm.FACE_RECOGNITION_KNN or algorithm == FaceRecognitionAlgorithm.FACE_RECOGNITION_KNN.name:
        ...
        elif algorithm == FaceRecognitionAlgorithm.FACE_RECOGNITION_EUCLIDEAN or algorithm == FaceRecognitionAlgorithm.FACE_RECOGNITION_EUCLIDEAN.name:
            from dronebuddylib.atoms.facerecognition.face_recognition_euclidean_impl import FaceRecognitionEuclideanImpl
            self.face_recognition_engine = FaceRecognitionEuclideanImpl(config)
        else:
