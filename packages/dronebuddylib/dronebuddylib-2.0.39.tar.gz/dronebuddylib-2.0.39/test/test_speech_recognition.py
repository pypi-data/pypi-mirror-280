...
class TestSpeechRecognition(unittest.TestCase):
    ...
    def test_speech_to_text_online(self):
        ...
        engine_configs.add_configuration(AtomicEngineConfigurations.SPEECH_RECOGNITION_VOSK_LANGUAGE_MODEL_PATH,
                                         r"C:\Users\augme\Downloads\vosk-model-small-fr-0.22\vosk-model-small-fr-0.22")
    ...
    # def test_speech_to_text_offline(self):
    #     engine_configs = EngineConfigurations({})
