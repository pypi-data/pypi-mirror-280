...
class DroneCommands(enum.Enum):
    ...
    RECOGNIZE_PERSON = "recognize the person in the image"
    REMEMBER_PERSON = "remember the person"
    REMEMBER_PLACE = "remember the place"
    RECOGNIZE_PLACE = "recognize the place from a known set of places"
    RECOGNIZE_KNOWN_ITEM = "recognize the item from a know set of items"
    REMEMBER_ITEM = "remember the item"
    READ_TEXT_FROM_GIVEN_IMAGE = "read the text from the image"
    DETECT_OBJECTS = "detect the object in the image"
    QNA_SCENE = "answer the questions and describe about the scene"
    VERIFY_IF_OBJECT_IS_IN_THE_IMAGE = "verify if the given known object is in the image"
