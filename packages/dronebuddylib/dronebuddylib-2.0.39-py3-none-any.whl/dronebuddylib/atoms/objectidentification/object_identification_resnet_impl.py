...
from dronebuddylib.atoms.objectidentification.object_identification_result import IdentifiedObjectObject, \
    IdentifiedObjects
from dronebuddylib.exceptions.common_exception import CommonException
...
class ObjectIdentificationResnetImpl(IObjectIdentification):
    ...
    def create_memory(self, changes=None):
        ...
        try:
            ...
            return CommonException("Error occurred while training the classifier", 500, e)
    ...
    def recognize_objects(self, image, top_n=3) -> IdentifiedObjects:
        ...
        predicted_place = model.predict([features])
        ...
        probabilities = model.predict_proba([features])[0]  # Probabilities of all classes
