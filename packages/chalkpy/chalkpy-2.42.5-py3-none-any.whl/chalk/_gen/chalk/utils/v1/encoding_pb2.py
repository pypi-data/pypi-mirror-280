...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, "chalk.utils.v1.encoding_pb2", globals())
if _descriptor._USE_C_DESCRIPTORS == False:
    google_dot_protobuf_dot_descriptor__pb2.EnumOptions.RegisterExtension(encoding)
    ...
    _STRINGENCODING_MAPPINGENTRY._options = None
    _STRINGENCODING_MAPPINGENTRY._serialized_options = b"8\001"
    _STRINGENCODING._serialized_start = 84
    _STRINGENCODING._serialized_end = 231
    _STRINGENCODING_MAPPINGENTRY._serialized_start = 173
    _STRINGENCODING_MAPPINGENTRY._serialized_end = 231
