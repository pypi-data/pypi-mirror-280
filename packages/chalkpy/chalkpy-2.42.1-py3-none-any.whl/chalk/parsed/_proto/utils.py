...
RESOLVER_ENUM_TO_KIND = {
    graph_pb.ResolverKind.RESOLVER_KIND_UNSPECIFIED: "UNSPECIFIED",
    graph_pb.ResolverKind.RESOLVER_KIND_ONLINE: "online",
    graph_pb.ResolverKind.RESOLVER_KIND_OFFLINE: "offline",
}
