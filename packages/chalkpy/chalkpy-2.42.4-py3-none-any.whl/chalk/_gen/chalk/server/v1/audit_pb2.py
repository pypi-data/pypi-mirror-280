...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, "chalk.server.v1.audit_pb2", globals())
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _AUDITLOG_REQUESTENTRY._options = None
    _AUDITLOG_REQUESTENTRY._serialized_options = b"8\001"
    _AUDITLOG_RESPONSEENTRY._options = None
    _AUDITLOG_RESPONSEENTRY._serialized_options = b"8\001"
    _AUDITSERVICE.methods_by_name["GetAuditLogs"]._options = None
    _AUDITSERVICE.methods_by_name["GetAuditLogs"]._serialized_options = b"\200}\006"
    _AUDITLOG._serialized_start = 195
    _AUDITLOG._serialized_end = 805
    _AUDITLOG_REQUESTENTRY._serialized_start = 593
    _AUDITLOG_REQUESTENTRY._serialized_end = 675
    _AUDITLOG_RESPONSEENTRY._serialized_start = 677
    _AUDITLOG_RESPONSEENTRY._serialized_end = 760
    _GETAUDITLOGSREQUEST._serialized_start = 807
    _GETAUDITLOGSREQUEST._serialized_end = 828
    _GETAUDITLOGSRESPONSE._serialized_start = 830
    _GETAUDITLOGSRESPONSE._serialized_end = 899
    _AUDITSERVICE._serialized_start = 901
    _AUDITSERVICE._serialized_end = 1013
