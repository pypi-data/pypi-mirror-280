...
class DataFrame(_message.Message):
    __slots__ = ["limit", "optional_columns", "required_columns"]
...
class Key(_message.Message):
    __slots__ = ["dataframe", "has_many", "raw_column", "scalar"]
...
class NodeImpl(_message.Message):
    __slots__ = ["chalk_project", "default_injector", "givens_scan", "project", "unknown"]
...
class Plan(_message.Message):
    __slots__ = ["nodes", "pyarrow_schema", "root_node_idx"]
