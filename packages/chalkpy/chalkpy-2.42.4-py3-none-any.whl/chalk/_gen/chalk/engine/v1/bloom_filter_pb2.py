...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, "chalk.engine.v1.bloom_filter_pb2", globals())
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _BLOOMFILTER._serialized_start = 56
    _BLOOMFILTER._serialized_end = 298
