...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, "chalk.common.v1.operation_kind_pb2", globals())
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _OPERATIONKIND._serialized_start = 58
    _OPERATIONKIND._serialized_end = 334
