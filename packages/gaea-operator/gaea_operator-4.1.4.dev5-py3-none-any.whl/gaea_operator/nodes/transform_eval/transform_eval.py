...
from gaea_operator.dataset import CocoDataset, ImageNetDataset, CityscapesDataset
...
def transform_eval(args):
    ...
    if args.input_model_uri is not None and len(args.input_model_uri) > 0:
        ...
        args.input_model_uri = "/home/windmill/tmp/transform"
    ...
    elif response.annotationFormat in [ANNOTATION_FORMAT_IMAGENET, ANNOTATION_FORMAT_PADDLECLS]:
