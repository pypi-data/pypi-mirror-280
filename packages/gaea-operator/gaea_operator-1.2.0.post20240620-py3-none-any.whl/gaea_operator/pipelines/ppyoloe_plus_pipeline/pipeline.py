...
def pipeline(accelerator: str = "T4",
    ...
    train = ContainerStep(name="train",
                          docker_env=
                          "iregistry.baidu-int.com/windmill-public/train/paddlepaddle:v1.2.0-hotfix-20240620",
    ...
    eval = ContainerStep(name="eval",
                         docker_env="iregistry.baidu-int.com/windmill-public/train/paddlepaddle:v1.2.0-hotfix-20240620",
    ...
    transform = ContainerStep(name="transform",
                              docker_env="iregistry.baidu-int.com/windmill-public/transform:v1.2.0-hotfix-20240620",
                              env=transform_env,
