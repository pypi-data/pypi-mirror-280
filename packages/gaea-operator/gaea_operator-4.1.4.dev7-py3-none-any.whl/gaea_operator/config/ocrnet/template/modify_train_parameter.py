...
def generate_train_config(
    ...
    # 更新metadata
    metadata["algorithmParameters"].update({'mean': f'{mean}', 'std': f'{std}'})
    ...
    # 1.2 pretrained
    set_pretrained(yaml_data, advanced_parameters[KEY_MODEL_TYPE], advanced_parameters[KEY_PRETRAINED])
