...
class YeeduOperator():
    ...
    def __init__(self, job_url, connection_name,login_password, *args, **kwargs):
        """
        Initializes the NotebookManager instance with the given parameters.
        
        Parameters:
        - job_url (str): The URL of the Yeedu Notebook or job.
        - connection_name (str): The prefect connection name. This connection is a JSON string should contain:
        ...
        - login_password (str): The password for connection.
        - *args: Additional arguments.
        - **kwargs: Additional keyword arguments.
        
        Raises:
        - ValueError: If the job URL is not provided.
        - ValueError: If the connection_name is not a valid JSON string.
        """
    ...
    This method loads a secret block identified by `self.login_password` using `Secret.load`.
    ...
    The extracted base URL is constructed by appending ':8080/api/v1/' to the parsed scheme and hostname.
    ...
    """
        ...
        # Construct base URL with :8080/api/v1/ appended
