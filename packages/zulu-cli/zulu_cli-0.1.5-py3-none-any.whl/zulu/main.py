        ...
        if args.env:
            ...
            if environment:
                ...
                if args.encrypt and args.decrypt:
                    ...
                    if secrets_path:
                        secrets_tool.encrypt_yaml_file(secrets_path,"nUTHusINgenteRVaNDEBAnDeNtArMiNdYNEparISHiCTrAmE")
                    else:
                        print("Error: Secrets file not found.")
                elif args.decrypt:
                    if secrets_path:
                        secrets_tool.decrypt_yaml_file(secrets_path,"nUTHusINgenteRVaNDEBAnDeNtArMiNdYNEparISHiCTrAmE")
        ...
        if args.env:
            ...
            if environment:
                ...
                if args.encrypt and args.decrypt:
                    ...
                    secrets.decrypt_yaml_file(secrets_path,"nUTHusINgenteRVaNDEBAnDeNtArMiNdYNEparISHiCTrAmE")
                else:
                    print("No operation specified. Use --encrypt or --decrypt.")
