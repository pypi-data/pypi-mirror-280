...
_DATA_FORMATS = ("esrfv1", "esrfv2", "esrfv3", "id16bspec")
...
def get_dataset_filter(raw_root_dir: str, raw_data_format: str = "esrfv3") -> str:
    """Get the dataset directory search filter from the raw data directory."""
    if raw_data_format in ("esrfv1", "esrfv2", "esrfv3", "id16bspec"):
