...
from insuant.helpers.flow import list_flows, load_flow, run_flow
from insuant.interface.custom.code_parser.utils import (
    extract_inner_type_from_generic_alias,
    extract_union_types_from_generic_alias,
)
from insuant.interface.custom.custom_component.component import Component
from insuant.schema import Record
from insuant.schema.dotdict import dotdict
from insuant.services.deps import get_storage_service, get_variable_service, session_scope
...
class CustomComponent(Component):
    """
    Represents a custom component in insuant.
