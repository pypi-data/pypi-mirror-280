...
def print_banner(host: str, port: int):
    ...
    try:
        from insuant.version import __version__ as langflow_version  # type: ignore
    ...
    if langflow_version is None:  # This means insuant.version was not imported
        try:
...
def run_langflow(host, port, log_level, options, app):
    ...
    try:
        if platform.system() in ["Windows"]:
            ...
            from insuant.server import LangflowApplication
