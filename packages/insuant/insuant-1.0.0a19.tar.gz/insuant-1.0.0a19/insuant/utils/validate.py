...
from insuant.field_typing.constants import CUSTOM_COMPONENT_SUPPORTED_TYPES
...
def create_class(code, class_name):
    ...
    # Replace from langflow import CustomComponent with from insuant.custom import CustomComponent
    code = code.replace("from langflow import CustomComponent", "from insuant.custom import CustomComponent")
...
def get_default_imports(code_string):
    ...
    langflow_module = importlib.import_module("insuant.field_typing")
