...
from insuant.services.base import Service
from insuant.services.database import models  # noqa
from insuant.services.database.models.user.crud import get_user_by_username
from insuant.services.database.utils import Result, TableResults
from insuant.services.deps import get_settings_service
from insuant.services.utils import teardown_superuser
...
class DatabaseService(Service):
    ...
    def __init__(self, database_url: str):
        ...
        # This file is in insuant.services.database.manager.py
