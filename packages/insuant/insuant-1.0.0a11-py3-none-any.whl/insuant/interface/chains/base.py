...
from insuant.interface.importing.utils import import_class
...
from insuant.template.frontend_node.chains import ChainFrontendNode
...
class ChainCreator(LangChainTypeCreator):
    ...
    def type_to_loader_dict(self) -> Dict:
        if self.type_dict is None:
            ...
            from insuant.interface.chains.custom import CUSTOM_CHAINS
