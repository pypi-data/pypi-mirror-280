...
from insuant.services.deps import get_chat_service, get_session, get_session_service
from insuant.services.monitor.utils import log_vertex_build

if TYPE_CHECKING:
    from insuant.graph.vertex.types import ChatVertex
...
async def try_running_celery_task(vertex, user_id):
    ...
    try:
        from insuant.worker import build_vertex
