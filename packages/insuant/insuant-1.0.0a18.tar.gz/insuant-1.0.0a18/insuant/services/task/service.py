...
from insuant.services.task.backends.anyio import AnyIOBackend
from insuant.services.task.backends.base import TaskBackend
from insuant.services.task.utils import get_celery_worker_status
...
def check_celery_availability():
    try:
        from insuant.worker import celery_app
...
class TaskService(Service):
    ...
    def get_backend(self) -> TaskBackend:
        if self.use_celery:
            from insuant.services.task.backends.celery import CeleryBackend
