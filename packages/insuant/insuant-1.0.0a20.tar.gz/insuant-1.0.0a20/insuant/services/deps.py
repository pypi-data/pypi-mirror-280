...
from insuant.services.schema import ServiceType

if TYPE_CHECKING:
    from sqlmodel import Session

    from insuant.services.cache.service import CacheService
    from insuant.services.chat.service import ChatService
    from insuant.services.database.service import DatabaseService
    from insuant.services.monitor.service import MonitorService
    from insuant.services.plugins.service import PluginService
    from insuant.services.session.service import SessionService
    from insuant.services.settings.service import SettingsService
    from insuant.services.socket.service import SocketIOService
    from insuant.services.state.service import StateService
    from insuant.services.storage.service import StorageService
...
def get_service(service_type: ServiceType, default=None):
    ...
    """
    from insuant.services.manager import service_manager
...
def get_state_service() -> "StateService":
    ...
    """
    from insuant.services.state.factory import StateServiceFactory
...
def get_storage_service() -> "StorageService":
    ...
    """
    from insuant.services.storage.factory import StorageServiceFactory
...
def get_variable_service() -> "VariableService":
    ...
    """
    from insuant.services.variable.factory import VariableServiceFactory
...
def get_settings_service() -> "SettingsService":
    ...
    """
    from insuant.services.settings.factory import SettingsServiceFactory
...
def get_db_service() -> "DatabaseService":
    ...
    """
    from insuant.services.database.factory import DatabaseServiceFactory
...
def get_cache_service() -> "CacheService":
    ...
    """
    from insuant.services.cache.factory import CacheServiceFactory
...
def get_session_service() -> "SessionService":
    ...
    """
    from insuant.services.session.factory import SessionServiceFactory
...
def get_monitor_service() -> "MonitorService":
    ...
    """
    from insuant.services.monitor.factory import MonitorServiceFactory
...
def get_task_service() -> "TaskService":
    ...
    """
    from insuant.services.task.factory import TaskServiceFactory
