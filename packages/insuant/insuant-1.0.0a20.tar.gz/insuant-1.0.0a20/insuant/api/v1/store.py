...
from insuant.api.utils import check_langflow_version
from insuant.services.auth import utils as auth_utils
from insuant.services.database.models.user.model import User
from insuant.services.deps import get_settings_service, get_store_service
from insuant.services.store.exceptions import CustomException
from insuant.services.store.schema import (
...
async def share_component(
    ...
    try:
        await check_insaunt_version(component)
...
async def update_shared_component(
    ...
    try:
        await check_insuant_version(component)
