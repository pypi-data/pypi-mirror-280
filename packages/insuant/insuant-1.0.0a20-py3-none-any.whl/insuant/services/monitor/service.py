...
from insuant.services.monitor.schema import MessageModel, TransactionModel, VertexBuildModel
from insuant.services.monitor.utils import add_row_to_table, drop_and_create_table_if_schema_mismatch
...
class MonitorService(Service):
    ...
    def __init__(self, settings_service: "SettingsService"):
        ...
        self.base_cache_dir = Path(user_cache_dir("insuant"))
