...
if TYPE_CHECKING:
    from insuant.services.database.models.user import User
...
class FlowBase(SQLModel):
    ...
    parent_id: Optional[UUID] = Field(default=None, index=True, nullable=True)
    type: Optional[str] = Field(default=None, nullable=True)
    published: Optional[bool] = Field(default=False, nullable=True)
