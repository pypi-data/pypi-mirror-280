...
from insuant.utils.logger import InterceptHandler  # type: ignore
...
class InsauntApplication(BaseApplication):
    def __init__(self, app, options=None):
        self.options = options or {}

        self.options["worker_class"] = "insuant.server.LangflowUvicornWorker"
