            ...
            <thead>
                ...
                <tr>
                    ...
                    <th scope="col" class="col_number" title="Total des kilomètres validés dans de MooGLi en ${year}">
                        <span class="screen-reader-text">Total des </span>K<span class="screen-reader-text">ilo</span>m<span class="screen-reader-text">ètre</span>s<span class="screen-reader-text"> validés dans de MooGLi en ${year}</span>
                    </th>
