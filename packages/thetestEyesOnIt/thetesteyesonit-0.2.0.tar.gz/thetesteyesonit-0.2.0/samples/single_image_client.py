from src.thetestEyesOnIt import EyesOnItSDK, EOIPrompt, EOIRegion
...
result = app.process_image(prompts=prompts, regions=regions, image="C:/Users/ctuchez/Downloads/1.png")
