...
class NotificationsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration[NotificationsRequestBuilderPostQueryParameters]] = None) -> None:
        """
    ...
    def to_post_request_information(self,request_configuration: Optional[RequestConfiguration[NotificationsRequestBuilderPostQueryParameters]] = None) -> RequestInformation:
        """
        Update notifications for a Test. It is possible to disable notifications for a Test, so that no notifications are sent to subscribers
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class NotificationsRequestBuilderPostRequestConfiguration(RequestConfiguration[NotificationsRequestBuilderPostQueryParameters]):
        """
