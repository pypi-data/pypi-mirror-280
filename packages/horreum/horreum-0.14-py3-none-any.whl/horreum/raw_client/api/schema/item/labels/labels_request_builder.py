...
class LabelsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Label, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[int]:
        """
    ...
    def to_post_request_information(self,body: Label, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Save new or update existing Label for a Schema
        param body: A Label is a core component of Horreum, defining which components of the JSON document are part of a KPI and how the metric values are calculated
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
