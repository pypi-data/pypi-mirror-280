...
class DescriptorsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[DescriptorsRequestBuilderGetQueryParameters]] = None) -> Optional[List[SchemaDescriptor]]:
        """
