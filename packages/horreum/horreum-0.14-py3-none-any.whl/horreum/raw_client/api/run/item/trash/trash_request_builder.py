...
class TrashRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration[TrashRequestBuilderPostQueryParameters]] = None) -> None:
        """
    ...
    def to_post_request_information(self,request_configuration: Optional[RequestConfiguration[TrashRequestBuilderPostQueryParameters]] = None) -> RequestInformation:
        """
        Trash a Run with a given ID
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> TrashRequestBuilder:
        """
    ...
    @dataclass
    class TrashRequestBuilderPostRequestConfiguration(RequestConfiguration[TrashRequestBuilderPostQueryParameters]):
        """
