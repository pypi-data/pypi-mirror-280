...
if TYPE_CHECKING:
    from .run_extended_access import RunExtended_access
    from .schema_usage import SchemaUsage
    from .validation_error import ValidationError

@dataclass
class RunExtended(AdditionalDataHolder, Parsable):
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: Dict[str, Any] = field(default_factory=dict)

    # Access rights for the test. This defines the visibility of the Test in the UI
    access: Optional[RunExtended_access] = None
    # Run result payload
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RunExtended:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "access": lambda n : setattr(self, 'access', n.get_enum_value(RunExtended_access)),
