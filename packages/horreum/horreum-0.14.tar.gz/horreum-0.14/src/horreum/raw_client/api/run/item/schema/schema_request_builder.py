...
class SchemaRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: str, request_configuration: Optional[RequestConfiguration[SchemaRequestBuilderPostQueryParameters]] = None) -> Optional[SchemaPostResponse]:
        """
    ...
    def to_post_request_information(self,body: str, request_configuration: Optional[RequestConfiguration[SchemaRequestBuilderPostQueryParameters]] = None) -> RequestInformation:
        """
        Update Run schema for part of JSON data
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class SchemaRequestBuilderPostRequestConfiguration(RequestConfiguration[SchemaRequestBuilderPostQueryParameters]):
        """
