...
class MoveRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration[MoveRequestBuilderPostQueryParameters]] = None) -> None:
        """
    ...
    def to_post_request_information(self,request_configuration: Optional[RequestConfiguration[MoveRequestBuilderPostQueryParameters]] = None) -> RequestInformation:
        """
        Update the folder for a Test. Tests can be moved to different folders
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class MoveRequestBuilderPostRequestConfiguration(RequestConfiguration[MoveRequestBuilderPostQueryParameters]):
        """
