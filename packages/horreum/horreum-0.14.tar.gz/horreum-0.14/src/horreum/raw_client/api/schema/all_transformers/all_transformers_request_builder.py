...
class AllTransformersRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[List[TransformerInfo]]:
        """
    ...
    def with_url(self,raw_url: str) -> AllTransformersRequestBuilder:
        """
    ...
    @dataclass
    class AllTransformersRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
