...
class ImportRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: TestExport, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> None:
        """
    ...
    def to_post_request_information(self,body: TestExport, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Import a previously exported Test either as a new Test or to update an existing Test
        param body: Represents a Test with all associated data used for export/import operations.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
