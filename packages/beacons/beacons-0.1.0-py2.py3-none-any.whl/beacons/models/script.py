"""
This file supports Script Pattern for beacons
"""
...
# ScriptItem
# ---------------------------------------------------------
class BeaconsScript(Item):
    """A Beacons Script model"""
    pass
...
# ScriptRequest
# ---------------------------------------------------------
class BeaconsScriptRequest(Request):
    
    """A Beacons request to Script manager.
...
# ScriptResponse
# ---------------------------------------------------------
class BeaconsScriptResponse(Response):
    
    """A Beacons response to Script manager.
    Contains the search results given by a request.
    """
    data: Dict[UID_TYPE, BeaconsScript] = {}
