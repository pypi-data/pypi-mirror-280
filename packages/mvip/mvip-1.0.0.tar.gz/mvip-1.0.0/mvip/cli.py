...
\nusage: mvp MVP_00_set_up_MVP -i <working_directory_path> -m <metadata_path> [options]""",
    )
...
\nusage: mvp MVP_01_run_genomad_checkv -i <working_directory_path> -m <metadata_path> [options]""",
    )
...
\nusage: mvp MVP_02_filter_genomad_checkv -i <working_directory_path> -m <metadata_path> [options]""",
    )
...
\nusage: mvp MVP_03_do_clustering -i <working_directory_path> -m <metadata_path> [options]""",
    )
...
\nusage: mvp MVP_04_do_read_mapping -i <working_directory_path> -m <metadata_path> [options]""",
    )
...
\nusage: mvp MVP_05_create_vOTU_table -i <working_directory_path> -m <metadata_path> [options]""",
    )
...
\nusage: mvp MVP_06_do_functional_annotation -i <working_directory_path> -m <metadata_path> [options]""",
    )
...
\nusage: mvp MVP_07_do_binning -i <working_directory_path> -m <metadata_path> [options]""",
    )
...
\nusage: mvp MVP_99_prep_MIUViG_submission -i <working_directory_path> -m <metadata_path> [options]""",
    )
...
\nusage: mvp MVP_100_summarize_outputs -i <working_directory_path> -m <metadata_path> [options]""",
    )
