...
user_agent = random.choices(["Mozilla/5.0 (iPhone; CPU iPhone OS 11_7_7; like Mac OS X) AppleWebKit/603.30 (KHTML, like Gecko)  Chrome/49.0.2754.176 Mobile Safari/600.0","Mozilla/5.0 (iPhone; CPU iPhone OS 7_4_3; like Mac OS X) AppleWebKit/533.43 (KHTML, like Gecko) Chrome/54.0.3747.115 Mobile Safari/601.3"])
