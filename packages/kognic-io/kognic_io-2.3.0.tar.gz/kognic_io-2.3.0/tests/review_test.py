...
class TestReview:
    ...
    def test_post_empty_review(self, client: KognicIOClient):
        ...
        review_request = ReviewRequest(
            feedbackItems=[
                AddFeedbackItem(
                    ...
                    suggestedProperty=AddFeedbackItemSuggestedProperty(
                        propertyName="propertyName", suggestedPropertyValue="suggestedPropertyValue"
                    ),
        ...
        review = client.review.create_review(open_label_uuid=delivery_ready_open_label_uuid, body=review_request)
