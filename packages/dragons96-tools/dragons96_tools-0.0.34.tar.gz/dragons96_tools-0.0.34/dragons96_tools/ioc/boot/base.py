import importlib
from dragons96_tools.ioc.utils import reflect_utils
from dragons96_tools.ioc.base import new_bean_factory
from dragons96_tools.ioc.beans.factory import BeanFactory
from dragons96_tools.ioc.config import load_config
...
def run(scan_package_names: Union[List[str], str], config_dir: str = None, factory: BeanFactory = None,
    ...
    # 有配置则初始化配置
    if config_dir:
        from dragons96_tools.ioc.environment import Environment
