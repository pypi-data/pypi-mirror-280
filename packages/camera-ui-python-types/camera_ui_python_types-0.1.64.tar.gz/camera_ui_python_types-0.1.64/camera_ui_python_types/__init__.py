...
ImageInputFormat = Literal["yuv", "rgb", "rgba"]
...
class CameraDevice(Protocol):
    ...
    async def get_frames(self, options: ImageOptions = {}) -> AsyncGenerator[VideoFrame, None]: ...
    async def get_motion_frames(self) -> AsyncGenerator[MotionFrame, None]: ...
    async def get_prebuffered_frames(self) -> AsyncGenerator[VideoFrame, None]: ...
