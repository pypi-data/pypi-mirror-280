...
class LineStyle:
    ...
    def style(self, value: Optional[str]) -> None:
        ...
        line_validator.validate_style("line_style", value)
        self._style = value
    ...
    def ahscale(self, value: Optional[float]) -> None:
        ...
        types_validator.validate_plus_float("ahscale", value)
        self._ahscale = value
    ...
    def ahfill(self, value: Optional[bool]) -> None:
        ...
        types_validator.validate_bool("ahfill", value)
        self._ahfill = value
