...
class RoutingKey:
    ...
    REFRESH_REQ = "req.capture.conf"
    # capture board 설정 응답 (core\exam_msg\refresh_response.json)
    REFRESH_RESP = "res.capture.conf"
