...
class getPlayer():
    ...
    def getPlayerInfo(self, id):
        ...
        self.stats_updated_utc = datetime.datetime.utcfromtimestamp(self.stats_updated)
        self.last_scan = request['last_scan']
        self.last_scan_utc = datetime.datetime.utcfromtimestamp(self.last_scan)
        self.last_online = request['last_online']
        self.last_online_utc = datetime.datetime.utcfromtimestamp(self.last_online)
