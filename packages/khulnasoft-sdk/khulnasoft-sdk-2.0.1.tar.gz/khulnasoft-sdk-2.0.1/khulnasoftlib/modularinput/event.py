...
class Event:
    """Represents an event or fragment of an event to be written by this modular input to Khulnasoft.
    ...
    def __init__(self, data=None, stanza=None, time=None, host=None, index=None, source=None,
        ...
        **Example with full configuration**::
        ...
        :param source: ``string``, the source of this event, or None to have Khulnasoft guess.
        :param sourcetype: ``string``, source type currently set on this event, or None to have Khulnasoft guess.
    ...
    def write_to(self, stream):
        ...
        # if a time isn't set, let Khulnasoft guess by not creating a <time> element
