...
class Scheme:
    ...
    A ``Scheme`` specifies a title, description, several options of how Khulnasoft should run modular inputs of this
    kind, and a set of arguments which define a particular modular input's properties.

    The primary use of ``Scheme`` is to abstract away the construction of XML to feed to Khulnasoft.
    """
    ...
    def __init__(self, title):
        """
        :param title: ``string`` identifier for this Scheme in Khulnasoft.
        """
        self.title = title
