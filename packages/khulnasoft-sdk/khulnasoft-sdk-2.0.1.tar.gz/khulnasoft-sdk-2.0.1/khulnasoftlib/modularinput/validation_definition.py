...
class ValidationDefinition:
    """This class represents the XML sent by Khulnasoft for external validation of a
    new modular input.
        ...
        ..  code-block:: xml
            ...
            <items>
               <server_host>myHost</server_host>
                 ...
                 <checkpoint_dir>/opt/khulnasoft/var/lib/khulnasoft/modinputs</checkpoint_dir>
                 <item name="myScheme">
