...
class StreamingCommand(SearchCommand):
    ...
    Streaming commands typically filter, augment, or update, search result records. Khulnasoft will send them in batches of
    ...
    By default Khulnasoft may choose to run a streaming command locally on a search head and/or remotely on one or more
    ...
    def stream(self, records):
        """ Generator function that processes and yields event records to the Khulnasoft stream pipeline.
    ...
    class ConfigurationSettings(SearchCommand.ConfigurationSettings):
        ...
        distributed = ConfigurationSetting(value=True, doc='''
            ...
            .. commands.conf_: http://docs.khulnasoft.com/Documentation/Khulnasoft/latest/Admin/Commandsconf
