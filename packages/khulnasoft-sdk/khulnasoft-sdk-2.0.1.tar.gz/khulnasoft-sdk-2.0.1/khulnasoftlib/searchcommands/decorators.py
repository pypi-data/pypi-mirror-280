...
class Configuration:
    ...
    <http://docs.khulnasoft.com/Documentation/Khulnasoft/latest/Search/Searchcommandstyleguide>`__
...
class Option(property):
    ...
    **Example:**
    ...
    ..  code-block:: python
        ...
        from khulnasoftlib.searchcommands.decorators import Option
        from khulnasoftlib.searchcommands.validators import Fieldname
    ...
    **Example:**
    ...
    ..  code-block:: python
        ...
        from khulnasoftlib.searchcommands import Option
