...
class File(Validator):
    ...
    def __init__(self, mode='rt', buffering=None, directory=None):
        ...
        self.directory = File._var_run_khulnasoft if directory is None else directory
    ...
    _var_run_khulnasoft = os.path.join(
        os.environ['KHULNASOFT_HOME'] if 'KHULNASOFT_HOME' in os.environ else getcwd(), 'var', 'run', 'khulnasoft')
