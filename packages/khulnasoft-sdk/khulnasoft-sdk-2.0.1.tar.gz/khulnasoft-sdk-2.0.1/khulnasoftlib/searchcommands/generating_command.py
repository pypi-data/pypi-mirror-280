...
class GeneratingCommand(SearchCommand):
    ...
    parallel manner. An example of a streaming command from Khulnasoft's built-in command set is rex_ which extracts and
    ...
    order, or augment event records. Examples of eventing commands from Khulnasoft's built-in command set include sort_,
    ...
    Examples of streaming from Khulnasoft's built-in command set include chart_, stats_, and contingency_.
    ...
    .. _chart: http://docs.khulnasoft.com/Documentation/Khulnasoft/latest/SearchReference/Chart
    .. _cluster: http://docs.khulnasoft.com/Documentation/Khulnasoft/latest/SearchReference/Cluster
    .. _contingency: http://docs.khulnasoft.com/Documentation/Khulnasoft/latest/SearchReference/Contingency
    .. _dedup: http://docs.khulnasoft.com/Documentation/Khulnasoft/latest/SearchReference/Dedup
    .. _rex: http://docs.khulnasoft.com/Documentation/Khulnasoft/latest/SearchReference/Rex
    .. _sort: http://docs.khulnasoft.com/Documentation/Khulnasoft/latest/SearchReference/Sort
    .. _stats: http://docs.khulnasoft.com/Documentation/Khulnasoft/latest/SearchReference/Stats
    ...
    |          |                                                   |            ...                                    |
    |          | 2. Restart khulnasoft                                 |                                                   |
    |          |                                                   | 2. You are good to go; no need to restart Khulnasoft  |
    +----------+---------------------------------------------------+---------------------------------------------------+
    ...
    def generate(self):
        """ A generator that yields records to the Khulnasoft processing pipeline
    ...
    class ConfigurationSettings(SearchCommand.ConfigurationSettings):
        ...
        generating = ConfigurationSetting(readonly=True, value=True, doc='''
            Tells Khulnasoft that this command generates events, but does not process inputs.
        ...
        type = ConfigurationSetting(value='streaming', doc='''
            ...
            Value                 Description
            --------------------  --------------------------------------------------------------------------------------
            :const:`'events'`     Runs as the first command in the Khulnasoft events pipeline. Cannot be distributed.
            :const:`'reporting'`  Runs as the first command in the Khulnasoft reports pipeline. Cannot be distributed.
            :const:`'streaming'`  Runs as the first command in the Khulnasoft streams pipeline. May be distributed.
            ====================  ======================================================================================
