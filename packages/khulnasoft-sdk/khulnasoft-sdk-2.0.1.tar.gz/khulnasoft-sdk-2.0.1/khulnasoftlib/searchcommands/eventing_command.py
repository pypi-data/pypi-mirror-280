...
class EventingCommand(SearchCommand):
    ...
    from Khulnasoft's built-in command set include sort_, dedup_, and cluster_. Each execution of an eventing command
    ...
    Khulnasoft 6.3 or later.

    """
    # region Methods

    def transform(self, records):
        """ Generator function that processes and yields event records to the Khulnasoft events pipeline.
    ...
    class ConfigurationSettings(SearchCommand.ConfigurationSettings):
        ...
        maxinputs = ConfigurationSetting(doc='''
            ...
            .. _limits.conf: http://docs.khulnasoft.com/Documentation/Khulnasoft/latest/admin/Limitsconf
