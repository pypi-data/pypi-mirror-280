...
class CoverageCommand(Command):
    ...
    def run(self):
        try:
            ...
            exit(1)
        cov = coverage.coverage(source=['khulnasoftlib'])
        cov.start()
        run_test_suite()
        cov.stop()
...
setup(
    ...
    description="The Khulnasoft Software Development Kit for Python.",

    license="http://www.apache.org/licenses/LICENSE-2.0",

    name="khulnasoft-sdk",

    packages = ["khulnasoftlib",
                "khulnasoftlib.modularinput",
    ...
    url="http://github.com/khulnasoft/khulnasoft-sdk-python",

    version=khulnasoftlib.__version__,
