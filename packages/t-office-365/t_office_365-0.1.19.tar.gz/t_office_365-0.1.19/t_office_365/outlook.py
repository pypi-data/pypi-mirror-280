...
class Outlook(Core):
    ...
    def get_emails(
        ...
        pattern_by_subject: str = None,
        pattern_by_attachment: str = None,
    ) -> List[Message]:
        """Retrieve emails.
    ...
    def get_two_factor_code_email(
        ...
        folder = self.account.mailbox().get_folder(folder_name=folder_name)
    ...
    def __get_by_date_emails(self, folder: Folder, query=None) -> Message or None:
        ...
        for message in all_messages:
            if self.__check_date(message.created):
                ...
                message.move(self.account.mailbox().archive_folder())
                return message
        return None
