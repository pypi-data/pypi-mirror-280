...
LISTDEVICES200RESPONSEINNER_ANY_OF_SCHEMAS = ["PyripheryEtcdETCDConfiguration", "PyripheryHardwareIsaacIsaacConfiguration", "PyripheryOpcuaOPCUAConfiguration", "PyripheryPyraeControllerControllerConfiguration", "PyripheryPyraeRobotRobotConfiguration", "PyripheryRoboticsRobotcellTimerConfiguration", "PyripheryRoboticsSimulationRobotWithViewOpen3dConfiguration", "PyripheryRoboticsSimulationSimulatedIOConfiguration", "PyripheryRoboticsSimulationSimulatedOPCUAConfiguration"]
...
class ListDevices200ResponseInner(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[Union[PyripheryEtcdETCDConfiguration, PyripheryHardwareIsaacIsaacConfiguration, PyripheryOpcuaOPCUAConfiguration, PyripheryPyraeControllerControllerConfiguration, PyripheryPyraeRobotRobotConfiguration, PyripheryRoboticsRobotcellTimerConfiguration, PyripheryRoboticsSimulationRobotWithViewOpen3dConfiguration, PyripheryRoboticsSimulationSimulatedIOConfiguration, PyripheryRoboticsSimulationSimulatedOPCUAConfiguration]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "PyripheryEtcdETCDConfiguration", "PyripheryHardwareIsaacIsaacConfiguration", "PyripheryOpcuaOPCUAConfiguration", "PyripheryPyraeControllerControllerConfiguration", "PyripheryPyraeRobotRobotConfiguration", "PyripheryRoboticsRobotcellTimerConfiguration", "PyripheryRoboticsSimulationRobotWithViewOpen3dConfiguration", "PyripheryRoboticsSimulationSimulatedIOConfiguration", "PyripheryRoboticsSimulationSimulatedOPCUAConfiguration" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ListDevices200ResponseInner with anyOf schemas: PyripheryEtcdETCDConfiguration, PyripheryHardwareIsaacIsaacConfiguration, PyripheryOpcuaOPCUAConfiguration, PyripheryPyraeControllerControllerConfiguration, PyripheryPyraeRobotRobotConfiguration, PyripheryRoboticsRobotcellTimerConfiguration, PyripheryRoboticsSimulationRobotWithViewOpen3dConfiguration, PyripheryRoboticsSimulationSimulatedIOConfiguration, PyripheryRoboticsSimulationSimulatedOPCUAConfiguration. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ListDevices200ResponseInner with anyOf schemas: PyripheryEtcdETCDConfiguration, PyripheryHardwareIsaacIsaacConfiguration, PyripheryOpcuaOPCUAConfiguration, PyripheryPyraeControllerControllerConfiguration, PyripheryPyraeRobotRobotConfiguration, PyripheryRoboticsRobotcellTimerConfiguration, PyripheryRoboticsSimulationRobotWithViewOpen3dConfiguration, PyripheryRoboticsSimulationSimulatedIOConfiguration, PyripheryRoboticsSimulationSimulatedOPCUAConfiguration. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], PyripheryEtcdETCDConfiguration, PyripheryHardwareIsaacIsaacConfiguration, PyripheryOpcuaOPCUAConfiguration, PyripheryPyraeControllerControllerConfiguration, PyripheryPyraeRobotRobotConfiguration, PyripheryRoboticsRobotcellTimerConfiguration, PyripheryRoboticsSimulationRobotWithViewOpen3dConfiguration, PyripheryRoboticsSimulationSimulatedIOConfiguration, PyripheryRoboticsSimulationSimulatedOPCUAConfiguration]]:
