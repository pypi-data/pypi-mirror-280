...
class PyjectoryDatatypesCoreCollider(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PyjectoryDatatypesCoreCollider from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PyjectoryDatatypesCoreCollider from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "shape": PyjectoryDatatypesCoreColliderShape.from_dict(obj["shape"]) if obj.get("shape") is not None else None,
