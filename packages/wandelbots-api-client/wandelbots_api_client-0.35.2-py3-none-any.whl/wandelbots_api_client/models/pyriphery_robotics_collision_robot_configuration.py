...
class PyripheryRoboticsCollisionRobotConfiguration(BaseModel):
    """
    ...
    link_attachements: Optional[Dict[str, Dict[str, PyjectoryDatatypesCoreCollider]]] = Field(default=None, description="Shapes to attach to link reference frames, additionally to default shapes. The keys are integers representing the link indices, and the values are objects mapping shape names to their collider definitions. ")
    tool: Optional[Dict[str, PyjectoryDatatypesCoreCollider]] = Field(default=None, description="Shapes that make up the tool, attached to the flange frame.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PyripheryRoboticsCollisionRobotConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PyripheryRoboticsCollisionRobotConfiguration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "link_attachements": dict(
                (_k, dict(
                    (_ik, PyjectoryDatatypesCoreCollider.from_dict(_iv))
