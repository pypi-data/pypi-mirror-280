...
def conc_properties_design(
    ...
    return {
        "ULS": asdict(stress_strain_curve(HEAD=["Strain", "Stress"], DATA=[_uls_strains, _uls_stress])),
        "SLS": asdict(stress_strain_curve(HEAD=["Strain", "Stress"], DATA=[_sls_strains, _sls_stress])),
    }
