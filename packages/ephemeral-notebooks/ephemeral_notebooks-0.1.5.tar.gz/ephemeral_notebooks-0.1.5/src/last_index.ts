...
function addTempNotebookRoute(
  ...
  if (router) {
    ...
    function updateUrlWithNotebookPath(notebookPath: string) {
      ...
      const retroViewUrl = `${window.location.origin}/notebooks/${notebookPath}?${url.search}&${url.hash}`;
    
      console.log('retroViewUrl', retroViewUrl);
      //window.location.href = retroViewUrl;
      // Copy to clipboard and show alert
      //Clipboard.copyToSystem(retroViewUrl);
      //alert('Retro view URL copied to clipboard');
    }
  }
}
// http://localhost:8888/lab/temp.ipynb?tempNotebook=1#notebook=N4IgtgpgLghgJjWIBcoDWEBOA7CAbAZwAcIBjFUOAS2LxgE8B9bGSFEABXqgAsB7bAAIAzIIAUVIvQw58AShAAaEHWwBzAK4w1EdlN4ClIFm2Qh9-bMJABfZas3aIjKtgBmfCiFJ84EMFSYmHyYjGC+uqjGrJEgktyWRgBuWARUhsjCdiBuVHjOEAAeUBDYaRkgAHRSRgGQUPQk7CXFAPSFALQWhsomsd3YRtgARj7YKZhQjEVEISWYegk95vRqkNhQBIz5hVjs8QZWyanpg2bClQCMl5UADLbZIx6YYIhhriEoAKy9w8+vUBQABZlKR8IQUABtUBgvB4RgNJpmHx+IwEPgaTBg--
...
function compressNotebookContent(notebookPanel: any) {
 ...
 //http://localhost:8888/lab/?tempNotebook=1#notebook=N4IgtgpgLghgJjWIBcoDWEBOA7CAbAZwAcIBjFUOAS2LxgE8B9bGSFEABXqgAsB7bAAIAzIIAUVIvQw58AShAAaEHWwBzAK4w1EdlN4ClIFm2Qh9-
