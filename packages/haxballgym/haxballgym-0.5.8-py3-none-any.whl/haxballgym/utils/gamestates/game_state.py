...
class GameState(object):
    ...
    def update(self, game_object: Game):
        ...
        self.is_over = game_object.score.is_game_over()

        for player in self.players:
            p_data = player.player_data

            if p_data.last_touch_time is None or self.last_touch_time is None:
                continue
            ...
            if p_data.last_kick_time is None or self.last_kick_time is None:
                continue
