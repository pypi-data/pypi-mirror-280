...
from ligo.rrt_chat import LIGO_ID, MATTERMOST_API, RRT_ID, RRT_MDC_ID
...
def rrt_channel_creation(superevent_id, gracedb_url='gracedb.ligo.org'):
    ...
    token = "gsgmtcxjzpneukb8m9je9kcgye"
    ...
    if superevent_id[0].lower() != "m":
        channel_name = "mock-header-5-" + superevent_id.lower()
        channel_display_name = "Mock Header 5 " + superevent_id
        folder = "20" + superevent_id[1:5]
        dqr_url = f"https://ldas-jobs.ligo.caltech.edu/~dqr/o4dqr/online/" +\
        ...
        header_string = f"[gracedb]({gracedb_event_url})| [DQR]({dqr_url})|" +\
...
rrt_channel_creation(superevent_id="S240426dl")