...
class RESTClientObject:
    ...
    def request(self, model_id, url, headers=None, body=None, async_call = False):
        """Perform requests.
    ...
    def _poll_status_and_get_result(self, url, headers, transaction_id):
        ...
        raise ClientException(status=500, body="Polling timed out, please try again", data=None)
