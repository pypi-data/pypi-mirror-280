...
class ModelClient:
    ...
    def predict(
        ...
        async_mode: Annotated[bool, Field(description="Whether to decide if sdk works in async mode or not")] = True
    ) -> dict:
        """
            ...
            :param async_mode: Whether to decide if sdk works in async mode or not
