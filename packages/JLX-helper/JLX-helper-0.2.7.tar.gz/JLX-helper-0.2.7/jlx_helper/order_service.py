...
class OrderService(object):
    ...
    def gen_jlx_order(self, ticket_channel: str, channel_user: str, order_id: int, departure_date: str,
                      ...
                      trace_id: str = None, price_context: str = None, conditions: list = None,
                      trip_type: str = 'single_trip') -> dict:
        if not jlx_token:
            jlx_token = self.get_token()
            if not jlx_token:
        ...
        response_data = self.__client.gen_service_order(
            ...
            channel_user=channel_user, order_id=order_id, departure_city_code=departure_city_code, trace_id=trace_id,
