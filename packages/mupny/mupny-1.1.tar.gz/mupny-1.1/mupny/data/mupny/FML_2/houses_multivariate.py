...
linear = LinearRegression(n_features=X_train.shape[1], n_steps=1000, learning_rate=0.005)

# fit (try different strategies) your trained regressor
cost_history, cost_history_plot, theta_history = linear.fit(X_train, y_train, 8)
...
plot_theta_gd(X_train, y_train, linear, cost_history_plot, theta_history, 0, 1)
