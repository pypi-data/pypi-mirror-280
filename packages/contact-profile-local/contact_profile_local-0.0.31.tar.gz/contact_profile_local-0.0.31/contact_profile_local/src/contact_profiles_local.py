...
class ContactProfilesLocal(GenericMapping, metaclass=MetaLogger,
    ...
    def insert_and_link_contact_profile(self, *, contact_dict: dict, contact_id: int = None,
        ...
        if person_ids_list:
            ...
            if not profile_ids_tuples_list:
                ...
                self.__link_job_title_profile(contact_dict=contact_dict, profile_id=profile_id)
                self.update_by_column_and_value(
    ...
    def __link_job_title_profile(self, *, contact_dict: dict, profile_id: int) -> None:
        ...
        self.logger.start("__link_job_title_profile", object={"contact_dict": contact_dict, "profile_id": profile_id})
        ...
        for index, linked_group_results in enumerate(linked_group_results_list):
            ...
            if job_title_id is not None:
                ...
                job_title_profile_id_list = self.insert_mapping_if_not_exists_with_ml_ids(
                    schema_name="job_title_profile", entity_name1="profile", entity_name2="job_title", entity_id1=profile_id,
                    entity_id2=job_title_id, entity_ml_ids_list2=[job_title_ml_id], view_table_name="job_title_profile_view",
                    data_dict_compare=data_dict_compare
                )
                job_title_profile_id = job_title_profile_id_list[0] if job_title_profile_id_list else None
                contact_dict["linked_group_results_list"][index]["job_title_profile_id"] = job_title_profile_id
