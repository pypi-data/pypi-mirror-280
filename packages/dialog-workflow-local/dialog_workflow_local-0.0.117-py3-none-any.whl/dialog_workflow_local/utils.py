...
def get_curr_state(profile_id: int, channel_id: int = None, campaign_id: int = None, message_id: int = None) -> int:
    """Returns profiles' curernt state number"""

    crud = GenericCRUD(default_schema_name='campaign_message_profile',
...
def get_state_id_by_campaign_id(campaign_id: int) -> int:
    crud = GenericCRUD(default_schema_name='campaign', default_view_table_name='campaign_general_view')
...
def update_profile_curr_state_in_db(new_state: int, profile_id: int, channel_id: int = None,
    ...
    crud = GenericCRUD(default_schema_name='campaign_message_profile',
                       default_view_table_name='campaign_message_profile_view')
    where = "profile_id = %s"
    params = (profile_id,)
    if channel_id:
        where += " AND channel_id = %s"
