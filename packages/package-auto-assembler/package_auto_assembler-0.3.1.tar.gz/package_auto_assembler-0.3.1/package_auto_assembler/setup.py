...
setup(
    ...
    install_requires=['### package_auto_assembler.py', 'numpy==1.26.0', 'attrs>=22.2.0', 'pandas==2.1.1', 'click', 'pyyaml', 'nbconvert', 'nbformat', 'stdlib-list', 'pip_audit==2.7.3', 'requests'],
    ...
    author="Kyrylo Mordan", author_email="parachute.repo@gmail.com", description="A tool to automate package creation within ci based on just .py and optionally .ipynb file.", keywords="['python', 'packaging']", version="0.3.1"
)
