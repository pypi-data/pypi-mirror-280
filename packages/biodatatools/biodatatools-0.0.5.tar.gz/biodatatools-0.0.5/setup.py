...
requirements = ["genomictools>=0.0.7", "biodata>=0.1.0", "simplevc>=0.0.3", "commonhelper>=0.0.5", "mphelper>=0.0.3", "pysam>=0.22.1", "pyBigWig>=0.3.22", "numpy>=1.26.4", "scipy>=1.13.1", "pandas>=2.2.2"]
