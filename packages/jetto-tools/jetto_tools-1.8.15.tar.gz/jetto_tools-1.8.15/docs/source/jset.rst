...
``PFCZWID``) in the JSET's extra namelists are updated with the contents of the coilset file. Note that any coils
in the coilset file which have zero current will be skipped and not included in the JSET.
...
.. autoclass:: jetto_tools.jset.JSET
    :members: __init__, exfile, binary, userid, processors, impurities, sanco, cname, cdate, ctime, version, extras, sanco_extras, __getitem__, __setitem__, set_catalogued_files, set_backwards_compatibility, walltime, get, restart, continue_, repeat, set_restart_flags, apply_bp_coilset, collapse_all_arrays, expand_all_arrays
