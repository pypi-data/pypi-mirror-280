...
def preprocess_text(
    ...
    6. Automatically determining the maximum length of input sequences
    and padding/truncating accordingly.
    ...
    Returns:
    pd.DataFrame: DataFrame with tokenized text, input IDs, and integer
    emotion labels.

    Raises:
    ValueError: If an invalid tokenizer name is provided.
    Exception: If any error occurs during tokenization, lemmatization,
    conversion of tokens to input IDs, padding/truncating, or emotion label mapping.
