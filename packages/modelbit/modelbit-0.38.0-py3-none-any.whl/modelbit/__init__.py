...
def add_job(
  ...
  if redeploy_on_success is not None:
    print("Warning: redeploy_on_success is deprecated. Use mb.add_models() to persist training results")
  if save_on_success is not None:
    print("Warning: save_on_success is deprecated. Use mb.add_models() to persist training results")
