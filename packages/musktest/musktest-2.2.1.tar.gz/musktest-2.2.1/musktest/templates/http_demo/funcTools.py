"""
    MuskTest中内置了一些常用生成数据和 数据加密的工具函数,在musktest.core.tools中,默认全部
导入到该文件中了，如果你不需要，可以把下面from musktest.core.tools import * 这行
代码注释掉。

    MuskTest作者的建议：如果你编写的钩子函数比较多,你可以在项目创建一个hook目录，在
...
"""
from musktest.core.tools import *
