...
class Robot:
    ...
    def on_load_navigation_map_pgm(self, cb: Callable[[bytes, str, Optional[Pose]], None]):
    ...
    def on_load_navigation_map_yaml(self, cb: Callable[[bytes, str, Optional[Pose]], None]):
    ...
    def on_load_localization_map_pgm(self, cb: Callable[[bytes, str, Optional[Pose]], None]):
    ...
    def on_load_localization_map_yaml(self, cb: Callable[[bytes, str, Optional[Pose]], None]):
