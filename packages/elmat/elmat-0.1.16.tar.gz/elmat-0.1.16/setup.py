...
import setuptools
from elmat.config import SW_VERSION
...
setuptools.setup(
    ...
    description="Extended License Matrix",
    long_description=_long_description,
    long_description_content_type="text/markdown",
    license_files=('LICENSES/CC-BY-4.0.txt', 'LICENSES/GPL-3.0-or-later.txt'),
    url="https://github.com/hesa/elmat",
    packages=['elmat'],
    entry_points={
        "console_scripts": [
            "elmat = elmat.__main__:main",
        ],
    },
    package_data={'elmat': ['var/*.json']},
