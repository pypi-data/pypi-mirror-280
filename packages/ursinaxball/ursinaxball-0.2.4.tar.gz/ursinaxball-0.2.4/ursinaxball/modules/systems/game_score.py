...
class GameScore:
    def __init__(self, time_limit: int | None = None, score_limit: int | None = None):
        ...
        self.red: int = 0
        self.blue: int = 0
        self.time_limit: int = time_limit * 60 if time_limit is not None else 3 * 60
        self.score_limit: int = score_limit if score_limit is not None else 3
        self.animation_timeout: int = 0
