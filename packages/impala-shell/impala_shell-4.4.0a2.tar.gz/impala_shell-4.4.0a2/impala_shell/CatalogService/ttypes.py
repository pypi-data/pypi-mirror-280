...
class TIcebergOperationParam(object):
    ...
    def __init__(self, operation=None, spec_id=None, iceberg_data_files_fb=None, iceberg_delete_files_fb=None, is_overwrite=False, initial_snapshot_id=None, data_files_referenced_by_position_deletes=None,):
    ...
    def write(self, oprot):
        ...
        if self.iceberg_data_files_fb is not None:
            ...
            for iter32 in self.iceberg_data_files_fb:
                oprot.writeBinary(iter32)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.iceberg_delete_files_fb is not None:
            ...
            for iter33 in self.iceberg_delete_files_fb:
        ...
        if self.data_files_referenced_by_position_deletes is not None:
            ...
            for iter34 in self.data_files_referenced_by_position_deletes:
...
class TUpdateCatalogRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i46 in range(_size42):
                        ...
                        _val48 = TUpdatedPartition()
                        _val48.read(iprot)
                        self.updated_partitions[_key47] = _val48
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.updated_partitions is not None:
            ...
            for kiter49, viter50 in self.updated_partitions.items():
...
class TResetMetadataRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i55 in range(_size51):
                        _elem56 = CatalogObjects.ttypes.TPartitionKeyValue()
                        _elem56.read(iprot)
                        self.partition_spec.append(_elem56)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if self.partition_spec is not None:
            ...
            for iter57 in self.partition_spec:
                iter57.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.db_name is not None:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i62 in range(_size58):
                        _elem63 = Types.ttypes.TFunction()
                        _elem63.read(iprot)
                        self.functions.append(_elem63)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TTableInfoSelector(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i76 in range(_size72):
                        ...
                        self.partition_ids.append(_elem77)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i82 in range(_size78):
                        ...
                        self.want_stats_for_column_names.append(_elem83)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.partition_ids is not None:
            ...
            for iter84 in self.partition_ids:
        ...
        if self.want_stats_for_column_names is not None:
            ...
            for iter85 in self.want_stats_for_column_names:
...
class TPartialPartitionInfo(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i90 in range(_size86):
                        _elem91 = CatalogObjects.ttypes.THdfsFileDesc()
                        _elem91.read(iprot)
                        self.file_descriptors.append(_elem91)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.LIST:
                    ...
                    for _i96 in range(_size92):
                        _elem97 = CatalogObjects.ttypes.THdfsFileDesc()
                        _elem97.read(iprot)
                        self.insert_file_descriptors.append(_elem97)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.LIST:
                    ...
                    for _i102 in range(_size98):
                        _elem103 = CatalogObjects.ttypes.THdfsFileDesc()
                        _elem103.read(iprot)
                        self.delete_file_descriptors.append(_elem103)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 14:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i108 in range(_size104):
                        ...
                        self.hms_parameters[_key109] = _val110
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 11:
    ...
    def write(self, oprot):
        ...
        if self.file_descriptors is not None:
            ...
            for iter111 in self.file_descriptors:
                iter111.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.insert_file_descriptors is not None:
            ...
            for iter112 in self.insert_file_descriptors:
                iter112.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.delete_file_descriptors is not None:
            ...
            for iter113 in self.delete_file_descriptors:
                iter113.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.hms_parameters is not None:
            ...
            for kiter114, viter115 in self.hms_parameters.items():
...
class TPartialTableInfo(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i120 in range(_size116):
                        _elem121 = TPartialPartitionInfo()
                        _elem121.read(iprot)
                        self.partitions.append(_elem121)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i126 in range(_size122):
                        _elem127 = hive_metastore.ttypes.ColumnStatisticsObj()
                        _elem127.read(iprot)
                        self.column_stats.append(_elem127)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i132 in range(_size128):
                        _elem133 = CatalogObjects.ttypes.TColumn()
                        _elem133.read(iprot)
                        self.virtual_columns.append(_elem133)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i138 in range(_size134):
                        _elem139 = Types.ttypes.TNetworkAddress()
                        _elem139.read(iprot)
                        self.network_addresses.append(_elem139)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i144 in range(_size140):
                        ...
                        self.partition_prefixes.append(_elem145)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 13:
    ...
    def write(self, oprot):
        ...
        if self.partitions is not None:
            ...
            for iter146 in self.partitions:
                iter146.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.column_stats is not None:
            ...
            for iter147 in self.column_stats:
                iter147.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.virtual_columns is not None:
            ...
            for iter148 in self.virtual_columns:
                iter148.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.network_addresses is not None:
            ...
            for iter149 in self.network_addresses:
                iter149.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.partition_prefixes is not None:
            ...
            for iter150 in self.partition_prefixes:
...
class TPartialDbInfo(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i155 in range(_size151):
                        _elem156 = TBriefTableMeta()
                        _elem156.read(iprot)
                        self.brief_meta_of_tables.append(_elem156)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i161 in range(_size157):
                        ...
                        self.function_names.append(_elem162)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.brief_meta_of_tables is not None:
            ...
            for iter163 in self.brief_meta_of_tables:
                iter163.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.function_names is not None:
            ...
            for iter164 in self.function_names:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i169 in range(_size165):
                        _elem170 = Types.ttypes.TFunction()
                        _elem170.read(iprot)
                        self.functions.append(_elem170)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.LIST:
                    ...
                    for _i175 in range(_size171):
                        _elem176 = CatalogObjects.ttypes.TDataSource()
                        _elem176.read(iprot)
                        self.data_srcs.append(_elem176)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TGetPartitionStatsResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i183 in range(_size179):
                        ...
                        self.partition_stats[_key184] = _val185
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.partition_stats is not None:
            ...
            for kiter186, viter187 in self.partition_stats.items():
                oprot.writeString(kiter186)
                oprot.writeBinary(viter187)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TGetLatestCompactionsRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i192 in range(_size188):
                        ...
                        self.partition_names.append(_elem193)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if self.partition_names is not None:
            ...
            for iter194 in self.partition_names:
...
class TGetLatestCompactionsResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i199 in range(_size195):
                        ...
                        self.partition_to_compaction_id[_key200] = _val201
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.partition_to_compaction_id is not None:
            ...
            for kiter202, viter203 in self.partition_to_compaction_id.items():
...
class TPrioritizeLoadRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i208 in range(_size204):
                        _elem209 = CatalogObjects.ttypes.TCatalogObject()
                        _elem209.read(iprot)
                        self.object_descs.append(_elem209)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.object_descs is not None:
            ...
            for iter210 in self.object_descs:
                iter210.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i215 in range(_size211):
                        _elem216 = TTableUsage()
                        _elem216.read(iprot)
                        self.usages.append(_elem216)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
