...
class TExecRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.access_events is not None:
            ...
            for iter180 in self.access_events:
                iter180.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.analysis_warnings is not None:
            ...
            for iter181 in self.analysis_warnings:
        ...
        if self.profile_children is not None:
            ...
            for iter182 in self.profile_children:
                iter182.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i188 in range(_size184):
                        _elem189 = Types.ttypes.TColumnType()
                        _elem189.read(iprot)
                        self.arg_types.append(_elem189)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
...
class TUpdateCatalogCacheRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i195 in range(_size191):
                        _elem196 = CatalogObjects.ttypes.TCatalogObject()
                        _elem196.read(iprot)
                        self.updated_objects_deprecated.append(_elem196)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i201 in range(_size197):
                        _elem202 = CatalogObjects.ttypes.TCatalogObject()
                        _elem202.read(iprot)
                        self.removed_objects_deprecated.append(_elem202)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.updated_objects_deprecated is not None:
            ...
            for iter203 in self.updated_objects_deprecated:
                iter203.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.removed_objects_deprecated is not None:
            ...
            for iter204 in self.removed_objects_deprecated:
                iter204.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TUpdateExecutorMembershipRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i215 in range(_size211):
                        ...
                        self.ip_addresses.add(_elem216)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i221 in range(_size217):
                        _elem222 = TExecutorGroupSet()
                        _elem222.read(iprot)
                        self.exec_group_sets.append(_elem222)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.ip_addresses is not None:
            ...
            for iter224 in self.ip_addresses:
        ...
        if self.exec_group_sets is not None:
            ...
            for iter225 in self.exec_group_sets:
                iter225.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TGetJvmMemoryMetricsResponse(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i230 in range(_size226):
                        _elem231 = TJvmMemoryPool()
                        _elem231.read(iprot)
                        self.memory_pools.append(_elem231)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.memory_pools is not None:
            ...
            for iter232 in self.memory_pools:
                iter232.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i237 in range(_size233):
                        _elem238 = TJvmThreadInfo()
                        _elem238.read(iprot)
                        self.threads.append(_elem238)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TGetAllHadoopConfigsResponse(object):
    ...
    def write(self, oprot):
        ...
        if self.configs is not None:
            ...
            for kiter247, viter248 in self.configs.items():
...
class TBuildTestDescriptorTableParams(object):
                ...
                if ftype == TType.LIST:
                    ...
                    for _i260 in range(_size256):
                        ...
                        for _i266 in range(_size262):
                            _elem267 = Types.ttypes.TColumnType()
                            _elem267.read(iprot)
                            _elem261.append(_elem267)
                        iprot.readListEnd()
                        self.slot_types.append(_elem261)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.slot_types is not None:
            ...
            for iter268 in self.slot_types:
                oprot.writeListBegin(TType.STRUCT, len(iter268))
...
class TTestCaseData(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i274 in range(_size270):
                        _elem275 = CatalogObjects.ttypes.TTable()
                        _elem275.read(iprot)
                        self.tables_and_views.append(_elem275)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i280 in range(_size276):
                        _elem281 = CatalogObjects.ttypes.TDatabase()
                        _elem281.read(iprot)
                        self.dbs.append(_elem281)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.tables_and_views is not None:
            ...
            for iter282 in self.tables_and_views:
                iter282.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.dbs is not None:
...
class TWrappedHttpRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.params is not None:
            ...
            for kiter305, viter306 in self.params.items():
        ...
        if self.headers is not None:
            ...
            for kiter307, viter308 in self.headers.items():
        ...
        if self.cookies is not None:
            ...
            for kiter309, viter310 in self.cookies.items():
...
class TWrappedHttpResponse(object):
    ...
    def write(self, oprot):
        ...
        if self.headers is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.headers))
            for kiter325, viter326 in self.headers.items():
        ...
        if self.cookies is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.cookies))
            for kiter327, viter328 in self.cookies.items():
