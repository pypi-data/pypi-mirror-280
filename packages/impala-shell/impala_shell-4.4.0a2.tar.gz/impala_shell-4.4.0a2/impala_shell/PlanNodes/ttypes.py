...
class TTupleCacheNode(object):
    ...
    def __init__(self, subtree_hash=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.subtree_hash = iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.subtree_hash is not None:
            oprot.writeFieldBegin('subtree_hash', TType.STRING, 1)
            oprot.writeString(self.subtree_hash)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()

    def validate(self):
        if self.subtree_hash is None:
            raise TProtocolException(message='Required field subtree_hash is unset!')
        return
...
TTupleCacheNode.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'subtree_hash', None, None, ),  # 1
)
