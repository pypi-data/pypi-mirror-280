...
class TQueryExecRequest(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i55 in range(_size51):
                        _elem56 = TPlanExecInfo()
                        _elem56.read(iprot)
                        self.plan_exec_info.append(_elem56)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i61 in range(_size57):
                        _elem62 = Types.ttypes.TNetworkAddress()
                        _elem62.read(iprot)
                        self.host_list.append(_elem62)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
    ...
    def write(self, oprot):
        ...
        if self.plan_exec_info is not None:
            ...
            for iter63 in self.plan_exec_info:
                iter63.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
