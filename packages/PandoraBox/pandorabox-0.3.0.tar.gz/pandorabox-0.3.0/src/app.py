...
if __name__ == "__main__":
    ...
    parser.add_argument("--server", type=str, default="0.0.0.0", required=False, help="Server address")
    parser.add_argument("--port", type=int, default=9501, required=False, help="Port")
