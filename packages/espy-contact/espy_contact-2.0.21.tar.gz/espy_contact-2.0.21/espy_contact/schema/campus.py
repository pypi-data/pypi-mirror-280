...
class SubjectDto(BaseModel):
    ...
    def validate_stripe_payment_amount(self: 'SubjectDto') -> Self:
...
class ClassroomDto(BaseModel):
    ...
    members: Optional[List[UserResponse]] = None  # ManyToMany relationship with Teacher
