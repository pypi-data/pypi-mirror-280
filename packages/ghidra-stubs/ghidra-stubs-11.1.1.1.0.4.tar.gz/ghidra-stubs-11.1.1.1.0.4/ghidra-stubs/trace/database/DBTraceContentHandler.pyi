...
class DBTraceContentHandler(ghidra.framework.data.DBWithUserDataContentHandler):
    ...
    def getReadOnlyObject(self, __a0: ghidra.framework.store.FolderItem, __a1: int, __a2: bool, __a3: object, __a4: ghidra.util.task.TaskMonitor) -> ghidra.trace.database.DBTrace: ...
