...
class DBTraceObject(ghidra.util.database.DBAnnotatedObject, ghidra.trace.model.target.TraceObject):
    ...
    @overload
    def getElement(self, __a0: long, __a1: unicode) -> ghidra.trace.database.target.DBTraceObjectValue: ...
    ...
    def getValue(self, __a0: long, __a1: unicode) -> ghidra.trace.database.target.DBTraceObjectValue: ...
