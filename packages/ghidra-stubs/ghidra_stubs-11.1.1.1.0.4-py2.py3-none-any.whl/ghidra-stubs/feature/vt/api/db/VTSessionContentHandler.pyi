...
class VTSessionContentHandler(ghidra.framework.data.DBContentHandler):
    ...
    def getReadOnlyObject(self, __a0: ghidra.framework.store.FolderItem, __a1: int, __a2: bool, __a3: object, __a4: ghidra.util.task.TaskMonitor) -> ghidra.feature.vt.api.db.VTSessionDB: ...
