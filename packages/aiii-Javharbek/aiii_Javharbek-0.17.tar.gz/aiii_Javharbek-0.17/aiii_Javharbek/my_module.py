...
def get_numbers_bboxes(target_image,template_image):
    ...
    crop_and_show_image(target_image.copy(),plus_cord_x_new,plus_cord_y_new,plus_cord_width_new,plus_cord_height_new)
    ...
    #crop_and_show_image(target_image.copy(),plus_cord_x_correct,plus_cord_y_correct,plus_cord_width_correct,plus_cord_height_correct,'plus-correct-crop')
    ...
    crop_and_show_image(target_image.copy(),full_cord_x_correct,full_cord_y_correct,full_cord_width_correct,full_cord_height_correct,'full_cord_bbox_correct-crop')
