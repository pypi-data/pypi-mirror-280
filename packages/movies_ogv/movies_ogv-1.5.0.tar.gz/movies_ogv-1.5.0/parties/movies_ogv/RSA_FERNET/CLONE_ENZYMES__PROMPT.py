...
"""
	PM rsa-fernet--clone-enzymes --de "" --to ""
"""

import click
@click.command	("rsa-fernet--clone-enzymes")

@click.option	('--de',		required = True)
@click.option	('--to',		required = False, default = "2048")
@click.option	('--replace',	is_flag = True)

def RSA_FERNET__CLONE_ENZYMES (
	de,
	to,
	replace
):
	...
	import shutil
	#shutil.copyfile (DE_HOT_1, TO_HOT_1)
	#shutil.copyfile (DE_HOT_2, TO_HOT_2)
