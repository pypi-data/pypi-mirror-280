...
from thestage.services.clients.thestage_api.dtos.container_response import DockerContainerListResponse, DockerContainerDto, \
    DockerContainerItemResponse
...
from thestage.services.clients.thestage_api.dtos.instance_rented_response import InstanceRentedListResponse, InstanceRentedDto
...
class TheStageApiClient(TheStageApiClientCore):
    ...
    def get_rented_instance_list(
        ...
        if statuses:
            data['statuses'] = [item.value for item in statuses]
    ...
    def get_self_hosted_instance_list(
            self,
            token: str,
