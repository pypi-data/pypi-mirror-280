...
class PaymentTestCase(TestCase):
    def test_creation(self):
        ...
        self.assertEqual(payment.remote_collection.id, UUID('218d7772-a747-4d5f-8c56-bbc7cfeab1a0'))
        self.assertEqual(payment.remote_collection.type, 'application')
        ...
        self.assertIsNone(payment.fault)
        self.assertEqual(payment.remote_collection.id, UUID('218d7772-a747-4d5f-8c56-bbc7cfeab1a0'))
        ...
        self.assertEqual(payment.payment.reason, 'bla')
        ...
        self.assertEqual(payment.event_version, '3.0')
            ...
            Payment(
                **get_payment_event_data(
                    payment={
                        ...
                        'currency': 'EUR',
                        'type': 'STAMP',
                        'reason': 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt '  # noqa
                        'ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco '  # noqa
