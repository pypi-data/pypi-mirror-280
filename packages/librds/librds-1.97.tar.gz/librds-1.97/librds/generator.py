...
class GroupGenerator:
    ...
    @staticmethod
    def ps(basic:Group, ps_text:str, segment:int, ms:bool=True, ta:bool=False, di:int=1, block2:int=0):
        """
    ...
    @staticmethod
    def ps_b(basic:Group,ps_text:str,segment:int,ms:bool=True,ta:bool=False,di:int=1):
        ...
        return Group(
            basic.a & 0xFFFF,
            ( basic.b | get_group(0,True) | int(ta) << 4 | int(ms) << 3 | ( ( di >> (3-segment) ) << 2) | segment ) & 0xFFFF,
            basic.a & 0xFFFF,
            (RDSCharset.translate(get_from_list(ps_text,segment*2," "))<<8 | RDSCharset.translate(get_from_list(ps_text,segment*2+1," "))) & 0xFFFF,
            True
        )
    @staticmethod
    def ecc(basic:Group, ecc: int, pin_day: int=0, pin_hour: int=0, pin_minute: int=0):
        ...
        return Group(
            basic.a & 0xFFFF,
            (basic.b | get_group(1)) & 0xFFFF,
            (basic.c | ecc) & 0xFFFF,
            (basic.d | (pin_day << 11) | (pin_hour << 6) | pin_minute) & 0xFFFF,
            False
        )
    @staticmethod
    def lic(basic:Group, lic: int, pin_day: int=0, pin_hour: int=0, pin_minute: int=0):
    ...
    @staticmethod
    def pin(basic:Group, pin_day: int=0, pin_hour: int=0, pin_minute: int=0):
        ...
        return Group(
            basic.a & 0xFFFF,
            (basic.b | get_group(1,True)) & 0xFFFF,
            basic.a & 0xFFFF,
            (basic.d | (pin_day << 11) | (pin_hour << 6) | pin_minute) & 0xFFFF,
            True
        )
    @staticmethod
    def broadcasterdata_pin(basic:Group, data: int, pin_day: int=0, pin_hour: int=0, pin_minute: int=0):
    ...
    @staticmethod
    def rt(basic:Group,rt_text:str,segment:int,ab:bool=False):
        ...
        return Group(
            basic.a & 0xFFFF,
            (basic.b | get_group(2) | int(ab) << 4 | segment) & 0xFFFF,
    ...
    @staticmethod
    def rt_b(basic:Group,rt_text:str,segment:int,ab:bool=False):
        ...
        return Group(
            basic.a & 0xFFFF,
            (basic.b | get_group(2,True) | int(ab) << 4 | segment) & 0xFFFF,
            basic.a & 0xFFFF,
            (RDSCharset.translate(get_from_list(rt_text,segment*4+0," "))<<8 | RDSCharset.translate(get_from_list(rt_text,segment*4+1," "))) & 0xFFFF,
            True
        )
    @staticmethod
    def ptyn(basic:Group, ptyn_text:str, segment:int,ab:bool=False):
        ...
        return Group(
            basic.a & 0xFFFF,
            (basic.b | get_group(10) | (int(ab) << 4) | segment) & 0xFFFF,
    ...
    def ct(basic:Group, mjd: int, hour: int, minute: int, local_hour:int|None=None,local_minute:int|None=None):
        ...
        return group
    @staticmethod
    def tdc(basic:Group, channel:int,data:list[int],segment:int):
        ...
        return Group(
            basic.a & 0xFFFF,
            (basic.b | get_group(5) | (channel & 0x1F)) & 0xFFFF,
    ...
    @staticmethod
    def tdc_b(basic:Group, channel:int,data:list[int],segment:int):
        ...
        return Group(
            basic.a & 0xFFFF,
            (basic.b | get_group(5,True) | (channel & 0x1F)) & 0xFFFF,
            basic.a & 0xFFFF,
            (get_from_list(data,segment+0,0)<<8 | get_from_list(data,segment+1,0)) & 0xFFFF,
            True
        )
    @staticmethod
    def in_house(basic:Group, data:list[int],segment:int=0):
        ...
        return Group(
            basic.a & 0xFFFF,
            (((basic.b | get_group(6)) & ~0x1F) | (get_from_list(data,segment+0,0) & 0x1F)) & 0xFFFF,
            get_from_list(data,segment+1,0) & 0xFFFF,
            get_from_list(data,segment+2,0) & 0xFFFF,
            False
        )
    @staticmethod
    def in_house_b(basic:Group, data:list[int],segment:int=0):
        ...
        return Group(
            basic.a & 0xFFFF,
            (((basic.b | get_group(6,True)) & ~0x1F) | (get_from_list(data,segment+0,0) & 0x1F)) & 0xFFFF,
            basic.a & 0xFFFF,
            get_from_list(data,segment+1,0) & 0xFFFF,
            True
        )
    @staticmethod
    def oda_aid(basic:Group, group: GroupIdentifier, aid:int, scb:int=0):
    ...
    @staticmethod
    def custom(basic:Group, group: GroupIdentifier, data:list):
        ...
        return Group(
            basic.a & 0xFFFF,
            (((basic.b | get_group(group.group_number,group.group_version)) & ~0x1F) | get_from_list(data,0,0) & 0x1F) & 0xFFFF,
            ((get_from_list(data,1,0) & 0xFFFF) if group.group_version == False else (basic.a & 0xFFFF)),
            get_from_list(data,2,0) & 0xFFFF,
            group.group_version
        )
    @staticmethod
    def eon(basic:Group, on_pi: int, on_tp: bool, variant_code: int, on_ps:str="", on_af:int=0, on_pty: int=0, on_ta: bool=False, on_broadcaster_data:int=0):
        ...
        group = Group(
            basic.a & 0xFFFF,
            (((basic.b | get_group(14,False) | BitManipulator.set_bit(0,11,on_tp)) & ~0xF) | (variant_code & 0xF)) & 0xFFFF,
            0,
            on_pi,
            False
        )
        ...
        return group
    @staticmethod
    def eon_b(basic:Group, on_pi: int, on_tp: bool, on_ta:bool):
        ...
        return Group(
            basic.a & 0xFFFF,
            (basic.b | get_group(14,True) | BitManipulator.set_bit(0,11,on_tp) | BitManipulator.set_bit(0,12,on_ta)) & 0xFFFF,
            basic.a & 0xFFFF,
            on_pi & 0xFFFF,
            True
        )
    @staticmethod
    def long_ps(basic:Group,ps_text:str,segment:int):
        ...
        return Group(
            basic.a & 0xFFFF,
            (basic.b | get_group(15) | segment) & 0xFFFF,
    ...
    @staticmethod
    def fast_switching(basic:Group, segment:int, ms:bool=True, ta:bool=False, di:int=1):
        """
        ...
        return Group(
            basic.a & 0xFFFF,
            ( basic.b | get_group(15,True) | int(ta) << 4 | int(ms) << 3 | ( ( di >> (3-segment) ) << 2) | segment ) & 0xFFFF,
            basic.a & 0xFFFF,
            ( basic.b | get_group(15,True) | int(ta) << 4 | int(ms) << 3 | ( ( di >> (3-segment) ) << 2) | segment ) & 0xFFFF,
            False
        )