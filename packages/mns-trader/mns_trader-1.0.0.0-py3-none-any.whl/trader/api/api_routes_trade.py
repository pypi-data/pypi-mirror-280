...
def trade_sell():
    ...
    terminal = request.json.get("terminal")
    if terminal == 'easy_trader':
        return easy_trader_service.order_buy(symbol, sell_price, sell_volume)
    elif terminal == 'qmt':
        return qmt_service.order_buy(symbol, sell_price, sell_volume)
    else:
        '''
        默认easy_trader
        '''
...
def cancel():
    ...
    if terminal == 'easy_trader':
        ...
        return qmt_service.order_cancel(entrust_no)
    else:
        '''
        默认easy_trader
        '''
