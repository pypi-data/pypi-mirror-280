...
class CreateTable:
    ...
    def create_plus_users(self):
        """
        Create table for plus users.

        :return: None.
        """
        query: str = f"""CREATE TABLE IF NOT EXISTS plus_users(
    ...
    def create_plus_promo_codes(self):
        """
        Create table of promo datas.
        """
        query: str = f"""CREATE TABLE IF NOT EXISTS plus_promo_codes(
                id INTEGER PRIMARY KEY AUTO_INCREMENT,
