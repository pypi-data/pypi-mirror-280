...
class Answers:
    ...
    @staticmethod
    def chat_action(bot: telebot.TeleBot, chat_id: int | str, action: str,
        ...
        :return: None.
        """
        bot.send_chat_action(chat_id=chat_id, action=action, timeout=15000,
                             business_connection_id=business_connection_id)

    def answer_to_user(self, bot: telebot.TeleBot, message: types.Message) -> None:
        """
