...
def load_llm(model_name_or_path="THUDM/chatglm-6b", device=None, num_gpus=2, **kwargs):
    import torch
...
def load_llm4chat(model_name_or_path="THUDM/chatglm-6b", device=None, num_gpus=2, stream=True, **kwargs):
