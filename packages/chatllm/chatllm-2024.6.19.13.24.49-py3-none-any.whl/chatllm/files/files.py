...
async def upload_files(
    ...
    if purpose == Purpose.file_upload:
        return await Minio().put_object_for_openai(file=file, purpose=purpose.value, bucket_name="files")
    ...
    elif purpose == Purpose.file_extract:  # kimi
        return await kimi_client.files.create(file=(file.filename, file.file), purpose=purpose.value)

    elif purpose == Purpose.file_extract_plus:  # todo: UnstructuredAPIFileLoader
