...
# from langchain_community.document_loaders.parsers.pdf import BaseBlobParser, Blob, Document
from langchain.schema import Document
from langchain_community.document_loaders.pdf import PyMuPDFLoader as _PyMuPDFLoader
