...
export var run = function (autoTester) {
	...
	autoTester.check (replace_test.py_replace ('c', 'x'));
	autoTester.check (replace_test.py_replace ('c', 'x', -(1)));
	autoTester.check (replace_test.py_replace ('c', 'x', 0));
	autoTester.check (replace_test.py_replace ('c', 'x', 1));
	autoTester.check (replace_test.py_replace ('c', 'x', 2));
	autoTester.check (replace_test.py_replace ('c', 'x', 10));
	...
	autoTester.check (string_test.startswith (tuple (['abc'])));
	autoTester.check (string_test.startswith (tuple (['abc', 'de', 'gh'])));
	autoTester.check (string_test.startswith (tuple (['abc', 'de', 'gh']), 2));
	autoTester.check (string_test.startswith (tuple (['abc', 'de', 'gh']), 3));
	autoTester.check (string_test.startswith (tuple (['abc', 'defgh']), 3, 9));
	autoTester.check (string_test.startswith (tuple (['abc', 'defgh']), 3, 6));
	...
	autoTester.check (string_test.endswith (tuple (['ijkl'])));
	autoTester.check (string_test.endswith (tuple (['abc', 'de', 'gh'])));
	autoTester.check (string_test.endswith (tuple (['abc', 'de', 'gh']), 3, -(4)));
	autoTester.check (string_test.endswith (tuple (['abc', 'de', 'gh']), -(6), -(4)));
	autoTester.check (string_test.endswith (tuple (['abc', 'defgh']), -(3), 8));
	autoTester.check (string_test.endswith (tuple (['abc', 'defgh']), -(9), 8));
};
