import{e as t,c as e,T as o,L as i,r as s,b as r,d as a,n,s as l,x as c,f as p,N as d,O as h,P as u,Q as m,I as _,J as v,l as g,S as w,E as y}from"./index-Coj9zNoA.js";import{g as f}from"./c.D0pASuB2.js";import"./c.0kl3f7I_.js";import{o as b,c as $,g as S}from"./c.BxOkMzH4.js";import{m as P,s as x,b as k}from"./c.DkGXJfUN.js";import{o as C}from"./c.BVWClKOx.js";class E{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}}class j{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){var t;null!==(t=this.Y)&&void 0!==t||(this.Y=new Promise((t=>this.Z=t)))}resume(){var t;null===(t=this.Z)||void 0===t||t.call(this),this.Y=this.Z=void 0}}const W=t=>!i(t)&&"function"==typeof t.then,H=1073741823;const I=t(class extends e{constructor(){super(...arguments),this._$C_t=H,this._$Cwt=[],this._$Cq=new E(this),this._$CK=new j}render(...t){var e;return null!==(e=t.find((t=>!W(t))))&&void 0!==e?e:o}update(t,e){const i=this._$Cwt;let s=i.length;this._$Cwt=e;const r=this._$Cq,a=this._$CK;this.isConnected||this.disconnected();for(let t=0;t<e.length&&!(t>this._$C_t);t++){const o=e[t];if(!W(o))return this._$C_t=t,o;t<s&&o===i[t]||(this._$C_t=H,s=0,Promise.resolve(o).then((async t=>{for(;a.get();)await a.get();const e=r.deref();if(void 0!==e){const i=e._$Cwt.indexOf(o);i>-1&&i<e._$C_t&&(e._$C_t=i,e.setValue(t))}})))}return o}disconnected(){this._$Cq.disconnect(),this._$CK.pause()}reconnected(){this._$Cq.reconnect(this),this._$CK.resume()}}),D=(t,e)=>{import("./c.CX5P12qQ.js");const o=document.createElement("esphome-compile-dialog");o.configuration=t,o.platformSupportsWebSerial=e,document.body.append(o)},T=async(t,e)=>{import("./c.ofidcPJf.js");let o=t.port;if(o)await o.close();else try{o=await navigator.serial.requestPort()}catch(o){return void("NotFoundError"===o.name?b((()=>T(t,e))):alert(`Unable to connect: ${o.message}`))}const i=$(o);e&&e();const s=document.createElement("esphome-install-web-dialog");s.params=t,s.esploader=i,document.body.append(s)},A={info:d,warning:h,error:u,success:m};let q=class extends l{constructor(){super(...arguments),this.title="",this.alertType="info",this.rtl=!1}render(){return c`
      <div
  ...
  `,r([a()],q.prototype,"title",void 0),r([a({attribute:"alert-type"})],q.prototype,"alertType",void 0),r([a({type:Boolean})],q.prototype,"rtl",void 0),q=r([n("esphome-alert")],q);const B=(t,e)=>{import("./c.wyjQnEUy.js");const o=document.createElement("esphome-download-type-dialog");o.configuration=t,o.platformSupportsWebSerial=e,document.body.append(o)};let U=class extends l{constructor(){super(...arguments),this._ethernet=!1,this._isPico=!1,this._shouldDownloadFactory=!1,this._state="pick_option"}get _platformSupportsWebSerial(){return!this._isPico}render(){let t,e;if("pick_option"===this._state)t=`How do you want to install ${this.configuration} on your device?`,e=c`
        <mwc-list-item
          twoline
          hasMeta
          .port=${"OTA"}
    ...
    `}_renderMessage(t,e,o){return c`
      ...
      ${o?c`
            ...
            ></mwc-button>
          `:""}
    `}firstUpdated(t){super.firstUpdated(t),this._updateSerialPorts(),w(this.configuration).then((t=>{this._ethernet=t.loaded_integrations.includes("ethernet"),this._isPico="RP2040"===t.esp_platform,this._shouldDownloadFactory="ESP32"===t.esp_platform}))}async _updateSerialPorts(){this._ports=await f()}willUpdate(t){super.willUpdate(t),t.has("_state")&&"download_instructions"===this._state&&!this._compileConfiguration&&(this._abortCompilation=new AbortController,this._compileConfiguration=y(this.configuration).then((()=>this._shouldDownloadFactory?c`<a
                  download
                  href="${S(this.configuration)}"
                  >Download project</a
                >`:c`<button
                  class="link"
    ...
    `],r([a()],U.prototype,"configuration",void 0),r([g()],U.prototype,"_ethernet",void 0),r([g()],U.prototype,"_isPico",void 0),r([g()],U.prototype,"_shouldDownloadFactory",void 0),r([g()],U.prototype,"_ports",void 0),r([g()],U.prototype,"_state",void 0),r([g()],U.prototype,"_error",void 0),U=r([n("esphome-install-choose-dialog")],U);var O=Object.freeze({__proto__:null});export{D as a,T as b,O as i,B as o};
//# sourceMappingURL=c.CGXyc9r0.js.map
