...
inline bool BackendConfig::_internal_has_onednn_softmax_config() const {
  return this != internal_default_instance() && _impl_.onednn_softmax_config_ != nullptr;
}
inline bool BackendConfig::has_onednn_softmax_config() const {
  return _internal_has_onednn_softmax_config();
}
inline void BackendConfig::clear_onednn_softmax_config() {
  if (GetArenaForAllocation() == nullptr && _impl_.onednn_softmax_config_ != nullptr) {
    delete _impl_.onednn_softmax_config_;
  }
  _impl_.onednn_softmax_config_ = nullptr;
}
inline const ::xla::cpu::OneDnnSoftmaxConfig& BackendConfig::_internal_onednn_softmax_config() const {
  const ::xla::cpu::OneDnnSoftmaxConfig* p = _impl_.onednn_softmax_config_;
  return p != nullptr ? *p : reinterpret_cast<const ::xla::cpu::OneDnnSoftmaxConfig&>(
      ::xla::cpu::_OneDnnSoftmaxConfig_default_instance_);
}
...
inline void BackendConfig::unsafe_arena_set_allocated_onednn_softmax_config(
    ::xla::cpu::OneDnnSoftmaxConfig* onednn_softmax_config) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.onednn_softmax_config_);
  }
  _impl_.onednn_softmax_config_ = onednn_softmax_config;
...
inline ::xla::cpu::OneDnnSoftmaxConfig* BackendConfig::release_onednn_softmax_config() {
  ...
  ::xla::cpu::OneDnnSoftmaxConfig* temp = _impl_.onednn_softmax_config_;
  _impl_.onednn_softmax_config_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::xla::cpu::OneDnnSoftmaxConfig* BackendConfig::_internal_mutable_onednn_softmax_config() {
  ...
  if (_impl_.onednn_softmax_config_ == nullptr) {
    auto* p = CreateMaybeMessage<::xla::cpu::OneDnnSoftmaxConfig>(GetArenaForAllocation());
    _impl_.onednn_softmax_config_ = p;
  }
  return _impl_.onednn_softmax_config_;
}
...
inline void BackendConfig::set_allocated_onednn_softmax_config(::xla::cpu::OneDnnSoftmaxConfig* onednn_softmax_config) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.onednn_softmax_config_;
  }
  if (onednn_softmax_config) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(onednn_softmax_config);
    if (message_arena != submessage_arena) {
      onednn_softmax_config = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, onednn_softmax_config, submessage_arena);
    }
  ...
  _impl_.onednn_softmax_config_ = onednn_softmax_config;
  // @@protoc_insertion_point(field_set_allocated:xla.cpu.BackendConfig.onednn_softmax_config)
}
