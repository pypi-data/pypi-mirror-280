...
class V1AppSpecV1Alpha1(BaseModel):
    ...
    resource: Optional[V1Resource] = None
    ...
    __properties: ClassVar[List[str]] = ["image", "imagePullSecrets", "volumeMounts", "env", "command", "port", "readinessProbe", "volumes", "resource", "routeAuthType", "routePublicKey", "autoscaler"]
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "env": [V1Environment.from_dict(_item) for _item in obj.get("env")] if obj.get("env") is not None else None,
            ...
            "resource": V1Resource.from_dict(obj.get("resource")) if obj.get("resource") is not None else None,
            "routeAuthType": obj.get("routeAuthType"),
            "routePublicKey": obj.get("routePublicKey"),
            "autoscaler": V1Autoscaler.from_dict(obj.get("autoscaler")) if obj.get("autoscaler") is not None else None
        })
        return _obj
