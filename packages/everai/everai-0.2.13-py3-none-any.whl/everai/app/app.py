...
class App(AppRunnerMixin, AppVersionedMixin, ShowMixin):
    ...
    def _make_decorator(cls,
                        decorators: typing.Optional[typing.List[Decorator]]
                        ) -> typing.Optional[typing.List[AutoscalerDecoratorsItem]]:
        if decorators is None or len(decorators) == 0:
            return None

        return [
            AutoscalerDecoratorsItem(name=decorator.name, arguments=decorator.arguments) for decorator in decorators
        ]

    @classmethod
    def _make_decorators(cls, decorators: typing.Optional[Decorators] = None) -> typing.Optional[AutoscalerDecorators]:
