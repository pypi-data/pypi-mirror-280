...
class FlowRateAdjuster(jneqsim.neqsim.processSimulation.processEquipment.ProcessEquipmentBaseClass):
    ...
    def setAdjustedStream(self, streamInterface: jneqsim.neqsim.processSimulation.processEquipment.stream.StreamInterface) -> None: ...
