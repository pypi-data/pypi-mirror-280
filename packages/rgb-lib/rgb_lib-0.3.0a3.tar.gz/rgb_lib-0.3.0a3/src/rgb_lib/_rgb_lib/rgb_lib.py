...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_rgblibffi_checksum_method_invoice_invoice_string() != 49576:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_recipientinfo_network() != 1106:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_recipientinfo_recipient_type() != 53534:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_rgblibffi_fn_method_recipientinfo_network.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_recipientinfo_network.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_recipientinfo_recipient_type.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_recipientinfo_recipient_type.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_rgblibffi_checksum_method_recipientinfo_network.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_recipientinfo_network.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_recipientinfo_recipient_type.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_recipientinfo_recipient_type.restype = ctypes.c_uint16
...
class RecipientInfo:
    ...
    def network(self, ) -> "BitcoinNetwork":
        return _UniffiConverterTypeBitcoinNetwork.lift(
            _rust_call(_UniffiLib.uniffi_rgblibffi_fn_method_recipientinfo_network,self._uniffi_clone_pointer(),)
        )
    ...
    def recipient_type(self, ) -> "RecipientType":
        return _UniffiConverterTypeRecipientType.lift(
            _rust_call(_UniffiLib.uniffi_rgblibffi_fn_method_recipientinfo_recipient_type,self._uniffi_clone_pointer(),)
        )
