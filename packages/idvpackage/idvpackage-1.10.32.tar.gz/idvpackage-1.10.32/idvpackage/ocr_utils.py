    ...
    try:
        ...
        if country == 'IRQ' or country == 'LBN' or country == 'QAT':
            if country == 'IRQ':
                main_prop_data = {}
                if data.get('doc_type') == 'passport':
                    keys_to_remove = ['name', 'first_name', 'issuing_place', 'occupation', 'employer', 'issuing_country', 'mrz_line3', 'family_sponsor']
                    keys = ['full_name', 'id_number', 'mrz', 'issue_date']
                else:
                    keys_to_remove = ['occupation', 'employer', 'family_sponsor', 'issuing_place']
                    keys = ['name_en', 'issuing_authority', 'gender_ar', 'place_of_birth', 'issuing_authority_en', 'place_of_birth_en', "issue_date"]
