...
│   │   ├── feature.prompt
│   │   └── rules.md
│   ├── prompt_order_exploration.md
│   └── steps_exploration.md
```

formated in the resultsfile "config_prompt_givens.md" like this:
```markdown
# ara
    - [] agile_artefact_deletion.feature
## agile_artefact_deletion.data
...
Warning: this test script has a little but and always needs at least 2 file types listed, the generate list function itself works correctly 
"""
