...
def initialize_prompt_templates(classifier, parameter):
    ...
    generate_config_prompt_givens_file(prompt_data_path, "config_prompt_givens.md", artefact_to_mark=f"{parameter}.{classifier}")
...
def create_and_send_custom_prompt(classifier, parameter):
    ...
    endings = [".rules.md", "_prompt_givens.md", ".intention.md", ".commands.md"]
...
def generate_config_prompt_template_file(prompt_data_path, config_prompt_templates_name):
    ...
    dir_list = ["ara/.araconfig/custom-prompt-modules"] + ["ara_cli/templates/prompt-modules"]  # TODO path must be adapted
...
def generate_config_prompt_givens_file(prompt_data_path, config_prompt_givens_name, artefact_to_mark=None):
    ...
    if artefact_to_mark:
        print(f"artefact {artefact_to_mark} marked in related config_prompt_givens.md per default")
