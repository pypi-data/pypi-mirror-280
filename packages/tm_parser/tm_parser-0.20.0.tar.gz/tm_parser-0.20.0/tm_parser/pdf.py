...
def parse_scout(data):
    ...
    if "Merit Badges" in scout:
        scout['Advancement']["Merit Badges"] = get_full_merit_badges(scout["Merit Badges"])
    ...
    if "Partial Merit Badges" in scout:
        scout['Advancement']["Merit Badge Requirements"] = get_partials(scout["Partial Merit Badges"])
