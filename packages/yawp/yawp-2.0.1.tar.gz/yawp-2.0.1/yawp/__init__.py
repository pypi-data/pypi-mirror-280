...
__version__ = '2.0.1' # YAWP present version
VERSION_DATE = '2024-06-20' # 'YYYY-mm-dd' date of YAWP present version
...
def cp(file, file2):
    ...
    if isfile(file):
        try:
            copy2(file, file2)
            return f'    copy {file!r} →\n         {file2!r}'
        except:
            return None
    elif isfile(file2):
        try:
            remove(file2)
            return f'    remove {file2!r}'
        except:
            return None
