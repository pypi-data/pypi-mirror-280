...
by typing at terminal:
    ...
    │ $ yawp -M f -v -w 97 -p c -n -4 -X e -L 3cm 'YAWP 2.0.0 User Manual.txt'
...
where arguments mean:
    ...
    • 'YAWP 2.0.0 User Manual.txt': set the text file to process
...
positional arguments:
  ...
  target_file           destination text file for CLI Copy mode (-M c) and CLI
                        Move mode (-M m)
...
options:
  ...
  -s SECOND_LINE, --second_line SECOND_LINE
                        second line of page headers (default: 's'=solid,
                        'n'=no, 'b'=blanks, 'p'=points, 'd'=dashes)
  -X EXPORT_PDF, --export-pdf EXPORT_PDF
                        export and browse PDF file (default: 'b'=export and
                        browse, 'n'=no, 'e'=export)
  -C CORRECT, --correct CORRECT
                        correct character size and page margins (default:
                        'd'=by default values, 'n'=no, 'f'=by correction file)
