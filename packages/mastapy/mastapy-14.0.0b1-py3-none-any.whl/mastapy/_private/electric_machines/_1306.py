...
class _Cast_ElectricMachineMeshingOptions:
    ...
    def electric_machine_meshing_options_base(
        self: "CastSelf",
    ) -> "_1307.ElectricMachineMeshingOptionsBase":
        return self.__parent__._cast(_1307.ElectricMachineMeshingOptionsBase)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ElectricMachineMeshingOptions(_1307.ElectricMachineMeshingOptionsBase):
    """ElectricMachineMeshingOptions
