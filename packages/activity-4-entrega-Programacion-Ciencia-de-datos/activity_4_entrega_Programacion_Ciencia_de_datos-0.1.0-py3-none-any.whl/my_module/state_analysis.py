...
def analyze_outliers(df: pd.DataFrame):
    ...
    conclusion = """
    La media de permisos (permit_perc) cambió significativamente después de reemplazar el valor de Kentucky.
    Este proceso de eliminar valores atípicos ayuda a evitar distorsiones en las métricas estadísticas y
    asegura que los análisis y modelos sean más precisos y representativos del conjunto de datos real.
    """
    print(conclusion)
