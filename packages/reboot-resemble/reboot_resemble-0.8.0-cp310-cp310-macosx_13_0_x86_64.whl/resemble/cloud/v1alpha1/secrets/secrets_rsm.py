...
class _SecretStub(Stub):
    ...
    __service_name__ = ServiceName('resemble.cloud.v1alpha1.secrets.SecretInterface')
...
SecretStateType: TypeAlias = resemble.cloud.v1alpha1.secrets.secrets_pb2.Secret
        ...
        *,
        ...
        if method_name == 'resemble.cloud.v1alpha1.secrets.Secret.Write':
            return await self.Write(
                context,
                cast(resemble.cloud.v1alpha1.secrets.secrets_pb2.Secret, state),
...
class SecretServicer(Servicer):
    ...
    def schedule(
        ...
        *,
        when: Optional[datetime | timedelta] = None,
    ) -> SecretServicer._Schedule:
        return SecretServicer._Schedule(when=when)
...
class Secret:
    ...
    State: TypeAlias = resemble.cloud.v1alpha1.secrets.secrets_pb2.Secret
    ...
    class WeakReference:
        ...
        def reactively(self):
            return Secret.WeakReference._Reactively(
                service_name=ServiceName('resemble.cloud.v1alpha1.secrets.SecretInterface'),
                actor_id=self._actor_id,
                bearer_token=self._bearer_token,
            )
