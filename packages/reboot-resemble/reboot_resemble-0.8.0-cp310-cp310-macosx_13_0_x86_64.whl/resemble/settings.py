...
ENVVAR_RSM_LOCAL_ENVOY = 'RSM_LOCAL_ENVOY'
ENVVAR_RSM_LOCAL_ENVOY_PORT = 'RSM_LOCAL_ENVOY_PORT'
ENVVAR_RSM_INSPECT_PORT = 'RSM_INSPECT_PORT'
...
# The maximum lengths of user inputs that will be encoded into headers. The
...
# configured.
ENVVAR_LOCAL_ENVOY_TLS_CERTIFICATE_PATH = 'LOCAL_ENVOY_TLS_CERTIFICATE_PATH'
ENVVAR_LOCAL_ENVOY_TLS_KEY_PATH = 'LOCAL_ENVOY_TLS_KEY_PATH'
