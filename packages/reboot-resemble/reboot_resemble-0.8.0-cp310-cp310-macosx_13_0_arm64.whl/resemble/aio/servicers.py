...
import importlib
import inspect
import resemble.v1alpha1.config_mode_pb2 as config_mode_pb2
import resemble.v1alpha1.config_mode_pb2_grpc as config_mode_pb2_grpc
from abc import ABC, abstractmethod
from functools import total_ordering
from google.protobuf.descriptor import FileDescriptor
from google.protobuf.message import Message
from resemble.aio.types import ServiceName
from resemble.v1alpha1.application_config_pb2 import ApplicationConfig
...
def _find_legacy_serviceable(
    ...
    resemble_module_name = (grpc_module_name[:-len('_pb2_grpc')] + '_rsm')
    try:
