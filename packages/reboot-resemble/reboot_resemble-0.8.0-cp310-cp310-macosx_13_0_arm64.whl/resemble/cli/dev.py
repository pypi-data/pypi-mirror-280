...
async def __dev_run(
    ...
    *,
    ...
    if args.name is not None:
        ...
        env[ENVVAR_RSM_DIRECTORY] = dot_rsm_dev_directory()
    ...
    if args.local_envoy:
        ...
        env[ENVVAR_RSM_LOCAL_ENVOY] = 'false'

    env[ENVVAR_RSM_LOCAL_ENVOY_PORT] = str(
    ...
    env[ENVVAR_RSM_INSPECT_PORT] = str(
