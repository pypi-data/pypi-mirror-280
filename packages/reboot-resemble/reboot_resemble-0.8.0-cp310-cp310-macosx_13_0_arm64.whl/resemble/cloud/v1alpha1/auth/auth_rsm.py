...
class APIKeyServicerMiddleware(Middleware):
    ...
    def add_to_server(self, server: grpc.aio.Server) -> None:
        resemble.cloud.v1alpha1.auth.auth_pb2_grpc.add_APIKeyInterfaceServicer_to_server(
            self, server
        )
    ...
    async def __Revoke(
        self,
        context: WriterContext,
        state: resemble.cloud.v1alpha1.auth.auth_pb2.APIKey,
        request: resemble.cloud.v1alpha1.auth.auth_pb2.RevokeRequest,
        *,
        validating_effects: bool,
...
class _APIKeyStub(Stub):
    ...
    __service_name__ = ServiceName('resemble.cloud.v1alpha1.auth.APIKeyInterface')
    ...
    def __init__(
        ...
        *,
        ...
        self._stub = resemble.cloud.v1alpha1.auth.auth_pb2_grpc.APIKeyInterfaceStub(channel)
...
APIKeyStateType: TypeAlias = resemble.cloud.v1alpha1.auth.auth_pb2.APIKey
        ...
        *,
        ...
        if method_name == 'resemble.cloud.v1alpha1.auth.APIKey.Create':
            ...
            return await self.Revoke(
                context,
                cast(resemble.cloud.v1alpha1.auth.auth_pb2.APIKey, state),
...
class APIKeyServicer(Servicer):
    ...
    __state_type__ = resemble.cloud.v1alpha1.auth.auth_pb2.APIKey
    ...
    def schedule(
        ...
        *,
        when: Optional[datetime | timedelta] = None,
    ) -> APIKeyServicer._Schedule:
        return APIKeyServicer._Schedule(when=when)
    ...
    class Effects(resemble.aio.state_managers.Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [resemble.cloud.v1alpha1.auth.auth_pb2.APIKey])
    ...
    ) -> resemble.cloud.v1alpha1.auth.auth_pb2.APIKey:
...
class APIKey:
    ...
    State: TypeAlias = resemble.cloud.v1alpha1.auth.auth_pb2.APIKey
...
resemble.cloud.v1alpha1.auth.auth_pb2.InvalidInputError        ]
    ...
    class WeakReference:
        ...
        def reactively(self):
            return APIKey.WeakReference._Reactively(
                service_name=ServiceName('resemble.cloud.v1alpha1.auth.APIKeyInterface'),
                actor_id=self._actor_id,
                bearer_token=self._bearer_token,
            )
        ...
        class _Idempotently:
            ...
            def schedule(
                ...
                *,
                when: Optional[datetime | timedelta] = None,
            ) -> APIKey.WeakReference._Schedule:
                return APIKey.WeakReference._Schedule(
        ...
        def idempotently(
            ...
            *,
            key: Optional[str] = None,
        ) -> APIKey.WeakReference._Idempotently:
            if (
                (alias is None and key is None) or
                (alias is not None and key is not None)
            ):
    ...
    def idempotently(
        ...
        *,
        ...
        return APIKey._Idempotently(alias=alias, key=key)
