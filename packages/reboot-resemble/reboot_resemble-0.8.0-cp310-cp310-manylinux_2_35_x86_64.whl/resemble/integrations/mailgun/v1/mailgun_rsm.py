...
class _MessageStub(Stub):
    ...
    __service_name__ = ServiceName('resemble.integrations.mailgun.v1.MessageInterface')
...
MessageStateType: TypeAlias = resemble.integrations.mailgun.v1.mailgun_pb2.Message
        ...
        *,
        ...
        if method_name == 'resemble.integrations.mailgun.v1.Message.Send':
            ...
            return await self.SendTask(
                context,
                cast(resemble.integrations.mailgun.v1.mailgun_pb2.Message, state),
...
class MessageServicer(Servicer):
    ...
    def schedule(
        ...
        *,
        when: Optional[datetime | timedelta] = None,
    ) -> MessageServicer._Schedule:
        return MessageServicer._Schedule(when=when)
...
class Message:
    ...
    State: TypeAlias = resemble.integrations.mailgun.v1.mailgun_pb2.Message
    ...
    class WeakReference:
        ...
        def reactively(self):
            return Message.WeakReference._Reactively(
                service_name=ServiceName('resemble.integrations.mailgun.v1.MessageInterface'),
                actor_id=self._actor_id,
                bearer_token=self._bearer_token,
            )
