...
class Model:
    ...
    def add_variable_vector(
        ...
        if vtype is Vtype.BINARY:
            ...
            _warn_that_bipolar_variables_are_deprecated()
            if variable_bounds:
...
def _warn_that_bipolar_variables_are_deprecated():
    warn(DeprecationWarning(
        "Support for bipolar variables is deprecated in TitanQ."
        + " Use `tools.BipolarToBinary` instead."),
        stacklevel=2)
