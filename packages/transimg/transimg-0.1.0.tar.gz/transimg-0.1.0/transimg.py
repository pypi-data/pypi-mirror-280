...
def get_text(language):
    if language == "E":
        return {
            ...
            "enter_format": "Enter the format to convert the images to (e.g., jpg, png, gif): ",
        ...
        return {
            ...
            "enter_format": "Введите формат, в который нужно конвертировать изображения (например, jpg, png, gif): ",
...
def main():
    ...
    while True:
        ...
        files_to_convert = [f for f in os.listdir(input_folder) if f.endswith((".jpg", ".png", ".gif"))]
