...
__date__ = "2024/06/23 19:09:33 hoel"
...
class CTI:
    ...
    async def _gen_data(self, inp: Sequence) -> list:
        return [
            entry
    ...
    async def _read_lines(self, inp: Sequence) -> tuple[str]:
        while True:
    ...
    async def _parse_input(self, data: list[str]) -> Ct | Ix:
        shorttitle = (
    ...
    def __iter__(self) -> list[str]:
        """Iterate over collected entries.
