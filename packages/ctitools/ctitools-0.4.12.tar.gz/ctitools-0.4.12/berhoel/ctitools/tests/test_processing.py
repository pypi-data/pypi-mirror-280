...
__date__ = "2024/06/22 22:23:19 Berthold Höllmann"
...
@pytest.fixture()
def cti_entry_1(tmp_path: Path, cti_entry_data_1: str) -> Path:
...
@pytest.fixture()
def cti_entry_2(tmp_path: Path, cti_entry_data_2: str) -> Path:
...
@pytest.fixture()
def cti_entry_3(tmp_path: Path, cti_entry_data_3: str) -> Path:
    """Provide cti entries.
...
def test_process_author_1(cti_entry: Sequence) -> None:
...
def test_process_author_2(cti_entry: Sequence) -> None:
