...
__date__ = "2024/06/23 19:15:32 hoel"
...
class IssueMap:
    ...
    SPECIAL_ISSUE = 27
    YEAR_FOR_MONTLY_TO_2WEEK_FREQUENCY = 1997
    LAST_MONTHLY_ISSUE_IN_1997 = 11
    YEAR_FOR_RETRO_STARTING_AS_SPECIAL_ISSUE = 2016
...
class Ct:
    ...
    def year_issue2full_issue(year: int, issue: int) -> str:
        ...
        """
        if issue == IssueMap.SPECIAL_ISSUE:
            if year in {2022}:
