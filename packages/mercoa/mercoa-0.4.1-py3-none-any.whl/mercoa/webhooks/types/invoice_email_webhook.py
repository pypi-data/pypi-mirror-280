...
class InvoiceEmailWebhook(pydantic_v1.BaseModel):
    """
    Examples
    --------
    import datetime
    ...
    invoice: typing.Optional[InvoiceResponse] = pydantic_v1.Field(default=None)
    """
    If an invoice was created from the email, this will be present.
    """

    existing_invoice_id: typing.Optional[InvoiceId] = pydantic_v1.Field(alias="existingInvoiceId", default=None)
    """
