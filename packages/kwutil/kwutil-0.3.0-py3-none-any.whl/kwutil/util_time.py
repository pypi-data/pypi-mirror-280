...
TODO:
    ...
    * This module probably gets ported to ubelt
"""
import numbers
import time
import math
...
class datetime(datetime_cls):
    ...
    * A more concise __str__ and __repr__
    ...
    def coerce(cls, data, default_timezone='utc', nan_policy='return-None',
        ...
        """
        self = _coerce_datetime(data, default_timezone=default_timezone,
                                nan_policy=nan_policy, none_policy=none_policy,
...
class timedelta(datetime_mod.timedelta):
    ...
    * :func:`kwutil.timedelta.format` - a readable represenation at some resolution
...
def _time_unit_registery():
    ...
    def format_quantity(data, _return_info=None, **kwargs):
        return ub.urepr(data.magnitude, **kwargs) + ' ' + ub.urepr(data.u)
